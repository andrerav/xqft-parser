...
fragment CleanChar						: ~('\u0001'..'\u0008' | '\u000B' | '\u000C' | '\u000E'..'\u001F' | '\uD800'..'\uDFFF' 
										| '\uFFFE' | '\uFFFF' | '{' | '}' | '<' | AMPERSi | '"' | '\'' | '-' );
fragment Char							: CleanChar | '{' | '}' | '<' | AMPERSi | '"' | '\'' | '-' ;
*/
...
fragment Char							: BaseChar | Ideographic | CombiningChar | Extender | Digit | ExtraChar 
										| '\u0021'..'\u0024' | '\u0028'..'\u002F' | '\u003A'..'\u0040' | '\u005B'..'\u005D' | '\u005F' | '\u007B'..'\u007D';
//last line: String special = "<![]-?/=>#:.{}$\"\\;_,+*()@|";
/*
...
fragment CharNotMinus					: CleanChar | '{' | '}' | '<' | AMPERSi | '"' | '\'';

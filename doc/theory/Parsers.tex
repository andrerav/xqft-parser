...
The XQFT Parser was developed as a part of a academic project at
\cite{ourselves} throughout the autumn of 2007. 

\subsubsection{AST construction}
Litt om hvordan AST'en blir konstruert i en LL-parser

\subsubsection{Injection of imaginary tokens}
hvordan vi sproyter inn imaginary tokens

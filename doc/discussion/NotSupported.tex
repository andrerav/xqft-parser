...
But this is a very specialised operator, and probably quite complex to implement. If no better translation option
is found, a better solution would be to require range expressions to have literals as operands.

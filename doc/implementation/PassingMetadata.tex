...
lookups is somewhat counter-intuitive, since this metainformation is actually\marginpar{\textbf{\LARGE
TODO:}\scriptsize \\skj\o nner ikke \\dette \\avsnittet} stored when a variable is first set. That is, the

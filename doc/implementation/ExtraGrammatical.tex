...
Where "A.3 Reserved Function Names" lists a number of names such as \verb!if!, \verb!text! and \verb!node! (thirteen in total). As mentioned in \ref{sect:impl:reserved_keywords} this restriction is provided to solve some non-detererminisms arising from the fact that XQuery does not have reserved keywords.

...
\label{fig:states}
\end{figure}
The \verb!IN_TAG! state exists mainly to differenciate between \verb!StringLitteral! and \verb!DirAttrValue!, while the other states are for separating characters legal in the attributes and the ones in the element. 

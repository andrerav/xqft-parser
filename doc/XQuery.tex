...
For - imperative for-loop for iterating over tuples
Let - assignment of tuples to variables
Where - conditional filtering of tuples
Order by - ordering of the resulting tuples
Return - not to be mistaken with return statements from imperative languages. Returning in this context is more similar to yielding known from functional programming. The return statement is executed once for every iteration

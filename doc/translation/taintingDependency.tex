...
with their dependencies during sequence constructing. Consider the subexpression $e$:
\begin{center}
\begin{tabular}{l}
\quad \;\, $\vdots$  \\
...
tainting of the subexpression $e_{i}$ can be expressed like this: \marginpar{\underline{\textbf{\Large TODO:}}
...
As described in \ref{sect:theory:xquery:Flwor}, the XQuery FLWOR has an iteration semantics. For each item in the

...
\underline{\LARGE TODO:} skrive en liten innledning her om hvorfor vi assumer ting.
...
The operator is quite similar to the \texttt{DENSE\_RANK} operator defined by SQL:1999 \cite{sqlbook}.

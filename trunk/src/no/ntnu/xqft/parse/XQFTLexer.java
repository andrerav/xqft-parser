// $ANTLR 3.0.1 etc/XQFT.g 2007-12-10 15:51:27
...
public class XQFTLexer extends Lexer {
    ...
    public final void mTOKENSWITCH() throws RecognitionException {
        try {
            ...
            // etc/XQFT.g:1008:16: ( ({...}? =>n= CDataSectionLEX | {...}? =>n= DirPIConstructor | {...}? =>n= DirCommentConstLEX | {...}? =>n= LENDTAGSi | {...}? =>n= ElementContent | {...}? =>n= PragmaLEX | {...}? =>n= Comment | {...}? =>n= NumberLEX | {...}? =>n= LexSigns | {...}? =>n= S | {...}? =>n= StringLiteral | {...}? =>n= LexLiterals | {...}? =>n= QuotAttributeContent | {...}? =>n= AposAttributeContent | {...}? =>n= RSELFTERMSi | n= QUOTSi | n= DOLLARSi | n= APOSSi | n= LPARSi | n= RPARSi | n= STARSi | n= PLUSSi | n= COMMASi | n= MINUSSi | n= DOTSi | n= SLASHSi | n= COLONSi | n= SEMICOLONSi | n= LTSi | n= EQSi | n= GTSi | n= QUESTIONSi | n= ATSi | n= LBRACKSi | n= RBRACKSi | n= LBRACESi | n= PIPESi | n= RBRACSi ) )
            // etc/XQFT.g:1008:18: ({...}? =>n= CDataSectionLEX | {...}? =>n= DirPIConstructor | {...}? =>n= DirCommentConstLEX | {...}? =>n= LENDTAGSi | {...}? =>n= ElementContent | {...}? =>n= PragmaLEX | {...}? =>n= Comment | {...}? =>n= NumberLEX | {...}? =>n= LexSigns | {...}? =>n= S | {...}? =>n= StringLiteral | {...}? =>n= LexLiterals | {...}? =>n= QuotAttributeContent | {...}? =>n= AposAttributeContent | {...}? =>n= RSELFTERMSi | n= QUOTSi | n= DOLLARSi | n= APOSSi | n= LPARSi | n= RPARSi | n= STARSi | n= PLUSSi | n= COMMASi | n= MINUSSi | n= DOTSi | n= SLASHSi | n= COLONSi | n= SEMICOLONSi | n= LTSi | n= EQSi | n= GTSi | n= QUESTIONSi | n= ATSi | n= LBRACKSi | n= RBRACKSi | n= LBRACESi | n= PIPESi | n= RBRACSi )
            {
            if ( backtracking==0 ) {
              print("State is: " + state);
            }
            // etc/XQFT.g:1008:48: ({...}? =>n= CDataSectionLEX | {...}? =>n= DirPIConstructor | {...}? =>n= DirCommentConstLEX | {...}? =>n= LENDTAGSi | {...}? =>n= ElementContent | {...}? =>n= PragmaLEX | {...}? =>n= Comment | {...}? =>n= NumberLEX | {...}? =>n= LexSigns | {...}? =>n= S | {...}? =>n= StringLiteral | {...}? =>n= LexLiterals | {...}? =>n= QuotAttributeContent | {...}? =>n= AposAttributeContent | {...}? =>n= RSELFTERMSi | n= QUOTSi | n= DOLLARSi | n= APOSSi | n= LPARSi | n= RPARSi | n= STARSi | n= PLUSSi | n= COMMASi | n= MINUSSi | n= DOTSi | n= SLASHSi | n= COLONSi | n= SEMICOLONSi | n= LTSi | n= EQSi | n= GTSi | n= QUESTIONSi | n= ATSi | n= LBRACKSi | n= RBRACKSi | n= LBRACESi | n= PIPESi | n= RBRACSi )
            int alt1=38;
            alt1 = dfa1.predict(input);
            switch (alt1) {
                case 1 :
                    // etc/XQFT.g:1009:9: {...}? =>n= CDataSectionLEX
                    {
                    ...
                    break;
                case 2 :
                    // etc/XQFT.g:1011:9: {...}? =>n= DirPIConstructor
                    {
                    if ( !(state!=State.IN_TAG && state!=State.IN_QUOT_ATTRIBUTE && state!=State.IN_APOS_ATTRIBUTE) ) {
                        if (backtracking>0) {failed=true; return ;}
                        throw new FailedPredicateException(input, "TOKENSWITCH", "state!=State.IN_TAG && state!=State.IN_QUOT_ATTRIBUTE && state!=State.IN_APOS_ATTRIBUTE");
                    ...
                    break;
                case 3 :
                    // etc/XQFT.g:1013:9: {...}? =>n= DirCommentConstLEX
                    {
                    if ( !(state!=State.IN_TAG && state!=State.IN_QUOT_ATTRIBUTE && state!=State.IN_APOS_ATTRIBUTE) ) {
                        if (backtracking>0) {failed=true; return ;}
                        throw new FailedPredicateException(input, "TOKENSWITCH", "state!=State.IN_TAG && state!=State.IN_QUOT_ATTRIBUTE && state!=State.IN_APOS_ATTRIBUTE");
                ...
                case 4 :
                    ...
                    break;
                case 5 :
                    // etc/XQFT.g:1017:13: {...}? =>n= ElementContent
                    {
                    if ( !(state==State.IN_ELEMENT) ) {
                        if (backtracking>0) {failed=true; return ;}
                        throw new FailedPredicateException(input, "TOKENSWITCH", "state==State.IN_ELEMENT");
                ...
                case 10 :
                    ...
                    break;
                case 11 :
                    // etc/XQFT.g:1029:9: {...}? =>n= StringLiteral
                    {
                    if ( !(state==State.DEFAULT) ) {
                        if (backtracking>0) {failed=true; return ;}
                        throw new FailedPredicateException(input, "TOKENSWITCH", "state==State.DEFAULT");
                    ...
                    break;
                case 12 :
                    // etc/XQFT.g:1031:9: {...}? =>n= LexLiterals
                    {
                    if ( !((state==State.DEFAULT || state==State.IN_TAG)) ) {
                        if (backtracking>0) {failed=true; return ;}
                        throw new FailedPredicateException(input, "TOKENSWITCH", "(state==State.DEFAULT || state==State.IN_TAG)");
                    ...
                    break;
                case 13 :
                    // etc/XQFT.g:1033:9: {...}? =>n= QuotAttributeContent
                    {
                    ...
                    break;
                case 14 :
                    // etc/XQFT.g:1035:9: {...}? =>n= AposAttributeContent
                    {
                    ...
                    break;
                case 15 :
                    // etc/XQFT.g:1037:9: {...}? =>n= RSELFTERMSi
                    {
                ...
                case 27 :
                    ...
                    break;
                case 28 :
                    // etc/XQFT.g:1051:9: n= SEMICOLONSi
                    {
                ...
                case 31 :
                    ...
                    break;
                case 32 :
                    // etc/XQFT.g:1055:9: n= QUESTIONSi
                    {
    ...
    public final void mStringLiteral() throws RecognitionException {
        try {
            // etc/XQFT.g:1072:30: ( QUOTSi ( PredefinedEntityRef | CharRef | {...}? => QUOTSi QUOTSi | ~ ( NotChar | QUOTSi | AMPERSi ) )* QUOTSi | APOSSi ( PredefinedEntityRef | CharRef | {...}? => APOSSi APOSSi | ~ ( NotChar | APOSSi | AMPERSi ) )* APOSSi )
            int alt5=2;
            ...
            if ( (LA5_0=='\"') ) {
                ...
                NoViableAltException nvae =
                    new NoViableAltException("1072:10: fragment StringLiteral : ( QUOTSi ( PredefinedEntityRef | CharRef | {...}? => QUOTSi QUOTSi | ~ ( NotChar | QUOTSi | AMPERSi ) )* QUOTSi | APOSSi ( PredefinedEntityRef | CharRef | {...}? => APOSSi APOSSi | ~ ( NotChar | APOSSi | AMPERSi ) )* APOSSi );", 5, 0, input);

                throw nvae;
            }
            switch (alt5) {
                case 1 :
                    // etc/XQFT.g:1072:32: QUOTSi ( PredefinedEntityRef | CharRef | {...}? => QUOTSi QUOTSi | ~ ( NotChar | QUOTSi | AMPERSi ) )* QUOTSi
                    {
                    mQUOTSi(); if (failed) return ;
                    // etc/XQFT.g:1073:11: ( PredefinedEntityRef | CharRef | {...}? => QUOTSi QUOTSi | ~ ( NotChar | QUOTSi | AMPERSi ) )*
                    loop3:
                    do {
                        int alt3=5;
                    	...
                    	case 2 :
                    	    ...
                    	    break;
                    	case 3 :
                    	    // etc/XQFT.g:1073:44: {...}? => QUOTSi QUOTSi
                    	    {
                    	    ...
                    	    break;
                    	case 4 :
                    	    // etc/XQFT.g:1073:104: ~ ( NotChar | QUOTSi | AMPERSi )
                    	    {
                    ...
                    break;
                case 2 :
                    // etc/XQFT.g:1075:12: APOSSi ( PredefinedEntityRef | CharRef | {...}? => APOSSi APOSSi | ~ ( NotChar | APOSSi | AMPERSi ) )* APOSSi
                    {
                    mAPOSSi(); if (failed) return ;
                    // etc/XQFT.g:1076:11: ( PredefinedEntityRef | CharRef | {...}? => APOSSi APOSSi | ~ ( NotChar | APOSSi | AMPERSi ) )*
                    loop4:
                    do {
                        int alt4=5;
                        ...
                        switch (alt4) {
                    	case 1 :
                    	    // etc/XQFT.g:1076:12: PredefinedEntityRef
                    	    {
                    	    mPredefinedEntityRef(); if (failed) return ;
                    	...
                    	case 2 :
                    	    ...
                    	    break;
                    	case 3 :
                    	    // etc/XQFT.g:1076:44: {...}? => APOSSi APOSSi
                    	    {
                    	    if ( !((input.LA(1)=='\'' && input.LA(2)=='\'')) ) {
                    	        if (backtracking>0) {failed=true; return ;}
                    	        throw new FailedPredicateException(input, "StringLiteral", "(input.LA(1)=='\\'' && input.LA(2)=='\\'')");
                    	    ...
                    	    break;
                    	case 4 :
                    	    // etc/XQFT.g:1076:106: ~ ( NotChar | APOSSi | AMPERSi )
                    	    {
    ...
    public final void mQuotAttributeContent() throws RecognitionException {
        try {
            // etc/XQFT.g:1080:32: ( ( PredefinedEntityRef | CharRef | QuotAttrContentChar )* )
            // etc/XQFT.g:1080:34: ( PredefinedEntityRef | CharRef | QuotAttrContentChar )*
            {
            // etc/XQFT.g:1080:34: ( PredefinedEntityRef | CharRef | QuotAttrContentChar )*
            loop6:
            do {
                ...
                switch (alt6) {
            	case 1 :
            	    // etc/XQFT.g:1080:35: PredefinedEntityRef
            	    {
            	    mPredefinedEntityRef(); if (failed) return ;
            	...
            	case 2 :
            	    ...
            	    break;
            	case 3 :
            	    // etc/XQFT.g:1080:67: QuotAttrContentChar
            	    {
    ...
    public final void mAposAttributeContent() throws RecognitionException {
        try {
            // etc/XQFT.g:1081:32: ( ( PredefinedEntityRef | CharRef | AposAttrContentChar )* )
            // etc/XQFT.g:1081:34: ( PredefinedEntityRef | CharRef | AposAttrContentChar )*
            {
            // etc/XQFT.g:1081:34: ( PredefinedEntityRef | CharRef | AposAttrContentChar )*
            loop7:
            do {
            	...
            	case 2 :
            	    ...
            	    break;
            	case 3 :
            	    // etc/XQFT.g:1081:67: AposAttrContentChar
            	    {
    ...
    public final void mElementContent() throws RecognitionException {
        try {
            // etc/XQFT.g:1082:28: ( ( PredefinedEntityRef | CharRef | ElementContentChar )* )
            // etc/XQFT.g:1082:30: ( PredefinedEntityRef | CharRef | ElementContentChar )*
            {
            // etc/XQFT.g:1082:30: ( PredefinedEntityRef | CharRef | ElementContentChar )*
            loop8:
            do {
                ...
                switch (alt8) {
            	case 1 :
            	    // etc/XQFT.g:1082:31: PredefinedEntityRef
            	    {
            	    mPredefinedEntityRef(); if (failed) return ;
            	...
            	case 2 :
            	    ...
            	    break;
            	case 3 :
            	    // etc/XQFT.g:1082:63: ElementContentChar
            	    {
    ...
    public final void mPredefinedEntityRef() throws RecognitionException {
        try {
            // etc/XQFT.g:1084:30: ( AMPERSi ( 'lt' | 'gt' | 'amp' | 'quot' | 'apos' ) SEMICOLONSi )
            // etc/XQFT.g:1084:32: AMPERSi ( 'lt' | 'gt' | 'amp' | 'quot' | 'apos' ) SEMICOLONSi
            {
            mAMPERSi(); if (failed) return ;
            // etc/XQFT.g:1084:40: ( 'lt' | 'gt' | 'amp' | 'quot' | 'apos' )
            int alt9=5;
            switch ( input.LA(1) ) {
            case 'l':
                {
            ...
            case 'a':
                ...
                if ( (LA9_3=='p') ) {
                    ...
                    if (backtracking>0) {failed=true; return ;}
                    NoViableAltException nvae =
                        new NoViableAltException("1084:40: ( 'lt' | 'gt' | 'amp' | 'quot' | 'apos' )", 9, 3, input);
            ...
            default:
                if (backtracking>0) {failed=true; return ;}
                NoViableAltException nvae =
                    new NoViableAltException("1084:40: ( 'lt' | 'gt' | 'amp' | 'quot' | 'apos' )", 9, 0, input);
    ...
    public final void mCharRef() throws RecognitionException {
        try {
            // etc/XQFT.g:1086:31: ( CREFDECSi ( '0' .. '9' )+ SEMICOLONSi | CREFHEXSi ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' )+ SEMICOLONSi )
            int alt12=2;
            ...
            if ( (LA12_0=='&') ) {
                ...
                if ( (LA12_1=='#') ) {
                    ...
                    if ( (LA12_2=='x') ) {
                        ...
                        if (backtracking>0) {failed=true; return ;}
                        NoViableAltException nvae =
                            new NoViableAltException("1086:10: fragment CharRef : ( CREFDECSi ( '0' .. '9' )+ SEMICOLONSi | CREFHEXSi ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' )+ SEMICOLONSi );", 12, 2, input);
                    ...
                    if (backtracking>0) {failed=true; return ;}
                    NoViableAltException nvae =
                        new NoViableAltException("1086:10: fragment CharRef : ( CREFDECSi ( '0' .. '9' )+ SEMICOLONSi | CREFHEXSi ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' )+ SEMICOLONSi );", 12, 1, input);
                ...
                if (backtracking>0) {failed=true; return ;}
                NoViableAltException nvae =
                    new NoViableAltException("1086:10: fragment CharRef : ( CREFDECSi ( '0' .. '9' )+ SEMICOLONSi | CREFHEXSi ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' )+ SEMICOLONSi );", 12, 0, input);

                throw nvae;
            }
            switch (alt12) {
                case 1 :
                    // etc/XQFT.g:1086:33: CREFDECSi ( '0' .. '9' )+ SEMICOLONSi
                    {
                    mCREFDECSi(); if (failed) return ;
                    // etc/XQFT.g:1086:43: ( '0' .. '9' )+
                    int cnt10=0;
                    loop10:
                    do {
                        int alt10=2;
                    ...
                    break;
                case 2 :
                    // etc/XQFT.g:1087:12: CREFHEXSi ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' )+ SEMICOLONSi
                    {
                    mCREFHEXSi(); if (failed) return ;
                    // etc/XQFT.g:1087:22: ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' )+
                    int cnt11=0;
                    loop11:
                    do {
                        int alt11=2;
    ...
    public final void mCREFHEXSi() throws RecognitionException {
        try {
            // etc/XQFT.g:1089:23: ( '&#x' )
            // etc/XQFT.g:1089:25: '&#x'
            {
    ...
    public final void mElementContentChar() throws RecognitionException {
        try {
            // etc/XQFT.g:1101:30: ( ({...}? => LBRACESi LBRACESi | {...}? => RBRACSi RBRACSi | ~ ( NotChar | LBRACESi | RBRACSi | LTSi | AMPERSi ) ) )
            // etc/XQFT.g:1101:32: ({...}? => LBRACESi LBRACESi | {...}? => RBRACSi RBRACSi | ~ ( NotChar | LBRACESi | RBRACSi | LTSi | AMPERSi ) )
            {
            // etc/XQFT.g:1101:32: ({...}? => LBRACESi LBRACESi | {...}? => RBRACSi RBRACSi | ~ ( NotChar | LBRACESi | RBRACSi | LTSi | AMPERSi ) )
            int alt13=3;
            ...
            if ( (LA13_0=='{') && ((input.LA(1)=='{' && input.LA(2)=='{'))) {
                ...
                if (backtracking>0) {failed=true; return ;}
                NoViableAltException nvae =
                    new NoViableAltException("1101:32: ({...}? => LBRACESi LBRACESi | {...}? => RBRACSi RBRACSi | ~ ( NotChar | LBRACESi | RBRACSi | LTSi | AMPERSi ) )", 13, 0, input);

                throw nvae;
            }
            switch (alt13) {
                case 1 :
                    // etc/XQFT.g:1101:33: {...}? => LBRACESi LBRACESi
                    {
                    if ( !((input.LA(1)=='{' && input.LA(2)=='{')) ) {
                        if (backtracking>0) {failed=true; return ;}
                    ...
                    break;
                case 2 :
                    // etc/XQFT.g:1102:13: {...}? => RBRACSi RBRACSi
                    {
                    if ( !((input.LA(1)=='}' && input.LA(2)=='}')) ) {
                        if (backtracking>0) {failed=true; return ;}
                        throw new FailedPredicateException(input, "ElementContentChar", "(input.LA(1)=='}' && input.LA(2)=='}')");
                    ...
                    break;
                case 3 :
                    // etc/XQFT.g:1103:12: ~ ( NotChar | LBRACESi | RBRACSi | LTSi | AMPERSi )
                    {
    ...
    public final void mQuotAttrContentChar() throws RecognitionException {
        try {
            // etc/XQFT.g:1104:33: ( ({...}? => QUOTSi QUOTSi | {...}? => LBRACESi LBRACESi | {...}? => RBRACSi RBRACSi | ~ ( NotChar | LBRACESi | RBRACSi | LTSi | AMPERSi | QUOTSi ) ) )
            // etc/XQFT.g:1104:35: ({...}? => QUOTSi QUOTSi | {...}? => LBRACESi LBRACESi | {...}? => RBRACSi RBRACSi | ~ ( NotChar | LBRACESi | RBRACSi | LTSi | AMPERSi | QUOTSi ) )
            {
            // etc/XQFT.g:1104:35: ({...}? => QUOTSi QUOTSi | {...}? => LBRACESi LBRACESi | {...}? => RBRACSi RBRACSi | ~ ( NotChar | LBRACESi | RBRACSi | LTSi | AMPERSi | QUOTSi ) )
            int alt14=4;
            ...
            if ( (LA14_0=='\"') && ((input.LA(1)=='"' && input.LA(2)=='"'))) {
                ...
                if (backtracking>0) {failed=true; return ;}
                NoViableAltException nvae =
                    new NoViableAltException("1104:35: ({...}? => QUOTSi QUOTSi | {...}? => LBRACESi LBRACESi | {...}? => RBRACSi RBRACSi | ~ ( NotChar | LBRACESi | RBRACSi | LTSi | AMPERSi | QUOTSi ) )", 14, 0, input);

                throw nvae;
            }
            switch (alt14) {
                case 1 :
                    // etc/XQFT.g:1104:36: {...}? => QUOTSi QUOTSi
                    {
                    if ( !((input.LA(1)=='"' && input.LA(2)=='"')) ) {
                        if (backtracking>0) {failed=true; return ;}
                    ...
                    break;
                case 2 :
                    // etc/XQFT.g:1105:39: {...}? => LBRACESi LBRACESi
                    {
                    if ( !((input.LA(1)=='{' && input.LA(2)=='{')) ) {
                        if (backtracking>0) {failed=true; return ;}
                        throw new FailedPredicateException(input, "QuotAttrContentChar", "(input.LA(1)=='{' && input.LA(2)=='{')");
                    ...
                    break;
                case 3 :
                    // etc/XQFT.g:1106:39: {...}? => RBRACSi RBRACSi
                    {
                    if ( !((input.LA(1)=='}' && input.LA(2)=='}')) ) {
                        if (backtracking>0) {failed=true; return ;}
                        throw new FailedPredicateException(input, "QuotAttrContentChar", "(input.LA(1)=='}' && input.LA(2)=='}')");
                    ...
                    break;
                case 4 :
                    // etc/XQFT.g:1107:39: ~ ( NotChar | LBRACESi | RBRACSi | LTSi | AMPERSi | QUOTSi )
                    {
    ...
    public final void mAposAttrContentChar() throws RecognitionException {
        try {
            // etc/XQFT.g:1108:30: ( ({...}? => APOSSi APOSSi | {...}? => LBRACESi LBRACESi | {...}? => RBRACSi RBRACSi | ~ ( NotChar | LBRACESi | RBRACSi | LTSi | AMPERSi | APOSSi ) ) )
            // etc/XQFT.g:1108:32: ({...}? => APOSSi APOSSi | {...}? => LBRACESi LBRACESi | {...}? => RBRACSi RBRACSi | ~ ( NotChar | LBRACESi | RBRACSi | LTSi | AMPERSi | APOSSi ) )
            {
            // etc/XQFT.g:1108:32: ({...}? => APOSSi APOSSi | {...}? => LBRACESi LBRACESi | {...}? => RBRACSi RBRACSi | ~ ( NotChar | LBRACESi | RBRACSi | LTSi | AMPERSi | APOSSi ) )
            int alt15=4;
            ...
            if ( (LA15_0=='\'') && ((input.LA(1)=='\'' && input.LA(2)=='\''))) {
                ...
                if (backtracking>0) {failed=true; return ;}
                NoViableAltException nvae =
                    new NoViableAltException("1108:32: ({...}? => APOSSi APOSSi | {...}? => LBRACESi LBRACESi | {...}? => RBRACSi RBRACSi | ~ ( NotChar | LBRACESi | RBRACSi | LTSi | AMPERSi | APOSSi ) )", 15, 0, input);

                throw nvae;
            }
            switch (alt15) {
                case 1 :
                    // etc/XQFT.g:1108:33: {...}? => APOSSi APOSSi
                    {
                    if ( !((input.LA(1)=='\'' && input.LA(2)=='\'')) ) {
                        if (backtracking>0) {failed=true; return ;}
                    ...
                    break;
                case 2 :
                    // etc/XQFT.g:1109:12: {...}? => LBRACESi LBRACESi
                    {
                    if ( !((input.LA(1)=='{' && input.LA(2)=='{')) ) {
                        if (backtracking>0) {failed=true; return ;}
                        throw new FailedPredicateException(input, "AposAttrContentChar", "(input.LA(1)=='{' && input.LA(2)=='{')");
                    ...
                    break;
                case 3 :
                    // etc/XQFT.g:1110:12: {...}? => RBRACSi RBRACSi
                    {
                    if ( !((input.LA(1)=='}' && input.LA(2)=='}')) ) {
                        if (backtracking>0) {failed=true; return ;}
                        throw new FailedPredicateException(input, "AposAttrContentChar", "(input.LA(1)=='}' && input.LA(2)=='}')");
                    ...
                    break;
                case 4 :
                    // etc/XQFT.g:1111:12: ~ ( NotChar | LBRACESi | RBRACSi | LTSi | AMPERSi | APOSSi )
                    {
                    if ( input.LA(1)=='\u0000'||(input.LA(1)>='\t' && input.LA(1)<='\n')||input.LA(1)=='\r'||(input.LA(1)>=' ' && input.LA(1)<='%')||(input.LA(1)>='(' && input.LA(1)<=';')||(input.LA(1)>='=' && input.LA(1)<='z')||input.LA(1)=='|'||(input.LA(1)>='~' && input.LA(1)<='\uD7FF')||(input.LA(1)>='\uE000' && input.LA(1)<='\uFFFE') ) {
                        input.consume();
                    failed=false;
    ...
    public final void mCDataSectionLEX() throws RecognitionException {
        try {
            // etc/XQFT.g:1115:28: ( LCDATASi CDataContents RCDATASi )
            // etc/XQFT.g:1115:30: LCDATASi CDataContents RCDATASi
            {
            if ( backtracking==0 ) {
              prepareSubToken();
            }
    ...
    public final void mLCDATASi() throws RecognitionException {
        try {
            // etc/XQFT.g:1118:23: ( '<![CDATA[' )
            // etc/XQFT.g:1118:25: '<![CDATA['
            {
    ...
    public final void mCDataContents() throws RecognitionException {
        try {
            // etc/XQFT.g:1119:27: ( ({...}? => RBRACKSi | ~ ( RBRACKSi | NotChar ) )* )
            // etc/XQFT.g:1119:29: ({...}? => RBRACKSi | ~ ( RBRACKSi | NotChar ) )*
            {
            // etc/XQFT.g:1119:29: ({...}? => RBRACKSi | ~ ( RBRACKSi | NotChar ) )*
            loop16:
            do {
            	...
            	case 1 :
            	    ...
            	    break;
            	case 2 :
            	    // etc/XQFT.g:1119:86: ~ ( RBRACKSi | NotChar )
            	    {
            	    if ( input.LA(1)=='\u0000'||(input.LA(1)>='\t' && input.LA(1)<='\n')||input.LA(1)=='\r'||(input.LA(1)>=' ' && input.LA(1)<='\\')||(input.LA(1)>='^' && input.LA(1)<='\uD7FF')||(input.LA(1)>='\uE000' && input.LA(1)<='\uFFFE') ) {
            	        input.consume();
            	    failed=false;
    ...
    public final void mDirPIConstructor() throws RecognitionException {
        try {
            ...
            // etc/XQFT.g:1123:29: ( LPISi PiTarget ( S d= DirPiContents )? RPISi )
            // etc/XQFT.g:1123:31: LPISi PiTarget ( S d= DirPiContents )? RPISi
            {
            if ( backtracking==0 ) {
              prepareSubToken();
            }
            ...
            // etc/XQFT.g:1125:15: ( S d= DirPiContents )?
            int alt17=2;
            ...
            switch (alt17) {
                case 1 :
                    // etc/XQFT.g:1125:16: S d= DirPiContents
                    {
                    mS(); if (failed) return ;
                    if ( backtracking==0 ) {
                      prepareSubToken();
    ...
    public final void mPiTarget() throws RecognitionException {
        try {
            ...
            // etc/XQFT.g:1129:23: (n= Name {...}?)
            // etc/XQFT.g:1129:25: n= Name {...}?
            {
    ...
    public final void mName() throws RecognitionException {
        try {
            // etc/XQFT.g:1130:25: ( ( Letter | UNDERSCORESi | COLONSi ) ( NameChar )* )
            // etc/XQFT.g:1130:27: ( Letter | UNDERSCORESi | COLONSi ) ( NameChar )*
            {
    ...
    public final void mNameChar() throws RecognitionException {
        try {
            // etc/XQFT.g:1131:23: ( Letter | Digit | DOTSi | MINUSSi | UNDERSCORESi | COLONSi | CombiningChar | Extender )
            // etc/XQFT.g:
            {
    ...
    public final void mDirPiContents() throws RecognitionException {
        try {
            // etc/XQFT.g:1132:27: ( ({...}? => QUESTIONSi | ~ ( NotChar | QUESTIONSi ) )* )
            // etc/XQFT.g:1132:29: ({...}? => QUESTIONSi | ~ ( NotChar | QUESTIONSi ) )*
            {
            // etc/XQFT.g:1132:29: ({...}? => QUESTIONSi | ~ ( NotChar | QUESTIONSi ) )*
            loop19:
            do {
            	...
            	case 1 :
            	    ...
            	    break;
            	case 2 :
            	    // etc/XQFT.g:1132:66: ~ ( NotChar | QUESTIONSi )
            	    {
            	    if ( input.LA(1)=='\u0000'||(input.LA(1)>='\t' && input.LA(1)<='\n')||input.LA(1)=='\r'||(input.LA(1)>=' ' && input.LA(1)<='>')||(input.LA(1)>='@' && input.LA(1)<='\uD7FF')||(input.LA(1)>='\uE000' && input.LA(1)<='\uFFFE') ) {
            	        input.consume();
            	    failed=false;
    ...
    public final void mDirCommentConstLEX() throws RecognitionException {
        try {
            // etc/XQFT.g:1136:31: ( LCOMMENTSi DirCommentContent RCOMMENTSi )
            // etc/XQFT.g:1136:33: LCOMMENTSi DirCommentContent RCOMMENTSi
            {
            if ( backtracking==0 ) {
              prepareSubToken();
            }
    ...
    public final void mDirCommentContent() throws RecognitionException {
        try {
            // etc/XQFT.g:1140:30: ( ({...}? => MINUSSi | ~ ( NotChar | MINUSSi ) )* )
            // etc/XQFT.g:1140:32: ({...}? => MINUSSi | ~ ( NotChar | MINUSSi ) )*
            {
            // etc/XQFT.g:1140:32: ({...}? => MINUSSi | ~ ( NotChar | MINUSSi ) )*
            loop20:
            do {
            	...
            	case 1 :
            	    ...
            	    break;
            	case 2 :
            	    // etc/XQFT.g:1140:67: ~ ( NotChar | MINUSSi )
            	    {
            	    if ( input.LA(1)=='\u0000'||(input.LA(1)>='\t' && input.LA(1)<='\n')||input.LA(1)=='\r'||(input.LA(1)>=' ' && input.LA(1)<=',')||(input.LA(1)>='.' && input.LA(1)<='\uD7FF')||(input.LA(1)>='\uE000' && input.LA(1)<='\uFFFE') ) {
            	        input.consume();
            	    failed=false;
    ...
    public final void mPragmaLEX() throws RecognitionException {
        try {
            ...
            // etc/XQFT.g:1144:22: ( LPRAGSi ( S )? NCName (c= COLONSi n= NCName )? ( S p= PragmaContents )? RPRAGSi )
            // etc/XQFT.g:1144:24: LPRAGSi ( S )? NCName (c= COLONSi n= NCName )? ( S p= PragmaContents )? RPRAGSi
            {
            if ( backtracking==0 ) {
              prepareSubToken();
            }
            ...
            // etc/XQFT.g:1147:10: (c= COLONSi n= NCName )?
            int alt22=2;
            ...
            switch (alt22) {
                case 1 :
                    // etc/XQFT.g:1148:11: c= COLONSi n= NCName
                    {
                    if ( backtracking==0 ) {
                      prepareSubToken();
                    }
            ...
            // etc/XQFT.g:1151:10: ( S p= PragmaContents )?
            int alt23=2;
            ...
            switch (alt23) {
                case 1 :
                    // etc/XQFT.g:1151:11: S p= PragmaContents
                    {
                    mS(); if (failed) return ;
                    if ( backtracking==0 ) {
                      prepareSubToken();
    ...
    public final void mPragmaContents() throws RecognitionException {
        try {
            // etc/XQFT.g:1156:26: ( ({...}? => SHARPSi | ~ ( NotChar | SHARPSi ) )* )
            // etc/XQFT.g:1156:28: ({...}? => SHARPSi | ~ ( NotChar | SHARPSi ) )*
            {
            // etc/XQFT.g:1156:28: ({...}? => SHARPSi | ~ ( NotChar | SHARPSi ) )*
            loop24:
            do {
            	...
            	case 1 :
            	    ...
            	    break;
            	case 2 :
            	    // etc/XQFT.g:1156:63: ~ ( NotChar | SHARPSi )
            	    {
            	    if ( input.LA(1)=='\u0000'||(input.LA(1)>='\t' && input.LA(1)<='\n')||input.LA(1)=='\r'||(input.LA(1)>=' ' && input.LA(1)<='\"')||(input.LA(1)>='$' && input.LA(1)<='\uD7FF')||(input.LA(1)>='\uE000' && input.LA(1)<='\uFFFE') ) {
            	        input.consume();
            	    failed=false;
    ...
    public final void mComment() throws RecognitionException {
        try {
            // etc/XQFT.g:1160:26: ( LXQCOMMENTSi ({...}? Comment | {...}? => COLONSi | {...}? => LPARSi | ~ ( LPARSi | COLONSi | NotChar ) )* RXQCOMMENTSi )
            // etc/XQFT.g:1160:28: LXQCOMMENTSi ({...}? Comment | {...}? => COLONSi | {...}? => LPARSi | ~ ( LPARSi | COLONSi | NotChar ) )* RXQCOMMENTSi
            {
            mLXQCOMMENTSi(); if (failed) return ;
            // etc/XQFT.g:1161:9: ({...}? Comment | {...}? => COLONSi | {...}? => LPARSi | ~ ( LPARSi | COLONSi | NotChar ) )*
            loop25:
            do {
                int alt25=5;
            	...
            	case 3 :
            	    ...
            	    break;
            	case 4 :
            	    // etc/XQFT.g:1164:11: ~ ( LPARSi | COLONSi | NotChar )
            	    {
    ...
    public final void mNumberLEX() throws RecognitionException {
        try {
            // etc/XQFT.g:1172:24: ( ( DoubleLiteral )=> DoubleLiteral | ( DecimalLiteral )=> DecimalLiteral | ( IntegerLiteral )=> IntegerLiteral )
            int alt26=3;
            alt26 = dfa26.predict(input);
            switch (alt26) {
                case 1 :
                    // etc/XQFT.g:1172:26: ( DoubleLiteral )=> DoubleLiteral
                    {
                    ...
                    break;
                case 2 :
                    // etc/XQFT.g:1173:14: ( DecimalLiteral )=> DecimalLiteral
                    {
                    ...
                    break;
                case 3 :
                    // etc/XQFT.g:1174:12: ( IntegerLiteral )=> IntegerLiteral
                    {
    ...
    public final void mIntegerLiteral() throws RecognitionException {
        try {
            // etc/XQFT.g:1177:28: ( Digits )
            // etc/XQFT.g:1177:30: Digits
            {
    ...
    public final void mDecimalLiteral() throws RecognitionException {
        try {
            // etc/XQFT.g:1178:28: ( DOTSi Digits | Digits DOTSi ( '0' .. '9' )* )
            int alt28=2;
            ...
            if ( (LA28_0=='.') ) {
                ...
                if (backtracking>0) {failed=true; return ;}
                NoViableAltException nvae =
                    new NoViableAltException("1178:10: fragment DecimalLiteral : ( DOTSi Digits | Digits DOTSi ( '0' .. '9' )* );", 28, 0, input);

                throw nvae;
            }
            switch (alt28) {
                case 1 :
                    // etc/XQFT.g:1178:30: DOTSi Digits
                    {
                    mDOTSi(); if (failed) return ;
                    mDigits(); if (failed) return ;
                    ...
                    break;
                case 2 :
                    // etc/XQFT.g:1179:12: Digits DOTSi ( '0' .. '9' )*
                    {
                    mDigits(); if (failed) return ;
                    mDOTSi(); if (failed) return ;
                    // etc/XQFT.g:1179:25: ( '0' .. '9' )*
                    loop27:
                    do {
                        int alt27=2;
    ...
    public final void mDoubleLiteral() throws RecognitionException {
        try {
            // etc/XQFT.g:1180:27: ( ( DOTSi Digits | Digits ( DOTSi ( '0' .. '9' )* )? ) ( 'e' | 'E' ) ( PLUSSi | MINUSSi )? Digits )
            // etc/XQFT.g:1180:29: ( DOTSi Digits | Digits ( DOTSi ( '0' .. '9' )* )? ) ( 'e' | 'E' ) ( PLUSSi | MINUSSi )? Digits
            {
            // etc/XQFT.g:1180:29: ( DOTSi Digits | Digits ( DOTSi ( '0' .. '9' )* )? )
            int alt31=2;
            ...
            if ( (LA31_0=='.') ) {
                ...
                if (backtracking>0) {failed=true; return ;}
                NoViableAltException nvae =
                    new NoViableAltException("1180:29: ( DOTSi Digits | Digits ( DOTSi ( '0' .. '9' )* )? )", 31, 0, input);

                throw nvae;
            }
            switch (alt31) {
                case 1 :
                    // etc/XQFT.g:1181:11: DOTSi Digits
                    {
                    mDOTSi(); if (failed) return ;
                    mDigits(); if (failed) return ;
                    ...
                    break;
                case 2 :
                    // etc/XQFT.g:1182:13: Digits ( DOTSi ( '0' .. '9' )* )?
                    {
                    mDigits(); if (failed) return ;
                    // etc/XQFT.g:1182:20: ( DOTSi ( '0' .. '9' )* )?
                    int alt30=2;
                    ...
                    switch (alt30) {
                        case 1 :
                            // etc/XQFT.g:1182:22: DOTSi ( '0' .. '9' )*
                            {
                            mDOTSi(); if (failed) return ;
                            // etc/XQFT.g:1182:28: ( '0' .. '9' )*
                            loop29:
                            do {
                                int alt29=2;
            ...
            // etc/XQFT.g:1184:22: ( PLUSSi | MINUSSi )?
            int alt32=2;
    ...
    public final void mNCName() throws RecognitionException {
        try {
            // etc/XQFT.g:1186:33: ( NCNameStartChar ( NCNameChar )* )
            // etc/XQFT.g:1186:35: NCNameStartChar ( NCNameChar )*
            {
            mNCNameStartChar(); if (failed) return ;
            // etc/XQFT.g:1186:51: ( NCNameChar )*
            loop33:
            do {
                int alt33=2;
    ...
    public final void mNCNameChar() throws RecognitionException {
        try {
            // etc/XQFT.g:1187:29: ( Letter | Digit | DOTSi | MINUSSi | UNDERSCORESi | CombiningChar | Extender )
            // etc/XQFT.g:
            {
    ...
    public final void mNCNameStartChar() throws RecognitionException {
        try {
            // etc/XQFT.g:1188:33: ( Letter | UNDERSCORESi )
            // etc/XQFT.g:
            {
    ...
    public final void mLexLiterals() throws RecognitionException {
        try {
            ...
            // etc/XQFT.g:1192:22: (n= NCName )
            // etc/XQFT.g:1192:24: n= NCName
            {
    ...
    public final void mLexSigns() throws RecognitionException {
        try {
            // etc/XQFT.g:1342:20: ( NODEBEFORESi | LTOREQSi | GTOREQSi | NODEAFTERSi | DBLCOLONSi | ASSIGNSi | DBLSLASHSi | DOTDOTSi | NEQSi )
            int alt34=9;
            switch ( input.LA(1) ) {
            case '<':
                {
                ...
                if ( (LA34_1=='=') ) {
                    ...
                    if (backtracking>0) {failed=true; return ;}
                    NoViableAltException nvae =
                        new NoViableAltException("1342:10: fragment LexSigns : ( NODEBEFORESi | LTOREQSi | GTOREQSi | NODEAFTERSi | DBLCOLONSi | ASSIGNSi | DBLSLASHSi | DOTDOTSi | NEQSi );", 34, 1, input);
            ...
            case '>':
                ...
                if ( (LA34_2=='=') ) {
                    ...
                    if (backtracking>0) {failed=true; return ;}
                    NoViableAltException nvae =
                        new NoViableAltException("1342:10: fragment LexSigns : ( NODEBEFORESi | LTOREQSi | GTOREQSi | NODEAFTERSi | DBLCOLONSi | ASSIGNSi | DBLSLASHSi | DOTDOTSi | NEQSi );", 34, 2, input);
            ...
            case ':':
                ...
                if ( (LA34_3==':') ) {
                    ...
                    if (backtracking>0) {failed=true; return ;}
                    NoViableAltException nvae =
                        new NoViableAltException("1342:10: fragment LexSigns : ( NODEBEFORESi | LTOREQSi | GTOREQSi | NODEAFTERSi | DBLCOLONSi | ASSIGNSi | DBLSLASHSi | DOTDOTSi | NEQSi );", 34, 3, input);
            ...
            default:
                if (backtracking>0) {failed=true; return ;}
                NoViableAltException nvae =
                    new NoViableAltException("1342:10: fragment LexSigns : ( NODEBEFORESi | LTOREQSi | GTOREQSi | NODEAFTERSi | DBLCOLONSi | ASSIGNSi | DBLSLASHSi | DOTDOTSi | NEQSi );", 34, 0, input);
            ...
            switch (alt34) {
                case 1 :
                    // etc/XQFT.g:1342:22: NODEBEFORESi
                    {
    ...
    public final void mUNDERSCORESi() throws RecognitionException {
        try {
            // etc/XQFT.g:1390:26: ( '_' )
            // etc/XQFT.g:1390:28: '_'
            {
    ...
    public final void mALL() throws RecognitionException {
        try {
            // etc/XQFT.g:1397:19: ( 'all' )
            // etc/XQFT.g:1397:21: 'all'
            {
    ...
    public final void mANY() throws RecognitionException {
        try {
            // etc/XQFT.g:1398:19: ( 'any' )
            // etc/XQFT.g:1398:21: 'any'
            {
    ...
    public final void mANCESTOR() throws RecognitionException {
        try {
            // etc/XQFT.g:1399:23: ( 'ancestor' )
            // etc/XQFT.g:1399:25: 'ancestor'
            {
    ...
    public final void mANCESTOR_OR_SELF() throws RecognitionException {
        try {
            // etc/XQFT.g:1400:29: ( 'ancestor-or-self' )
            // etc/XQFT.g:1400:31: 'ancestor-or-self'
            {
    ...
    public final void mAND() throws RecognitionException {
        try {
            // etc/XQFT.g:1401:19: ( 'and' )
            // etc/XQFT.g:1401:21: 'and'
            {
    ...
    public final void mAS() throws RecognitionException {
        try {
            // etc/XQFT.g:1402:18: ( 'as' )
            // etc/XQFT.g:1402:20: 'as'
            {
    ...
    public final void mASCENDING() throws RecognitionException {
        try {
            // etc/XQFT.g:1403:24: ( 'ascending' )
            // etc/XQFT.g:1403:26: 'ascending'
            {
    ...
    public final void mAT() throws RecognitionException {
        try {
            // etc/XQFT.g:1404:18: ( 'at' )
            // etc/XQFT.g:1404:20: 'at'
            {
    ...
    public final void mATTRIBUTE() throws RecognitionException {
        try {
            // etc/XQFT.g:1405:24: ( 'attribute' )
            // etc/XQFT.g:1405:26: 'attribute'
            {
    ...
    public final void mBASE_URI() throws RecognitionException {
        try {
            // etc/XQFT.g:1406:23: ( 'base-uri' )
            // etc/XQFT.g:1406:25: 'base-uri'
            {
    ...
    public final void mBY() throws RecognitionException {
        try {
            // etc/XQFT.g:1407:18: ( 'by' )
            // etc/XQFT.g:1407:20: 'by'
            {
    ...
    public final void mBOUNDARYSPACE() throws RecognitionException {
        try {
            // etc/XQFT.g:1408:27: ( 'boundary-space' )
            // etc/XQFT.g:1408:29: 'boundary-space'
            {
    ...
    public final void mCASE() throws RecognitionException {
        try {
            // etc/XQFT.g:1409:20: ( 'case' )
            // etc/XQFT.g:1409:22: 'case'
            {
    ...
    public final void mCAST() throws RecognitionException {
        try {
            // etc/XQFT.g:1410:20: ( 'cast' )
            // etc/XQFT.g:1410:22: 'cast'
            {
    ...
    public final void mCASTABLE() throws RecognitionException {
        try {
            // etc/XQFT.g:1411:23: ( 'castable' )
            // etc/XQFT.g:1411:25: 'castable'
            {
    ...
    public final void mCHILD() throws RecognitionException {
        try {
            // etc/XQFT.g:1412:21: ( 'child' )
            // etc/XQFT.g:1412:23: 'child'
            {
    ...
    public final void mCOLLATION() throws RecognitionException {
        try {
            // etc/XQFT.g:1413:24: ( 'collation' )
            // etc/XQFT.g:1413:26: 'collation'
            {
    ...
    public final void mCOMMENT() throws RecognitionException {
        try {
            // etc/XQFT.g:1414:22: ( 'comment' )
            // etc/XQFT.g:1414:24: 'comment'
            {
    ...
    public final void mCONSTRUCTION() throws RecognitionException {
        try {
            // etc/XQFT.g:1415:26: ( 'construction' )
            // etc/XQFT.g:1415:28: 'construction'
            {
    ...
    public final void mCONTENT() throws RecognitionException {
        try {
            // etc/XQFT.g:1416:22: ( 'content' )
            // etc/XQFT.g:1416:24: 'content'
            {
    ...
    public final void mCOPY_NAMESPACES() throws RecognitionException {
        try {
            // etc/XQFT.g:1417:28: ( 'copy-namespaces' )
            // etc/XQFT.g:1417:30: 'copy-namespaces'
            {
    ...
    public final void mDECLARE() throws RecognitionException {
        try {
            // etc/XQFT.g:1418:22: ( 'declare' )
            // etc/XQFT.g:1418:24: 'declare'
            {
    ...
    public final void mDEFAULT() throws RecognitionException {
        try {
            // etc/XQFT.g:1419:22: ( 'default' )
            // etc/XQFT.g:1419:24: 'default'
            {
    ...
    public final void mDESCENDANT() throws RecognitionException {
        try {
            // etc/XQFT.g:1420:24: ( 'descendant' )
            // etc/XQFT.g:1420:26: 'descendant'
            {
    ...
    public final void mDESCENDANT_OR_SELF() throws RecognitionException {
        try {
            // etc/XQFT.g:1421:30: ( 'descendant-or-self' )
            // etc/XQFT.g:1421:32: 'descendant-or-self'
            {
    ...
    public final void mDESCENDING() throws RecognitionException {
        try {
            // etc/XQFT.g:1422:24: ( 'descending' )
            // etc/XQFT.g:1422:26: 'descending'
            {
    ...
    public final void mDIACRITICS() throws RecognitionException {
        try {
            // etc/XQFT.g:1423:24: ( 'diacritics' )
            // etc/XQFT.g:1423:26: 'diacritics'
            {
    ...
    public final void mDIFFERENT() throws RecognitionException {
        try {
            // etc/XQFT.g:1424:24: ( 'different' )
            // etc/XQFT.g:1424:26: 'different'
            {
    ...
    public final void mDISTANCE() throws RecognitionException {
        try {
            // etc/XQFT.g:1425:23: ( 'distance' )
            // etc/XQFT.g:1425:25: 'distance'
            {
    ...
    public final void mDIV() throws RecognitionException {
        try {
            // etc/XQFT.g:1426:19: ( 'div' )
            // etc/XQFT.g:1426:21: 'div'
            {
    ...
    public final void mDOCUMENT() throws RecognitionException {
        try {
            // etc/XQFT.g:1427:23: ( 'document' )
            // etc/XQFT.g:1427:25: 'document'
            {
    ...
    public final void mDOCUMENT_NODE() throws RecognitionException {
        try {
            // etc/XQFT.g:1428:27: ( 'document-node' )
            // etc/XQFT.g:1428:29: 'document-node'
            {
    ...
    public final void mELEMENT() throws RecognitionException {
        try {
            // etc/XQFT.g:1429:22: ( 'element' )
            // etc/XQFT.g:1429:24: 'element'
            {
    ...
    public final void mELSE() throws RecognitionException {
        try {
            // etc/XQFT.g:1430:20: ( 'else' )
            // etc/XQFT.g:1430:22: 'else'
            {
    ...
    public final void mENCODING() throws RecognitionException {
        try {
            // etc/XQFT.g:1431:23: ( 'encoding' )
            // etc/XQFT.g:1431:25: 'encoding'
            {
    ...
    public final void mEND() throws RecognitionException {
        try {
            // etc/XQFT.g:1432:19: ( 'end' )
            // etc/XQFT.g:1432:21: 'end'
            {
    ...
    public final void mENTIRE() throws RecognitionException {
        try {
            // etc/XQFT.g:1433:21: ( 'entire' )
            // etc/XQFT.g:1433:23: 'entire'
            {
    ...
    public final void mEMPTY() throws RecognitionException {
        try {
            // etc/XQFT.g:1434:21: ( 'empty' )
            // etc/XQFT.g:1434:23: 'empty'
            {
    ...
    public final void mEMPTY_SEQUENCE() throws RecognitionException {
        try {
            // etc/XQFT.g:1435:27: ( 'empty-sequence' )
            // etc/XQFT.g:1435:29: 'empty-sequence'
            {
    ...
    public final void mEQ() throws RecognitionException {
        try {
            // etc/XQFT.g:1436:18: ( 'eq' )
            // etc/XQFT.g:1436:20: 'eq'
            {
    ...
    public final void mEVERY() throws RecognitionException {
        try {
            // etc/XQFT.g:1437:21: ( 'every' )
            // etc/XQFT.g:1437:23: 'every'
            {
    ...
    public final void mEXACTLY() throws RecognitionException {
        try {
            // etc/XQFT.g:1438:22: ( 'exactly' )
            // etc/XQFT.g:1438:24: 'exactly'
            {
    ...
    public final void mEXCEPT() throws RecognitionException {
        try {
            // etc/XQFT.g:1439:21: ( 'except' )
            // etc/XQFT.g:1439:23: 'except'
            {
    ...
    public final void mEXTERNAL() throws RecognitionException {
        try {
            // etc/XQFT.g:1440:23: ( 'external' )
            // etc/XQFT.g:1440:25: 'external'
            {
    ...
    public final void mFOLLOWING() throws RecognitionException {
        try {
            // etc/XQFT.g:1441:24: ( 'following' )
            // etc/XQFT.g:1441:26: 'following'
            {
    ...
    public final void mFOLLOWING_SIBLING() throws RecognitionException {
        try {
            // etc/XQFT.g:1442:30: ( 'following-sibling' )
            // etc/XQFT.g:1442:32: 'following-sibling'
            {
    ...
    public final void mFOR() throws RecognitionException {
        try {
            // etc/XQFT.g:1443:19: ( 'for' )
            // etc/XQFT.g:1443:21: 'for'
            {
    ...
    public final void mFROM() throws RecognitionException {
        try {
            // etc/XQFT.g:1444:20: ( 'from' )
            // etc/XQFT.g:1444:22: 'from'
            {
    ...
    public final void mFTAND() throws RecognitionException {
        try {
            // etc/XQFT.g:1445:21: ( 'ftand' )
            // etc/XQFT.g:1445:23: 'ftand'
            {
    ...
    public final void mFTCONTAINS() throws RecognitionException {
        try {
            // etc/XQFT.g:1446:24: ( 'ftcontains' )
            // etc/XQFT.g:1446:26: 'ftcontains'
            {
    ...
    public final void mFTNOT() throws RecognitionException {
        try {
            // etc/XQFT.g:1447:21: ( 'ftnot' )
            // etc/XQFT.g:1447:23: 'ftnot'
            {
    ...
    public final void mFTOPTION() throws RecognitionException {
        try {
            // etc/XQFT.g:1448:23: ( 'ft-option' )
            // etc/XQFT.g:1448:25: 'ft-option'
            {
    ...
    public final void mFTOR() throws RecognitionException {
        try {
            // etc/XQFT.g:1449:20: ( 'ftor' )
            // etc/XQFT.g:1449:22: 'ftor'
            {
    ...
    public final void mFUNCTION() throws RecognitionException {
        try {
            // etc/XQFT.g:1450:23: ( 'function' )
            // etc/XQFT.g:1450:25: 'function'
            {
    ...
    public final void mGE() throws RecognitionException {
        try {
            // etc/XQFT.g:1451:18: ( 'ge' )
            // etc/XQFT.g:1451:20: 'ge'
            {
    ...
    public final void mGREATEST() throws RecognitionException {
        try {
            // etc/XQFT.g:1452:23: ( 'greatest' )
            // etc/XQFT.g:1452:25: 'greatest'
            {
    ...
    public final void mGT() throws RecognitionException {
        try {
            // etc/XQFT.g:1453:18: ( 'gt' )
            // etc/XQFT.g:1453:20: 'gt'
            {
            match("gt"); if (failed) return ;
    ...
    public final void mIDIV() throws RecognitionException {
        try {
            // etc/XQFT.g:1454:20: ( 'idiv' )
            // etc/XQFT.g:1454:22: 'idiv'
            {
    ...
    public final void mIF() throws RecognitionException {
        try {
            // etc/XQFT.g:1455:18: ( 'if' )
            // etc/XQFT.g:1455:20: 'if'
            {
    ...
    public final void mIMPORT() throws RecognitionException {
        try {
            // etc/XQFT.g:1456:21: ( 'import' )
            // etc/XQFT.g:1456:23: 'import'
            {
    ...
    public final void mIN() throws RecognitionException {
        try {
            // etc/XQFT.g:1457:18: ( 'in' )
            // etc/XQFT.g:1457:20: 'in'
            {
    ...
    public final void mINHERIT() throws RecognitionException {
        try {
            // etc/XQFT.g:1458:22: ( 'inherit' )
            // etc/XQFT.g:1458:24: 'inherit'
            {
    ...
    public final void mINSENSITIVE() throws RecognitionException {
        try {
            // etc/XQFT.g:1459:25: ( 'insensitive' )
            // etc/XQFT.g:1459:27: 'insensitive'
            {
    ...
    public final void mINSTANCE() throws RecognitionException {
        try {
            // etc/XQFT.g:1460:23: ( 'instance' )
            // etc/XQFT.g:1460:25: 'instance'
            {
    ...
    public final void mINTERSECT() throws RecognitionException {
        try {
            // etc/XQFT.g:1461:24: ( 'intersect' )
            // etc/XQFT.g:1461:26: 'intersect'
            {
    ...
    public final void mIS() throws RecognitionException {
        try {
            // etc/XQFT.g:1462:18: ( 'is' )
            // etc/XQFT.g:1462:20: 'is'
            {
    ...
    public final void mITEM() throws RecognitionException {
        try {
            // etc/XQFT.g:1463:20: ( 'item' )
            // etc/XQFT.g:1463:22: 'item'
            {
    ...
    public final void mLANGUAGE() throws RecognitionException {
        try {
            // etc/XQFT.g:1464:23: ( 'language' )
            // etc/XQFT.g:1464:25: 'language'
            {
    ...
    public final void mLAX() throws RecognitionException {
        try {
            // etc/XQFT.g:1465:19: ( 'lax' )
            // etc/XQFT.g:1465:21: 'lax'
            {
    ...
    public final void mLE() throws RecognitionException {
        try {
            // etc/XQFT.g:1466:18: ( 'le' )
            // etc/XQFT.g:1466:20: 'le'
            {
    ...
    public final void mLEAST() throws RecognitionException {
        try {
            // etc/XQFT.g:1467:21: ( 'least' )
            // etc/XQFT.g:1467:23: 'least'
            {
    ...
    public final void mLET() throws RecognitionException {
        try {
            // etc/XQFT.g:1468:19: ( 'let' )
            // etc/XQFT.g:1468:21: 'let'
            {
    ...
    public final void mLEVELS() throws RecognitionException {
        try {
            // etc/XQFT.g:1469:21: ( 'levels' )
            // etc/XQFT.g:1469:23: 'levels'
            {
    ...
    public final void mLOWERCASE() throws RecognitionException {
        try {
            // etc/XQFT.g:1470:24: ( 'lowercase' )
            // etc/XQFT.g:1470:26: 'lowercase'
            {
    ...
    public final void mLT() throws RecognitionException {
        try {
            // etc/XQFT.g:1471:18: ( 'lt' )
            // etc/XQFT.g:1471:20: 'lt'
            {
            match("lt"); if (failed) return ;
    ...
    public final void mMOD() throws RecognitionException {
        try {
            // etc/XQFT.g:1472:19: ( 'mod' )
            // etc/XQFT.g:1472:21: 'mod'
            {
    ...
    public final void mMODULE() throws RecognitionException {
        try {
            // etc/XQFT.g:1473:21: ( 'module' )
            // etc/XQFT.g:1473:23: 'module'
            {
    ...
    public final void mMOST() throws RecognitionException {
        try {
            // etc/XQFT.g:1474:20: ( 'most' )
            // etc/XQFT.g:1474:22: 'most'
            {
    ...
    public final void mNAMESPACE() throws RecognitionException {
        try {
            // etc/XQFT.g:1475:24: ( 'namespace' )
            // etc/XQFT.g:1475:26: 'namespace'
            {
    ...
    public final void mNE() throws RecognitionException {
        try {
            // etc/XQFT.g:1476:18: ( 'ne' )
            // etc/XQFT.g:1476:20: 'ne'
            {
    ...
    public final void mNODE() throws RecognitionException {
        try {
            // etc/XQFT.g:1477:20: ( 'node' )
            // etc/XQFT.g:1477:22: 'node'
            {
    ...
    public final void mNOINHERIT() throws RecognitionException {
        try {
            // etc/XQFT.g:1478:24: ( 'no-inherit' )
            // etc/XQFT.g:1478:26: 'no-inherit'
            {
    ...
    public final void mNOPRESERVE() throws RecognitionException {
        try {
            // etc/XQFT.g:1479:24: ( 'no-preserve' )
            // etc/XQFT.g:1479:26: 'no-preserve'
            {
    ...
    public final void mNOT() throws RecognitionException {
        try {
            // etc/XQFT.g:1480:19: ( 'not' )
            // etc/XQFT.g:1480:21: 'not'
            {
    ...
    public final void mOCCURS() throws RecognitionException {
        try {
            // etc/XQFT.g:1481:21: ( 'occurs' )
            // etc/XQFT.g:1481:23: 'occurs'
            {
    ...
    public final void mOF() throws RecognitionException {
        try {
            // etc/XQFT.g:1482:18: ( 'of' )
            // etc/XQFT.g:1482:20: 'of'
            {
    ...
    public final void mOPTION() throws RecognitionException {
        try {
            // etc/XQFT.g:1483:21: ( 'option' )
            // etc/XQFT.g:1483:23: 'option'
            {
    ...
    public final void mOR() throws RecognitionException {
        try {
            // etc/XQFT.g:1484:18: ( 'or' )
            // etc/XQFT.g:1484:20: 'or'
            {
    ...
    public final void mORDER() throws RecognitionException {
        try {
            // etc/XQFT.g:1485:21: ( 'order' )
            // etc/XQFT.g:1485:23: 'order'
            {
    ...
    public final void mORDERED() throws RecognitionException {
        try {
            // etc/XQFT.g:1486:22: ( 'ordered' )
            // etc/XQFT.g:1486:24: 'ordered'
            {
    ...
    public final void mORDERING() throws RecognitionException {
        try {
            // etc/XQFT.g:1487:23: ( 'ordering' )
            // etc/XQFT.g:1487:25: 'ordering'
            {
    ...
    public final void mPARAGRAPH() throws RecognitionException {
        try {
            // etc/XQFT.g:1488:24: ( 'paragraph' )
            // etc/XQFT.g:1488:26: 'paragraph'
            {
    ...
    public final void mPARAGRAPHS() throws RecognitionException {
        try {
            // etc/XQFT.g:1489:24: ( 'paragraphs' )
            // etc/XQFT.g:1489:26: 'paragraphs'
            {
    ...
    public final void mPARENT() throws RecognitionException {
        try {
            // etc/XQFT.g:1490:21: ( 'parent' )
            // etc/XQFT.g:1490:23: 'parent'
            {
    ...
    public final void mPHRASE() throws RecognitionException {
        try {
            // etc/XQFT.g:1491:21: ( 'phrase' )
            // etc/XQFT.g:1491:23: 'phrase'
            {
    ...
    public final void mPRECEDING() throws RecognitionException {
        try {
            // etc/XQFT.g:1492:24: ( 'preceding' )
            // etc/XQFT.g:1492:26: 'preceding'
            {
    ...
    public final void mPRECEDING_SIBLING() throws RecognitionException {
        try {
            // etc/XQFT.g:1493:30: ( 'preceding-sibling' )
            // etc/XQFT.g:1493:32: 'preceding-sibling'
            {
    ...
    public final void mPRESERVE() throws RecognitionException {
        try {
            // etc/XQFT.g:1494:23: ( 'preserve' )
            // etc/XQFT.g:1494:25: 'preserve'
            {
    ...
    public final void mPROCESSING_INSTRUCTION() throws RecognitionException {
        try {
            // etc/XQFT.g:1495:33: ( 'processing-instruction' )
            // etc/XQFT.g:1495:35: 'processing-instruction'
            {
    ...
    public final void mRELATIONSHIP() throws RecognitionException {
        try {
            // etc/XQFT.g:1496:26: ( 'relationship' )
            // etc/XQFT.g:1496:28: 'relationship'
            {
    ...
    public final void mRETURN() throws RecognitionException {
        try {
            // etc/XQFT.g:1497:21: ( 'return' )
            // etc/XQFT.g:1497:23: 'return'
            {
    ...
    public final void mSAME() throws RecognitionException {
        try {
            // etc/XQFT.g:1498:20: ( 'same' )
            // etc/XQFT.g:1498:22: 'same'
            {
    ...
    public final void mSATISFIES() throws RecognitionException {
        try {
            // etc/XQFT.g:1499:24: ( 'satisfies' )
            // etc/XQFT.g:1499:26: 'satisfies'
            {
    ...
    public final void mSCHEMA() throws RecognitionException {
        try {
            // etc/XQFT.g:1500:21: ( 'schema' )
            // etc/XQFT.g:1500:23: 'schema'
            {
    ...
    public final void mSCHEMA_ATTRIBUTE() throws RecognitionException {
        try {
            // etc/XQFT.g:1501:29: ( 'schema-attribute' )
            // etc/XQFT.g:1501:31: 'schema-attribute'
            {
    ...
    public final void mSCHEMA_ELEMENT() throws RecognitionException {
        try {
            // etc/XQFT.g:1502:28: ( 'schema-element' )
            // etc/XQFT.g:1502:30: 'schema-element'
            {
    ...
    public final void mSCORE() throws RecognitionException {
        try {
            // etc/XQFT.g:1503:21: ( 'score' )
            // etc/XQFT.g:1503:23: 'score'
            {
    ...
    public final void mSELF() throws RecognitionException {
        try {
            // etc/XQFT.g:1504:20: ( 'self' )
            // etc/XQFT.g:1504:22: 'self'
            {
    ...
    public final void mSENSITIVE() throws RecognitionException {
        try {
            // etc/XQFT.g:1505:24: ( 'sensitive' )
            // etc/XQFT.g:1505:26: 'sensitive'
            {
    ...
    public final void mSENTENCES() throws RecognitionException {
        try {
            // etc/XQFT.g:1506:24: ( 'sentences' )
            // etc/XQFT.g:1506:26: 'sentences'
            {
    ...
    public final void mSENTENCE() throws RecognitionException {
        try {
            // etc/XQFT.g:1507:23: ( 'sentence' )
            // etc/XQFT.g:1507:25: 'sentence'
            {
    ...
    public final void mSOME() throws RecognitionException {
        try {
            // etc/XQFT.g:1508:20: ( 'some' )
            // etc/XQFT.g:1508:22: 'some'
            {
    ...
    public final void mSTABLE() throws RecognitionException {
        try {
            // etc/XQFT.g:1509:21: ( 'stable' )
            // etc/XQFT.g:1509:23: 'stable'
            {
    ...
    public final void mSTART() throws RecognitionException {
        try {
            // etc/XQFT.g:1510:21: ( 'start' )
            // etc/XQFT.g:1510:23: 'start'
            {
    ...
    public final void mSTEMMING() throws RecognitionException {
        try {
            // etc/XQFT.g:1511:23: ( 'stemming' )
            // etc/XQFT.g:1511:25: 'stemming'
            {
    ...
    public final void mSTOP() throws RecognitionException {
        try {
            // etc/XQFT.g:1512:20: ( 'stop' )
            // etc/XQFT.g:1512:22: 'stop'
            {
    ...
    public final void mSTRICT() throws RecognitionException {
        try {
            // etc/XQFT.g:1513:21: ( 'strict' )
            // etc/XQFT.g:1513:23: 'strict'
            {
    ...
    public final void mSTRIP() throws RecognitionException {
        try {
            // etc/XQFT.g:1514:21: ( 'strip' )
            // etc/XQFT.g:1514:23: 'strip'
            {
    ...
    public final void mTEXT() throws RecognitionException {
        try {
            // etc/XQFT.g:1515:20: ( 'text' )
            // etc/XQFT.g:1515:22: 'text'
            {
    ...
    public final void mTHESAURUS() throws RecognitionException {
        try {
            // etc/XQFT.g:1516:24: ( 'thesaurus' )
            // etc/XQFT.g:1516:26: 'thesaurus'
            {
    ...
    public final void mTHEN() throws RecognitionException {
        try {
            // etc/XQFT.g:1517:20: ( 'then' )
            // etc/XQFT.g:1517:22: 'then'
            {
    ...
    public final void mTIMES() throws RecognitionException {
        try {
            // etc/XQFT.g:1518:21: ( 'times' )
            // etc/XQFT.g:1518:23: 'times'
            {
    ...
    public final void mTO() throws RecognitionException {
        try {
            // etc/XQFT.g:1519:18: ( 'to' )
            // etc/XQFT.g:1519:20: 'to'
            {
    ...
    public final void mTREAT() throws RecognitionException {
        try {
            // etc/XQFT.g:1520:21: ( 'treat' )
            // etc/XQFT.g:1520:23: 'treat'
            {
    ...
    public final void mTYPESWITCH() throws RecognitionException {
        try {
            // etc/XQFT.g:1521:24: ( 'typeswitch' )
            // etc/XQFT.g:1521:26: 'typeswitch'
            {
    ...
    public final void mUNION() throws RecognitionException {
        try {
            // etc/XQFT.g:1522:21: ( 'union' )
            // etc/XQFT.g:1522:23: 'union'
            {
    ...
    public final void mUNORDERED() throws RecognitionException {
        try {
            // etc/XQFT.g:1523:24: ( 'unordered' )
            // etc/XQFT.g:1523:26: 'unordered'
            {
    ...
    public final void mUPPERCASE() throws RecognitionException {
        try {
            // etc/XQFT.g:1524:24: ( 'uppercase' )
            // etc/XQFT.g:1524:26: 'uppercase'
            {
    ...
    public final void mVALIDATE() throws RecognitionException {
        try {
            // etc/XQFT.g:1525:23: ( 'validate' )
            // etc/XQFT.g:1525:25: 'validate'
            {
    ...
    public final void mVARIABLE() throws RecognitionException {
        try {
            // etc/XQFT.g:1526:23: ( 'variable' )
            // etc/XQFT.g:1526:25: 'variable'
            {
    ...
    public final void mVERSION() throws RecognitionException {
        try {
            // etc/XQFT.g:1527:22: ( 'version' )
            // etc/XQFT.g:1527:24: 'version'
            {
    ...
    public final void mWEIGHT() throws RecognitionException {
        try {
            // etc/XQFT.g:1528:21: ( 'weight' )
            // etc/XQFT.g:1528:23: 'weight'
            {
    ...
    public final void mWHERE() throws RecognitionException {
        try {
            // etc/XQFT.g:1529:21: ( 'where' )
            // etc/XQFT.g:1529:23: 'where'
            {
    ...
    public final void mWILDCARDS() throws RecognitionException {
        try {
            // etc/XQFT.g:1530:24: ( 'wildcards' )
            // etc/XQFT.g:1530:26: 'wildcards'
            {
    ...
    public final void mWINDOW() throws RecognitionException {
        try {
            // etc/XQFT.g:1531:21: ( 'window' )
            // etc/XQFT.g:1531:23: 'window'
            {
    ...
    public final void mWITH() throws RecognitionException {
        try {
            // etc/XQFT.g:1532:20: ( 'with' )
            // etc/XQFT.g:1532:22: 'with'
            {
    ...
    public final void mWITHOUT() throws RecognitionException {
        try {
            // etc/XQFT.g:1533:22: ( 'without' )
            // etc/XQFT.g:1533:24: 'without'
            {
    ...
    public final void mWORD() throws RecognitionException {
        try {
            // etc/XQFT.g:1534:20: ( 'word' )
            // etc/XQFT.g:1534:22: 'word'
            {
    ...
    public final void mWORDS() throws RecognitionException {
        try {
            // etc/XQFT.g:1535:21: ( 'words' )
            // etc/XQFT.g:1535:23: 'words'
            {
    ...
    public final void mXQUERY() throws RecognitionException {
        try {
            // etc/XQFT.g:1536:21: ( 'xquery' )
            // etc/XQFT.g:1536:23: 'xquery'
            {
    ...
    public final void mCleanChar() throws RecognitionException {
        try {
            // etc/XQFT.g:1545:25: ( S | BaseChar | Ideographic | CombiningChar | Extender | Digit | ExtraChar | EXCLSi | SHARPSi | DOLLARSi | LPARSi | RPARSi | STARSi | PLUSSi | COMMASi | DOTSi | SLASHSi | COLONSi | SEMICOLONSi | EQSi | GTSi | QUESTIONSi | ATSi | LBRACKSi | BACKSLASHSi | RBRACKSi | UNDERSCORESi | PIPESi )
            int alt35=28;
            ...
            if ( ((LA35_0>='\t' && LA35_0<='\n')||LA35_0=='\r'||LA35_0==' ') ) {
                ...
                if (backtracking>0) {failed=true; return ;}
                NoViableAltException nvae =
                    new NoViableAltException("1545:10: fragment CleanChar : ( S | BaseChar | Ideographic | CombiningChar | Extender | Digit | ExtraChar | EXCLSi | SHARPSi | DOLLARSi | LPARSi | RPARSi | STARSi | PLUSSi | COMMASi | DOTSi | SLASHSi | COLONSi | SEMICOLONSi | EQSi | GTSi | QUESTIONSi | ATSi | LBRACKSi | BACKSLASHSi | RBRACKSi | UNDERSCORESi | PIPESi );", 35, 0, input);

                throw nvae;
            }
            switch (alt35) {
                case 1 :
                    // etc/XQFT.g:1545:27: S
                    {
                    mS(); if (failed) return ;
                ...
                case 2 :
                    ...
                    break;
                case 3 :
                    // etc/XQFT.g:1545:42: Ideographic
                    {
                    ...
                    break;
                case 4 :
                    // etc/XQFT.g:1545:56: CombiningChar
                    {
                ...
                case 18 :
                    ...
                    break;
                case 19 :
                    // etc/XQFT.g:1547:41: SEMICOLONSi
                    {
                    mSEMICOLONSi(); if (failed) return ;
                ...
                case 24 :
                    ...
                    break;
                case 25 :
                    // etc/XQFT.g:1548:24: BACKSLASHSi
                    {
                ...
                case 26 :
                    ...
                    break;
                case 27 :
                    // etc/XQFT.g:1548:49: UNDERSCORESi
                    {
    ...
    public final void mChar() throws RecognitionException {
        try {
            // etc/XQFT.g:1550:21: ( CleanChar | LBRACESi | RBRACSi | LTSi | AMPERSi | QUOTSi | APOSSi | MINUSSi )
            int alt36=8;
            ...
            if ( ((LA36_0>='\t' && LA36_0<='\n')||LA36_0=='\r'||(LA36_0>=' ' && LA36_0<='!')||(LA36_0>='#' && LA36_0<='%')||(LA36_0>='(' && LA36_0<=',')||(LA36_0>='.' && LA36_0<=';')||(LA36_0>='=' && LA36_0<='z')||LA36_0=='|'||(LA36_0>='~' && LA36_0<='\uD7FF')||(LA36_0>='\uE000' && LA36_0<='\uFFFD')) ) {
                ...
                if (backtracking>0) {failed=true; return ;}
                NoViableAltException nvae =
                    new NoViableAltException("1550:10: fragment Char : ( CleanChar | LBRACESi | RBRACSi | LTSi | AMPERSi | QUOTSi | APOSSi | MINUSSi );", 36, 0, input);

                throw nvae;
            }
            switch (alt36) {
                case 1 :
                    // etc/XQFT.g:1550:23: CleanChar
                    {
    ...
    public final void mDigits() throws RecognitionException {
        try {
            // etc/XQFT.g:1555:33: ( ( '0' .. '9' )+ )
            // etc/XQFT.g:1555:35: ( '0' .. '9' )+
            {
            // etc/XQFT.g:1555:35: ( '0' .. '9' )+
            int cnt37=0;
            loop37:
    ...
    public final void mDigit() throws RecognitionException {
        try {
            // etc/XQFT.g:1557:33: ( '\\u0030' .. '\\u0039' | '\\u0660' .. '\\u0669' | '\\u06F0' .. '\\u06F9' | '\\u0966' .. '\\u096F' | '\\u09E6' .. '\\u09EF' | '\\u0A66' .. '\\u0A6F' | '\\u0AE6' .. '\\u0AEF' | '\\u0B66' .. '\\u0B6F' | '\\u0BE7' .. '\\u0BEF' | '\\u0C66' .. '\\u0C6F' | '\\u0CE6' .. '\\u0CEF' | '\\u0D66' .. '\\u0D6F' | '\\u0E50' .. '\\u0E59' | '\\u0ED0' .. '\\u0ED9' | '\\u0F20' .. '\\u0F29' )
            // etc/XQFT.g:
            {
    ...
    public final void mLetter() throws RecognitionException {
        try {
            // etc/XQFT.g:1559:23: ( BaseChar | Ideographic )
            // etc/XQFT.g:
            {
    ...
    public final void mCombiningChar() throws RecognitionException {
        try {
            // etc/XQFT.g:1565:33: ( '\\u0300' .. '\\u0345' | '\\u0360' .. '\\u0361' | '\\u0483' .. '\\u0486' | '\\u0591' .. '\\u05A1' | '\\u05A3' .. '\\u05B9' | '\\u05BB' .. '\\u05BD' | '\\u05BF' | '\\u05C1' .. '\\u05C2' | '\\u05C4' | '\\u064B' .. '\\u0652' | '\\u0670' | '\\u06D6' .. '\\u06DC' | '\\u06DD' .. '\\u06DF' | '\\u06E0' .. '\\u06E4' | '\\u06E7' .. '\\u06E8' | '\\u06EA' .. '\\u06ED' | '\\u0901' .. '\\u0903' | '\\u093C' | '\\u093E' .. '\\u094C' | '\\u094D' | '\\u0951' .. '\\u0954' | '\\u0962' .. '\\u0963' | '\\u0981' .. '\\u0983' | '\\u09BC' | '\\u09BE' | '\\u09BF' | '\\u09C0' .. '\\u09C4' | '\\u09C7' .. '\\u09C8' | '\\u09CB' .. '\\u09CD' | '\\u09D7' | '\\u09E2' .. '\\u09E3' | '\\u0A02' | '\\u0A3C' | '\\u0A3E' | '\\u0A3F' | '\\u0A40' .. '\\u0A42' | '\\u0A47' .. '\\u0A48' | '\\u0A4B' .. '\\u0A4D' | '\\u0A70' .. '\\u0A71' | '\\u0A81' .. '\\u0A83' | '\\u0ABC' | '\\u0ABE' .. '\\u0AC5' | '\\u0AC7' .. '\\u0AC9' | '\\u0ACB' .. '\\u0ACD' | '\\u0B01' .. '\\u0B03' | '\\u0B3C' | '\\u0B3E' .. '\\u0B43' | '\\u0B47' .. '\\u0B48' | '\\u0B4B' .. '\\u0B4D' | '\\u0B56' .. '\\u0B57' | '\\u0B82' .. '\\u0B83' | '\\u0BBE' .. '\\u0BC2' | '\\u0BC6' .. '\\u0BC8' | '\\u0BCA' .. '\\u0BCD' | '\\u0BD7' | '\\u0C01' .. '\\u0C03' | '\\u0C3E' .. '\\u0C44' | '\\u0C46' .. '\\u0C48' | '\\u0C4A' .. '\\u0C4D' | '\\u0C55' .. '\\u0C56' | '\\u0C82' .. '\\u0C83' | '\\u0CBE' .. '\\u0CC4' | '\\u0CC6' .. '\\u0CC8' | '\\u0CCA' .. '\\u0CCD' | '\\u0CD5' .. '\\u0CD6' | '\\u0D02' .. '\\u0D03' | '\\u0D3E' .. '\\u0D43' | '\\u0D46' .. '\\u0D48' | '\\u0D4A' .. '\\u0D4D' | '\\u0D57' | '\\u0E31' | '\\u0E34' .. '\\u0E3A' | '\\u0E47' .. '\\u0E4E' | '\\u0EB1' | '\\u0EB4' .. '\\u0EB9' | '\\u0EBB' .. '\\u0EBC' | '\\u0EC8' .. '\\u0ECD' | '\\u0F18' .. '\\u0F19' | '\\u0F35' | '\\u0F37' | '\\u0F39' | '\\u0F3E' | '\\u0F3F' | '\\u0F71' .. '\\u0F84' | '\\u0F86' .. '\\u0F8B' | '\\u0F90' .. '\\u0F95' | '\\u0F97' | '\\u0F99' .. '\\u0FAD' | '\\u0FB1' .. '\\u0FB7' | '\\u0FB9' | '\\u20D0' .. '\\u20DC' | '\\u20E1' | '\\u302A' .. '\\u302F' | '\\u3099' | '\\u309A' )
            // etc/XQFT.g:
            {
    ...
    public final void mExtender() throws RecognitionException {
        try {
            // etc/XQFT.g:1567:33: ( '\\u00B7' | '\\u02D0' | '\\u02D1' | '\\u0387' | '\\u0640' | '\\u0E46' | '\\u0EC6' | '\\u3005' | '\\u3031' .. '\\u3035' | '\\u309D' .. '\\u309E' | '\\u30FC' .. '\\u30FE' )
            // etc/XQFT.g:
            {
    ...
    public final void synpred1_fragment() throws RecognitionException {   
        // etc/XQFT.g:1172:26: ( DoubleLiteral )
        // etc/XQFT.g:1172:27: DoubleLiteral
        {
        mDoubleLiteral(); if (failed) return ;
    ...
    public final void synpred2_fragment() throws RecognitionException {   
        // etc/XQFT.g:1173:14: ( DecimalLiteral )
        // etc/XQFT.g:1173:15: DecimalLiteral
        {
        mDecimalLiteral(); if (failed) return ;
    ...
    public final void synpred3_fragment() throws RecognitionException {   
        // etc/XQFT.g:1174:12: ( IntegerLiteral )
        // etc/XQFT.g:1174:13: IntegerLiteral
        {
        mIntegerLiteral(); if (failed) return ;
    ...
    class DFA1 extends DFA {
        ...
        public String getDescription() {
            return "1008:48: ({...}? =>n= CDataSectionLEX | {...}? =>n= DirPIConstructor | {...}? =>n= DirCommentConstLEX | {...}? =>n= LENDTAGSi | {...}? =>n= ElementContent | {...}? =>n= PragmaLEX | {...}? =>n= Comment | {...}? =>n= NumberLEX | {...}? =>n= LexSigns | {...}? =>n= S | {...}? =>n= StringLiteral | {...}? =>n= LexLiterals | {...}? =>n= QuotAttributeContent | {...}? =>n= AposAttributeContent | {...}? =>n= RSELFTERMSi | n= QUOTSi | n= DOLLARSi | n= APOSSi | n= LPARSi | n= RPARSi | n= STARSi | n= PLUSSi | n= COMMASi | n= MINUSSi | n= DOTSi | n= SLASHSi | n= COLONSi | n= SEMICOLONSi | n= LTSi | n= EQSi | n= GTSi | n= QUESTIONSi | n= ATSi | n= LBRACKSi | n= RBRACKSi | n= LBRACESi | n= PIPESi | n= RBRACSi )";
        }
        public int specialStateTransition(int s, IntStream input) throws NoViableAltException {
            ...
            switch ( s ) {
                    ...
                    case 6 : 
                        ...
                        input.rewind();
                        s = -1;
                        if ( (LA1_4=='}') && (((state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))))) {s = 44;}
    ...
    class DFA26 extends DFA {
        ...
        public String getDescription() {
            return "1172:10: fragment NumberLEX : ( ( DoubleLiteral )=> DoubleLiteral | ( DecimalLiteral )=> DecimalLiteral | ( IntegerLiteral )=> IntegerLiteral );";
        }
        public int specialStateTransition(int s, IntStream input) throws NoViableAltException {
        	int _s = s;
            switch ( s ) {

// $ANTLR 3.0.1 etc/XQFT.g 2008-04-17 21:09:44
...
public class XQFTLexer extends Lexer {
    public static final int NotChar=237;
    public static final int LENDTAGSi=207;
    public static final int QUOTSi=208;
    public static final int END=168;
    public static final int NOINHERIT=58;
    public static final int INSTANCE=117;
    public static final int LBRACESi=70;
    public static final int CONTENT=123;
    public static final int LAX=184;
    public static final int STOP=174;
    public static final int PIPESi=114;
    public static final int IMPORT=59;
    public static final int APOSSi=210;
    public static final int DBLCOLONSi=194;
    public static final int AposAttrContentChar=240;
    public static final int Letter=245;
    public static final int ORDER=43;
    public static final int CASTABLE=120;
    public static final int DIACRITICS=180;
    public static final int RCOMMENTSi=218;
    public static final int TYPESWITCH=100;
    public static final int MODULE=34;
    public static final int VERSION=30;
    public static final int AST_PATHEXPR_SGL=16;
    public static final int Ideographic=261;
    public static final int AST_STEPEXPR=18;
    public static final int DBLSLASHSi=187;
    public static final int EXACTLY=153;
    public static final int FTNOT=142;
    public static final int DECLARE=38;
    public static final int GTSi=133;
    public static final int TOKENSWITCH=234;
    public static final int ElementContentChar=241;
    public static final int OCCURS=151;
    public static final int UNION=113;
    public static final int STRIP=49;
    public static final int NameChar=247;
    public static final int PLUSSi=86;
    public static final int AST_WHERECLAUSE=9;
    public static final int SAME=163;
    public static final int QuotAttrContentChar=239;
    public static final int FTCONTAINS=107;
    public static final int AST_IFEXPR=14;
    public static final int QUESTIONSi=77;
    public static final int DESCENDING=96;
    public static final int AST_ORDERBYCLAUSE=8;
    public static final int FTOPTION=73;
    public static final int DOCUMENT_NODE=76;
    public static final int ANCESTOR_OR_SELF=193;
    public static final int LCDATASi=213;
    public static final int RELATIONSHIP=181;
    public static final int ANY=146;
    public static final int GE=129;
    public static final int GTOREQSi=134;
    public static final int AST_MODULE=4;
    public static final int CREFHEXSi=243;
    public static final int WORD=147;
    public static final int ELSE=104;
    public static final int SENSITIVE=177;
    public static final int SELF=199;
    public static final int DISTANCE=162;
    public static final int LPISi=219;
    public static final int ExtraChar=259;
    public static final int NODEBEFORESi=136;
    public static final int CREFDECSi=242;
    public static final int TEXT=84;
    public static final int PARENT=189;
    public static final int CombiningChar=249;
    public static final int NCName=224;
    public static final int FTOR=139;
    public static final int SCORE=90;
    public static final int PragmaLEX=228;
    public static final int EXTERNAL=65;
    public static final int EMPTY_SEQUENCE=74;
    public static final int Digit=248;
    public static final int UNDERSCORESi=246;
    public static final int DOLLARSi=63;
    public static final int RCDATASi=215;
    public static final int CAST=121;
    ...
    public static final int NOPRESERVE=56;
    public static final int S=232;
    public static final int RPARSi=69;
    public static final int BY=93;
    public static final int COLONSi=195;
    public static final int SCHEMA_ELEMENT=79;
    public static final int SLASHSi=186;
    public static final int WEIGHT=138;
    public static final int AST_RETURNCLAUSE=10;
    public static final int PRECEDING_SIBLING=191;
    public static final int UPPERCASE=179;
    public static final int AST_LETCLAUSE=7;
    public static final int SEMICOLONSi=33;
    public static final int FROM=155;
    public static final int STEMMING=172;
    public static final int TIMES=152;
    public static final int EMPTY=44;
    public static final int ASCENDING=95;
    public static final int CleanChar=262;
    public static final int IntegerLiteral=143;
    public static final int SENTENCES=160;
    public static final int NE=125;
    public static final int AposAttributeContent=211;
    public static final int COMMENT=83;
    public static final int MINUSSi=109;
    public static final int NCNameChar=256;
    public static final int ENTIRE=169;
    ...
    public static final int MOST=154;
    public static final int RETURN=87;
    ...
    public static final int Extender=250;
    public static final int NODE=85;
    public static final int FOR=88;
    public static final int Tokens=264;
    public static final int PRESERVE=48;
    public static final int DEFAULT=39;
    public static final int AST_FTPOSFILTER=21;
    public static final int DirCommentContent=217;
    public static final int LEVELS=182;
    public static final int LPRAGSi=156;
    public static final int COMMASi=37;
    public static final int ATTRIBUTE=80;
    public static final int CHILD=197;
    public static final int Digits=254;
    ...
    public static final int INSENSITIVE=176;
    public static final int DOCUMENT=223;
    public static final int AS=67;
    public static final int ENCODING=32;
    public static final int BOUNDARYSPACE=47;
    public static final int SYNTH_PR_LVL=28;
    public static final int TREAT=119;
    public static final int NAMESPACE=35;
    public static final int LXQCOMMENTSi=252;
    public static final int LEAST=46;
    public static final int THEN=103;
    public static final int WORDS=149;
    public static final int AST_PATHEXPR_REL=17;
    public static final int PiTarget=220;
    public static final int AST_RELATIVEPATHEXPR=19;
    public static final int CDataContents=214;
    public static final int PARAGRAPHS=161;
    public static final int NCNameStartChar=255;
    public static final int QuotAttributeContent=209;
    public static final int BASE_URI=50;
    ...
    public static final int LexSigns=231;
    public static final int NEQSi=130;
    public static final int LANGUAGE=175;
    public static final int LE=127;
    public static final int LOWERCASE=178;
    public static final int BACKSLASHSi=258;
    public static final int SCHEMA=60;
    public static final int CONSTRUCTION=51;
    public static final int STARSi=78;
    public static final int RPRAGSi=158;
    public static final int WILDCARDS=171;
    public static final int DOTDOTSi=196;
    public static final int DIFFERENT=164;
    public static final int LTOREQSi=132;
    ...
    public static final int GREATEST=45;
    public static final int DOTSi=188;
    public static final int BaseChar=260;
    public static final int Char=263;
    ...
    public static final int WINDOW=159;
    public static final int Name=244;
    public static final int FOLLOWING=202;
    public static final int CASE=101;
    public static final int RXQCOMMENTSi=253;
    public static final int DESCENDANT_OR_SELF=200;
    public static final int CDataSectionLEX=225;
    public static final int THESAURUS=173;
    public static final int RSELFTERMSi=206;
    public static final int DecimalLiteral=144;
    public static final int FTAND=140;
    public static final int PragmaContents=157;
    public static final int PARAGRAPH=166;
    public static final int DIV=110;
    public static final int EQSi=36;
    public static final int ALL=148;
    public static final int EXCLSi=257;
    public static final int WHERE=92;
    public static final int DirPIConstructor=226;
    public static final int WITHOUT=122;
    public static final int EVERY=98;
    public static final int SCHEMA_ATTRIBUTE=81;
    public static final int XQUERY=29;
    public static final int IDIV=111;
    public static final int SATISFIES=99;
    public static final int DESCENDANT=198;
    public static final int ATSi=203;
    public static final int STRICT=185;
    public static final int RBRACKSi=205;
    public static final int FOLLOWING_SIBLING=201;
    public static final int STABLE=94;
    public static final int SYNTH_PR_PATHEXPR=27;
    public static final int START=167;
    public static final int DoubleLiteral=145;
    public static final int AMPERSi=238;
    public static final int VALIDATE=183;
    public static final int PRECEDING=192;
    public static final int ORDERING=52;
    public static final int COPY_NAMESPACES=55;
    public static final int ASSIGNSi=64;
    public static final int UNORDERED=54;
    public static final int NumberLEX=230;
    public static final int PredefinedEntityRef=235;
    public static final int LTSi=131;
    public static final int SENTENCE=165;
    ...
    public static final int LexLiterals=233;
    public static final int SHARPSi=251;
    public static final int IS=135;
    public static final int GT=128;
    public static final int PHRASE=150;
    public static final int StringLiteral=31;
    public static final int RPISi=222;
    public static final int ITEM=75;
    public static final int DirPiContents=221;
    public static final int ORDERED=53;
    public static final int DirCommentConstLEX=227;
    public static final int PROCESSING_INSTRUCTION=82;
    public static final int NODEAFTERSi=137;
    public static final int COLLATION=42;
    public static final int CharRef=236;
    public static final int LPARSi=68;
    public static final int ANCESTOR=190;
    public static final int AST_PREDICATE=24;
    public static final int VARIABLE=62;
    public static final int EOF=-1;
    public static final int RBRACSi=71;
    public static final int ElementContent=212;
    public static final int LCOMMENTSi=216;
    public static final int LBRACKSi=204;
    ...
    public final void mTOKENSWITCH() throws RecognitionException {
        try {
            ...
            // etc/XQFT.g:934:13: ( ({...}? =>n= CDataSectionLEX | {...}? =>n= DirPIConstructor | {...}? =>n= DirCommentConstLEX | {...}? =>n= LENDTAGSi | {...}? =>n= ElementContent | {...}? =>n= PragmaLEX | {...}? =>n= Comment | {...}? =>n= NumberLEX | {...}? =>n= LexSigns | {...}? =>n= S | {...}? =>n= StringLiteral | {...}? =>n= LexLiterals | {...}? =>n= QuotAttributeContent | {...}? =>n= AposAttributeContent | {...}? =>n= RSELFTERMSi | n= QUOTSi | n= DOLLARSi | n= APOSSi | n= LPARSi | n= RPARSi | n= STARSi | n= PLUSSi | n= COMMASi | n= MINUSSi | n= DOTSi | n= SLASHSi | n= COLONSi | n= SEMICOLONSi | n= LTSi | n= EQSi | n= GTSi | n= QUESTIONSi | n= ATSi | n= LBRACKSi | n= RBRACKSi | n= LBRACESi | n= PIPESi | n= RBRACSi ) )
            // etc/XQFT.g:934:15: ({...}? =>n= CDataSectionLEX | {...}? =>n= DirPIConstructor | {...}? =>n= DirCommentConstLEX | {...}? =>n= LENDTAGSi | {...}? =>n= ElementContent | {...}? =>n= PragmaLEX | {...}? =>n= Comment | {...}? =>n= NumberLEX | {...}? =>n= LexSigns | {...}? =>n= S | {...}? =>n= StringLiteral | {...}? =>n= LexLiterals | {...}? =>n= QuotAttributeContent | {...}? =>n= AposAttributeContent | {...}? =>n= RSELFTERMSi | n= QUOTSi | n= DOLLARSi | n= APOSSi | n= LPARSi | n= RPARSi | n= STARSi | n= PLUSSi | n= COMMASi | n= MINUSSi | n= DOTSi | n= SLASHSi | n= COLONSi | n= SEMICOLONSi | n= LTSi | n= EQSi | n= GTSi | n= QUESTIONSi | n= ATSi | n= LBRACKSi | n= RBRACKSi | n= LBRACESi | n= PIPESi | n= RBRACSi )
            {
            // etc/XQFT.g:934:15: ({...}? =>n= CDataSectionLEX | {...}? =>n= DirPIConstructor | {...}? =>n= DirCommentConstLEX | {...}? =>n= LENDTAGSi | {...}? =>n= ElementContent | {...}? =>n= PragmaLEX | {...}? =>n= Comment | {...}? =>n= NumberLEX | {...}? =>n= LexSigns | {...}? =>n= S | {...}? =>n= StringLiteral | {...}? =>n= LexLiterals | {...}? =>n= QuotAttributeContent | {...}? =>n= AposAttributeContent | {...}? =>n= RSELFTERMSi | n= QUOTSi | n= DOLLARSi | n= APOSSi | n= LPARSi | n= RPARSi | n= STARSi | n= PLUSSi | n= COMMASi | n= MINUSSi | n= DOTSi | n= SLASHSi | n= COLONSi | n= SEMICOLONSi | n= LTSi | n= EQSi | n= GTSi | n= QUESTIONSi | n= ATSi | n= LBRACKSi | n= RBRACKSi | n= LBRACESi | n= PIPESi | n= RBRACSi )
            int alt1=38;
            ...
            switch (alt1) {
                case 1 :
                    // etc/XQFT.g:935:5: {...}? =>n= CDataSectionLEX
                    {
                    ...
                    int nStart43 = getCharIndex();
                    mCDataSectionLEX(); if (failed) return ;
                    n = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, nStart43, getCharIndex()-1);

                    }
                    break;
                case 2 :
                    // etc/XQFT.g:937:7: {...}? =>n= DirPIConstructor
                    {
                    if ( !(state!=State.IN_TAG && state!=State.IN_QUOT_ATTRIBUTE && state!=State.IN_APOS_ATTRIBUTE) ) {
                        if (backtracking>0) {failed=true; return ;}
                        throw new FailedPredicateException(input, "TOKENSWITCH", "state!=State.IN_TAG && state!=State.IN_QUOT_ATTRIBUTE && state!=State.IN_APOS_ATTRIBUTE");
                    }
                    int nStart65 = getCharIndex();
                    mDirPIConstructor(); if (failed) return ;
                    n = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, nStart65, getCharIndex()-1);

                    }
                    break;
                case 3 :
                    // etc/XQFT.g:939:7: {...}? =>n= DirCommentConstLEX
                    {
                    if ( !(state!=State.IN_TAG && state!=State.IN_QUOT_ATTRIBUTE && state!=State.IN_APOS_ATTRIBUTE) ) {
                        if (backtracking>0) {failed=true; return ;}
                        throw new FailedPredicateException(input, "TOKENSWITCH", "state!=State.IN_TAG && state!=State.IN_QUOT_ATTRIBUTE && state!=State.IN_APOS_ATTRIBUTE");
                    }
                    int nStart87 = getCharIndex();
                    mDirCommentConstLEX(); if (failed) return ;
                    n = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, nStart87, getCharIndex()-1);

                    }
                    break;
                case 4 :
                    // etc/XQFT.g:941:7: {...}? =>n= LENDTAGSi
                    {
                    ...
                    int nStart109 = getCharIndex();
                    mLENDTAGSi(); if (failed) return ;
                    n = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, nStart109, getCharIndex()-1);
                    if ( backtracking==0 ) {
                      _type=LENDTAGSi;
                    }
                    ...
                    break;
                case 5 :
                    // etc/XQFT.g:943:11: {...}? =>n= ElementContent
                    {
                    if ( !(state==State.IN_ELEMENT) ) {
                        if (backtracking>0) {failed=true; return ;}
                        throw new FailedPredicateException(input, "TOKENSWITCH", "state==State.IN_ELEMENT");
                    }
                    int nStart137 = getCharIndex();
                    mElementContent(); if (failed) return ;
                    n = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, nStart137, getCharIndex()-1);
                    if ( backtracking==0 ) {
                    ...
                    break;
                case 6 :
                    // etc/XQFT.g:945:7: {...}? =>n= PragmaLEX
                    {
                    if ( !(state==State.DEFAULT) ) {
                        if (backtracking>0) {failed=true; return ;}
                        throw new FailedPredicateException(input, "TOKENSWITCH", "state==State.DEFAULT");
                    }
                    int nStart166 = getCharIndex();
                    mPragmaLEX(); if (failed) return ;
                    n = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, nStart166, getCharIndex()-1);

                    }
                    break;
                case 7 :
                    // etc/XQFT.g:947:7: {...}? =>n= Comment
                    {
                    if ( !(state==State.DEFAULT) ) {
                        if (backtracking>0) {failed=true; return ;}
                        throw new FailedPredicateException(input, "TOKENSWITCH", "state==State.DEFAULT");
                    }
                    int nStart188 = getCharIndex();
                    mComment(); if (failed) return ;
                    n = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, nStart188, getCharIndex()-1);
                    if ( backtracking==0 ) {
                    ...
                    break;
                case 8 :
                    // etc/XQFT.g:949:7: {...}? =>n= NumberLEX
                    {
                    if ( !(state==State.DEFAULT) ) {
                        if (backtracking>0) {failed=true; return ;}
                        throw new FailedPredicateException(input, "TOKENSWITCH", "state==State.DEFAULT");
                    }
                    int nStart212 = getCharIndex();
                    mNumberLEX(); if (failed) return ;
                    n = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, nStart212, getCharIndex()-1);
                    if ( backtracking==0 ) {
                    ...
                    break;
                case 9 :
                    // etc/XQFT.g:951:7: {...}? =>n= LexSigns
                    {
                    if ( !(state==State.DEFAULT) ) {
                        if (backtracking>0) {failed=true; return ;}
                        throw new FailedPredicateException(input, "TOKENSWITCH", "state==State.DEFAULT");
                    }
                    int nStart235 = getCharIndex();
                    mLexSigns(); if (failed) return ;
                    n = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, nStart235, getCharIndex()-1);
                    if ( backtracking==0 ) {
                      _type=this.tokenType;
                    }
                ...
                case 10 :
                    ...
                    int nStart258 = getCharIndex();
                    mS(); if (failed) return ;
                    n = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, nStart258, getCharIndex()-1);
                    if ( backtracking==0 ) {
                    ...
                    break;
                case 11 :
                    // etc/XQFT.g:955:7: {...}? =>n= StringLiteral
                    {
                    if ( !(state==State.DEFAULT) ) {
                        if (backtracking>0) {failed=true; return ;}
                        throw new FailedPredicateException(input, "TOKENSWITCH", "state==State.DEFAULT");
                    }
                    int nStart281 = getCharIndex();
                    mStringLiteral(); if (failed) return ;
                    n = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, nStart281, getCharIndex()-1);
                    if ( backtracking==0 ) {
                      _type=StringLiteral;
                    }
                    ...
                    break;
                case 12 :
                    // etc/XQFT.g:957:7: {...}? =>n= LexLiterals
                    {
                    if ( !((state==State.DEFAULT || state==State.IN_TAG)) ) {
                        if (backtracking>0) {failed=true; return ;}
                        throw new FailedPredicateException(input, "TOKENSWITCH", "(state==State.DEFAULT || state==State.IN_TAG)");
                    ...
                    break;
                case 13 :
                    // etc/XQFT.g:959:7: {...}? =>n= QuotAttributeContent
                    {
                    if ( !(state==State.IN_QUOT_ATTRIBUTE) ) {
                        if (backtracking>0) {failed=true; return ;}
                        throw new FailedPredicateException(input, "TOKENSWITCH", "state==State.IN_QUOT_ATTRIBUTE");
                    }
                    int nStart353 = getCharIndex();
                    mQuotAttributeContent(); if (failed) return ;
                    n = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, nStart353, getCharIndex()-1);
                    if ( backtracking==0 ) {
                    ...
                    break;
                case 14 :
                    // etc/XQFT.g:961:7: {...}? =>n= AposAttributeContent
                    {
                    if ( !(state==State.IN_APOS_ATTRIBUTE) ) {
                        if (backtracking>0) {failed=true; return ;}
                        throw new FailedPredicateException(input, "TOKENSWITCH", "state==State.IN_APOS_ATTRIBUTE");
                    }
                    int nStart376 = getCharIndex();
                    mAposAttributeContent(); if (failed) return ;
                    n = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, nStart376, getCharIndex()-1);
                    if ( backtracking==0 ) {
                    ...
                    break;
                case 15 :
                    // etc/XQFT.g:963:7: {...}? =>n= RSELFTERMSi
                    {
                    if ( !(state==State.IN_TAG) ) {
                        if (backtracking>0) {failed=true; return ;}
                        throw new FailedPredicateException(input, "TOKENSWITCH", "state==State.IN_TAG");
                    }
                    int nStart399 = getCharIndex();
                    mRSELFTERMSi(); if (failed) return ;
                    n = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, nStart399, getCharIndex()-1);
                    if ( backtracking==0 ) {
                      _type=RSELFTERMSi;
                    }
                ...
                case 16 :
                    ...
                    break;
                case 17 :
                    // etc/XQFT.g:966:7: n= DOLLARSi
                    {
                    int nStart423 = getCharIndex();
                    mDOLLARSi(); if (failed) return ;
                    n = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, nStart423, getCharIndex()-1);
                    if ( backtracking==0 ) {
                      _type=DOLLARSi;
                    }
                    ...
                    break;
                case 18 :
                    // etc/XQFT.g:967:7: n= APOSSi
                    {
                    int nStart451 = getCharIndex();
                    mAPOSSi(); if (failed) return ;
                    n = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, nStart451, getCharIndex()-1);
                    if ( backtracking==0 ) {
                      _type=APOSSi;
                    }
                    ...
                    break;
                case 19 :
                    // etc/XQFT.g:968:7: n= LPARSi
                    {
                    int nStart463 = getCharIndex();
                    mLPARSi(); if (failed) return ;
                    n = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, nStart463, getCharIndex()-1);
                    if ( backtracking==0 ) {
                      _type=LPARSi;
                    }
                    ...
                    break;
                case 20 :
                    // etc/XQFT.g:969:7: n= RPARSi
                    {
                    int nStart475 = getCharIndex();
                    mRPARSi(); if (failed) return ;
                    n = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, nStart475, getCharIndex()-1);
                    if ( backtracking==0 ) {
                      _type=RPARSi;
                    }
                    ...
                    break;
                case 21 :
                    // etc/XQFT.g:970:7: n= STARSi
                    {
                    int nStart487 = getCharIndex();
                    mSTARSi(); if (failed) return ;
                    n = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, nStart487, getCharIndex()-1);
                    if ( backtracking==0 ) {
                      _type=STARSi;
                    }
                    ...
                    break;
                case 22 :
                    // etc/XQFT.g:971:7: n= PLUSSi
                    {
                    int nStart499 = getCharIndex();
                    mPLUSSi(); if (failed) return ;
                    n = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, nStart499, getCharIndex()-1);
                    if ( backtracking==0 ) {
                      _type=PLUSSi;
                    }
                    ...
                    break;
                case 23 :
                    // etc/XQFT.g:972:7: n= COMMASi
                    {
                    int nStart511 = getCharIndex();
                    mCOMMASi(); if (failed) return ;
                    n = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, nStart511, getCharIndex()-1);
                    if ( backtracking==0 ) {
                      _type=COMMASi;
                    }
                    ...
                    break;
                case 24 :
                    // etc/XQFT.g:973:7: n= MINUSSi
                    {
                    int nStart523 = getCharIndex();
                    mMINUSSi(); if (failed) return ;
                    n = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, nStart523, getCharIndex()-1);
                    if ( backtracking==0 ) {
                      _type=MINUSSi;
                    }
                ...
                case 27 :
                    ...
                    break;
                case 28 :
                    // etc/XQFT.g:977:7: n= SEMICOLONSi
                    {
                    ...
                    break;
                case 29 :
                    // etc/XQFT.g:978:7: n= LTSi
                    {
                    int nStart583 = getCharIndex();
                    mLTSi(); if (failed) return ;
                    n = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, nStart583, getCharIndex()-1);
                    if ( backtracking==0 ) {
                      _type=LTSi;
                    }
                    ...
                    break;
                case 30 :
                    // etc/XQFT.g:979:7: n= EQSi
                    {
                    int nStart595 = getCharIndex();
                    mEQSi(); if (failed) return ;
                    n = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, nStart595, getCharIndex()-1);
                    if ( backtracking==0 ) {
                      _type=EQSi;
                    }
                    ...
                    break;
                case 31 :
                    // etc/XQFT.g:980:7: n= GTSi
                    {
                    int nStart607 = getCharIndex();
                    mGTSi(); if (failed) return ;
                    n = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, nStart607, getCharIndex()-1);
                    if ( backtracking==0 ) {
                      _type=GTSi;
                    }
                    ...
                    break;
                case 32 :
                    // etc/XQFT.g:981:7: n= QUESTIONSi
                    {
                    int nStart619 = getCharIndex();
                    mQUESTIONSi(); if (failed) return ;
                    n = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, nStart619, getCharIndex()-1);
                    if ( backtracking==0 ) {
                      _type=QUESTIONSi;
                    }
                ...
                case 33 :
                    ...
                    break;
                case 34 :
                    // etc/XQFT.g:983:7: n= LBRACKSi
                    {
                    int nStart643 = getCharIndex();
                    mLBRACKSi(); if (failed) return ;
                    n = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, nStart643, getCharIndex()-1);
                    if ( backtracking==0 ) {
                      _type=LBRACKSi;
                    }
                    ...
                    break;
                case 35 :
                    // etc/XQFT.g:984:7: n= RBRACKSi
                    {
                    int nStart655 = getCharIndex();
                    mRBRACKSi(); if (failed) return ;
                    n = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, nStart655, getCharIndex()-1);
                    if ( backtracking==0 ) {
                      _type=RBRACKSi;
                    }
                ...
                case 36 :
                    ...
                    break;
                case 37 :
                    // etc/XQFT.g:986:7: n= PIPESi
                    {
                    int nStart679 = getCharIndex();
                    mPIPESi(); if (failed) return ;
                    n = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, nStart679, getCharIndex()-1);
                    if ( backtracking==0 ) {
                      _type=PIPESi;
                    }
                    ...
                    break;
                case 38 :
                    // etc/XQFT.g:987:7: n= RBRACSi
                    {
                    int nStart691 = getCharIndex();
                    mRBRACSi(); if (failed) return ;
                    n = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, nStart691, getCharIndex()-1);
                    if ( backtracking==0 ) {
                      _type=RBRACSi;
                    }
    ...
    public final void mStringLiteral() throws RecognitionException {
        try {
            // etc/XQFT.g:996:24: ( QUOTSi ( PredefinedEntityRef | CharRef | {...}? => QUOTSi QUOTSi | ~ ( NotChar | QUOTSi | AMPERSi ) )* QUOTSi | APOSSi ( PredefinedEntityRef | CharRef | {...}? => APOSSi APOSSi | ~ ( NotChar | APOSSi | AMPERSi ) )* APOSSi )
            int alt5=2;
            ...
            if ( (LA5_0=='\"') ) {
                ...
                NoViableAltException nvae =
                    new NoViableAltException("996:10: fragment StringLiteral : ( QUOTSi ( PredefinedEntityRef | CharRef | {...}? => QUOTSi QUOTSi | ~ ( NotChar | QUOTSi | AMPERSi ) )* QUOTSi | APOSSi ( PredefinedEntityRef | CharRef | {...}? => APOSSi APOSSi | ~ ( NotChar | APOSSi | AMPERSi ) )* APOSSi );", 5, 0, input);

                throw nvae;
            }
            switch (alt5) {
                case 1 :
                    // etc/XQFT.g:997:5: QUOTSi ( PredefinedEntityRef | CharRef | {...}? => QUOTSi QUOTSi | ~ ( NotChar | QUOTSi | AMPERSi ) )* QUOTSi
                    {
                    mQUOTSi(); if (failed) return ;
                    // etc/XQFT.g:998:9: ( PredefinedEntityRef | CharRef | {...}? => QUOTSi QUOTSi | ~ ( NotChar | QUOTSi | AMPERSi ) )*
                    loop3:
                    do {
                        int alt3=5;
                        ...
                        switch (alt3) {
                    	case 1 :
                    	    // etc/XQFT.g:998:10: PredefinedEntityRef
                    	    {
                    	...
                    	case 2 :
                    	    ...
                    	    break;
                    	case 3 :
                    	    // etc/XQFT.g:998:42: {...}? => QUOTSi QUOTSi
                    	    {
                    	    ...
                    	    break;
                    	case 4 :
                    	    // etc/XQFT.g:998:102: ~ ( NotChar | QUOTSi | AMPERSi )
                    	    {
                    ...
                    break;
                case 2 :
                    // etc/XQFT.g:1001:5: APOSSi ( PredefinedEntityRef | CharRef | {...}? => APOSSi APOSSi | ~ ( NotChar | APOSSi | AMPERSi ) )* APOSSi
                    {
                    mAPOSSi(); if (failed) return ;
                    // etc/XQFT.g:1002:9: ( PredefinedEntityRef | CharRef | {...}? => APOSSi APOSSi | ~ ( NotChar | APOSSi | AMPERSi ) )*
                    loop4:
                    do {
                        int alt4=5;
                        ...
                        switch (alt4) {
                    	case 1 :
                    	    // etc/XQFT.g:1002:10: PredefinedEntityRef
                    	    {
                    	    mPredefinedEntityRef(); if (failed) return ;
                    	...
                    	case 2 :
                    	    ...
                    	    break;
                    	case 3 :
                    	    // etc/XQFT.g:1002:42: {...}? => APOSSi APOSSi
                    	    {
                    	    if ( !((input.LA(1)=='\'' && input.LA(2)=='\'')) ) {
                    	        if (backtracking>0) {failed=true; return ;}
                    	        throw new FailedPredicateException(input, "StringLiteral", "(input.LA(1)=='\\'' && input.LA(2)=='\\'')");
                    	    ...
                    	    break;
                    	case 4 :
                    	    // etc/XQFT.g:1002:104: ~ ( NotChar | APOSSi | AMPERSi )
                    	    {
    ...
    public final void mQuotAttributeContent() throws RecognitionException {
        try {
            // etc/XQFT.g:1006:31: ( ( PredefinedEntityRef | CharRef | QuotAttrContentChar )* )
            // etc/XQFT.g:1006:33: ( PredefinedEntityRef | CharRef | QuotAttrContentChar )*
            {
            // etc/XQFT.g:1006:33: ( PredefinedEntityRef | CharRef | QuotAttrContentChar )*
            loop6:
            do {
                ...
                switch (alt6) {
            	case 1 :
            	    // etc/XQFT.g:1006:34: PredefinedEntityRef
            	    {
            	    mPredefinedEntityRef(); if (failed) return ;
            	...
            	case 2 :
            	    ...
            	    break;
            	case 3 :
            	    // etc/XQFT.g:1006:66: QuotAttrContentChar
            	    {
    ...
    public final void mAposAttributeContent() throws RecognitionException {
        try {
            // etc/XQFT.g:1007:31: ( ( PredefinedEntityRef | CharRef | AposAttrContentChar )* )
            // etc/XQFT.g:1007:33: ( PredefinedEntityRef | CharRef | AposAttrContentChar )*
            {
            // etc/XQFT.g:1007:33: ( PredefinedEntityRef | CharRef | AposAttrContentChar )*
            loop7:
            do {
                ...
                switch (alt7) {
            	case 1 :
            	    // etc/XQFT.g:1007:34: PredefinedEntityRef
            	    {
            	    mPredefinedEntityRef(); if (failed) return ;
            	...
            	case 2 :
            	    ...
            	    break;
            	case 3 :
            	    // etc/XQFT.g:1007:66: AposAttrContentChar
            	    {
    ...
    public final void mElementContent() throws RecognitionException {
        try {
            // etc/XQFT.g:1008:31: ( ( PredefinedEntityRef | CharRef | ElementContentChar )* )
            // etc/XQFT.g:1008:33: ( PredefinedEntityRef | CharRef | ElementContentChar )*
            {
            // etc/XQFT.g:1008:33: ( PredefinedEntityRef | CharRef | ElementContentChar )*
            loop8:
            do {
                ...
                switch (alt8) {
            	case 1 :
            	    // etc/XQFT.g:1008:34: PredefinedEntityRef
            	    {
            	    mPredefinedEntityRef(); if (failed) return ;
            	...
            	case 2 :
            	    ...
            	    break;
            	case 3 :
            	    // etc/XQFT.g:1008:66: ElementContentChar
            	    {
    ...
    public final void mPredefinedEntityRef() throws RecognitionException {
        try {
            // etc/XQFT.g:1009:31: ( AMPERSi ( 'lt' | 'gt' | 'amp' | 'quot' | 'apos' ) SEMICOLONSi )
            // etc/XQFT.g:1009:33: AMPERSi ( 'lt' | 'gt' | 'amp' | 'quot' | 'apos' ) SEMICOLONSi
            {
            mAMPERSi(); if (failed) return ;
            // etc/XQFT.g:1009:41: ( 'lt' | 'gt' | 'amp' | 'quot' | 'apos' )
            int alt9=5;
            switch ( input.LA(1) ) {
            case 'l':
                {
            ...
            case 'a':
                ...
                if ( (LA9_3=='p') ) {
                    ...
                    if (backtracking>0) {failed=true; return ;}
                    NoViableAltException nvae =
                        new NoViableAltException("1009:41: ( 'lt' | 'gt' | 'amp' | 'quot' | 'apos' )", 9, 3, input);
            ...
            default:
                if (backtracking>0) {failed=true; return ;}
                NoViableAltException nvae =
                    new NoViableAltException("1009:41: ( 'lt' | 'gt' | 'amp' | 'quot' | 'apos' )", 9, 0, input);
    ...
    public final void mCharRef() throws RecognitionException {
        try {
            // etc/XQFT.g:1010:18: ( CREFDECSi ( '0' .. '9' )+ SEMICOLONSi | CREFHEXSi ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' )+ SEMICOLONSi )
            int alt12=2;
            ...
            if ( (LA12_0=='&') ) {
                ...
                if ( (LA12_1=='#') ) {
                    ...
                    if ( (LA12_2=='x') ) {
                        ...
                        if (backtracking>0) {failed=true; return ;}
                        NoViableAltException nvae =
                            new NoViableAltException("1010:10: fragment CharRef : ( CREFDECSi ( '0' .. '9' )+ SEMICOLONSi | CREFHEXSi ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' )+ SEMICOLONSi );", 12, 2, input);
                    ...
                    if (backtracking>0) {failed=true; return ;}
                    NoViableAltException nvae =
                        new NoViableAltException("1010:10: fragment CharRef : ( CREFDECSi ( '0' .. '9' )+ SEMICOLONSi | CREFHEXSi ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' )+ SEMICOLONSi );", 12, 1, input);
                ...
                if (backtracking>0) {failed=true; return ;}
                NoViableAltException nvae =
                    new NoViableAltException("1010:10: fragment CharRef : ( CREFDECSi ( '0' .. '9' )+ SEMICOLONSi | CREFHEXSi ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' )+ SEMICOLONSi );", 12, 0, input);

                throw nvae;
            }
            switch (alt12) {
                case 1 :
                    // etc/XQFT.g:1011:9: CREFDECSi ( '0' .. '9' )+ SEMICOLONSi
                    {
                    mCREFDECSi(); if (failed) return ;
                    // etc/XQFT.g:1011:19: ( '0' .. '9' )+
                    int cnt10=0;
                    loop10:
                    do {
                        int alt10=2;
                    ...
                    break;
                case 2 :
                    // etc/XQFT.g:1013:9: CREFHEXSi ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' )+ SEMICOLONSi
                    {
                    mCREFHEXSi(); if (failed) return ;
                    // etc/XQFT.g:1013:19: ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' )+
                    int cnt11=0;
                    loop11:
                    do {
                        int alt11=2;
    ...
    public final void mCREFHEXSi() throws RecognitionException {
        try {
            // etc/XQFT.g:1016:20: ( '&#x' )
            // etc/XQFT.g:1016:22: '&#x'
            {
    ...
    public final void mElementContentChar() throws RecognitionException {
        try {
            // etc/XQFT.g:1018:28: ( ({...}? => LBRACESi LBRACESi | {...}? => RBRACSi RBRACSi | ~ ( NotChar | LBRACESi | RBRACSi | LTSi | AMPERSi ) ) )
            // etc/XQFT.g:1019:9: ({...}? => LBRACESi LBRACESi | {...}? => RBRACSi RBRACSi | ~ ( NotChar | LBRACESi | RBRACSi | LTSi | AMPERSi ) )
            {
            // etc/XQFT.g:1019:9: ({...}? => LBRACESi LBRACESi | {...}? => RBRACSi RBRACSi | ~ ( NotChar | LBRACESi | RBRACSi | LTSi | AMPERSi ) )
            int alt13=3;
            ...
            if ( (LA13_0=='{') && ((input.LA(1)=='{' && input.LA(2)=='{'))) {
                ...
                if (backtracking>0) {failed=true; return ;}
                NoViableAltException nvae =
                    new NoViableAltException("1019:9: ({...}? => LBRACESi LBRACESi | {...}? => RBRACSi RBRACSi | ~ ( NotChar | LBRACESi | RBRACSi | LTSi | AMPERSi ) )", 13, 0, input);

                throw nvae;
            }
            switch (alt13) {
                case 1 :
                    // etc/XQFT.g:1020:13: {...}? => LBRACESi LBRACESi
                    {
                    if ( !((input.LA(1)=='{' && input.LA(2)=='{')) ) {
                        if (backtracking>0) {failed=true; return ;}
                    ...
                    break;
                case 2 :
                    // etc/XQFT.g:1021:16: {...}? => RBRACSi RBRACSi
                    {
                    if ( !((input.LA(1)=='}' && input.LA(2)=='}')) ) {
                        if (backtracking>0) {failed=true; return ;}
                        throw new FailedPredicateException(input, "ElementContentChar", "(input.LA(1)=='}' && input.LA(2)=='}')");
                    ...
                    break;
                case 3 :
                    // etc/XQFT.g:1022:15: ~ ( NotChar | LBRACESi | RBRACSi | LTSi | AMPERSi )
                    {
    ...
    public final void mQuotAttrContentChar() throws RecognitionException {
        try {
            // etc/XQFT.g:1025:30: ( ({...}? => QUOTSi QUOTSi | {...}? => LBRACESi LBRACESi | {...}? => RBRACSi RBRACSi | ~ ( NotChar | LBRACESi | RBRACSi | LTSi | AMPERSi | QUOTSi ) ) )
            // etc/XQFT.g:1026:9: ({...}? => QUOTSi QUOTSi | {...}? => LBRACESi LBRACESi | {...}? => RBRACSi RBRACSi | ~ ( NotChar | LBRACESi | RBRACSi | LTSi | AMPERSi | QUOTSi ) )
            {
            // etc/XQFT.g:1026:9: ({...}? => QUOTSi QUOTSi | {...}? => LBRACESi LBRACESi | {...}? => RBRACSi RBRACSi | ~ ( NotChar | LBRACESi | RBRACSi | LTSi | AMPERSi | QUOTSi ) )
            int alt14=4;
            ...
            if ( (LA14_0=='\"') && ((input.LA(1)=='"' && input.LA(2)=='"'))) {
                ...
                if (backtracking>0) {failed=true; return ;}
                NoViableAltException nvae =
                    new NoViableAltException("1026:9: ({...}? => QUOTSi QUOTSi | {...}? => LBRACESi LBRACESi | {...}? => RBRACSi RBRACSi | ~ ( NotChar | LBRACESi | RBRACSi | LTSi | AMPERSi | QUOTSi ) )", 14, 0, input);

                throw nvae;
            }
            switch (alt14) {
                case 1 :
                    // etc/XQFT.g:1027:13: {...}? => QUOTSi QUOTSi
                    {
                    if ( !((input.LA(1)=='"' && input.LA(2)=='"')) ) {
                        if (backtracking>0) {failed=true; return ;}
                    ...
                    break;
                case 2 :
                    // etc/XQFT.g:1028:15: {...}? => LBRACESi LBRACESi
                    {
                    if ( !((input.LA(1)=='{' && input.LA(2)=='{')) ) {
                        if (backtracking>0) {failed=true; return ;}
                        throw new FailedPredicateException(input, "QuotAttrContentChar", "(input.LA(1)=='{' && input.LA(2)=='{')");
                    ...
                    break;
                case 3 :
                    // etc/XQFT.g:1029:15: {...}? => RBRACSi RBRACSi
                    {
                    if ( !((input.LA(1)=='}' && input.LA(2)=='}')) ) {
                        if (backtracking>0) {failed=true; return ;}
                        throw new FailedPredicateException(input, "QuotAttrContentChar", "(input.LA(1)=='}' && input.LA(2)=='}')");
                    ...
                    break;
                case 4 :
                    // etc/XQFT.g:1030:15: ~ ( NotChar | LBRACESi | RBRACSi | LTSi | AMPERSi | QUOTSi )
                    {
    ...
    public final void mAposAttrContentChar() throws RecognitionException {
        try {
            // etc/XQFT.g:1034:30: ( ({...}? => APOSSi APOSSi | {...}? => LBRACESi LBRACESi | {...}? => RBRACSi RBRACSi | ~ ( NotChar | LBRACESi | RBRACSi | LTSi | AMPERSi | APOSSi ) ) )
            // etc/XQFT.g:1035:9: ({...}? => APOSSi APOSSi | {...}? => LBRACESi LBRACESi | {...}? => RBRACSi RBRACSi | ~ ( NotChar | LBRACESi | RBRACSi | LTSi | AMPERSi | APOSSi ) )
            {
            // etc/XQFT.g:1035:9: ({...}? => APOSSi APOSSi | {...}? => LBRACESi LBRACESi | {...}? => RBRACSi RBRACSi | ~ ( NotChar | LBRACESi | RBRACSi | LTSi | AMPERSi | APOSSi ) )
            int alt15=4;
            ...
            if ( (LA15_0=='\'') && ((input.LA(1)=='\'' && input.LA(2)=='\''))) {
                ...
                if (backtracking>0) {failed=true; return ;}
                NoViableAltException nvae =
                    new NoViableAltException("1035:9: ({...}? => APOSSi APOSSi | {...}? => LBRACESi LBRACESi | {...}? => RBRACSi RBRACSi | ~ ( NotChar | LBRACESi | RBRACSi | LTSi | AMPERSi | APOSSi ) )", 15, 0, input);

                throw nvae;
            }
            switch (alt15) {
                case 1 :
                    // etc/XQFT.g:1036:13: {...}? => APOSSi APOSSi
                    {
                    if ( !((input.LA(1)=='\'' && input.LA(2)=='\'')) ) {
                        if (backtracking>0) {failed=true; return ;}
                    ...
                    break;
                case 2 :
                    // etc/XQFT.g:1037:15: {...}? => LBRACESi LBRACESi
                    {
                    if ( !((input.LA(1)=='{' && input.LA(2)=='{')) ) {
                        if (backtracking>0) {failed=true; return ;}
                        throw new FailedPredicateException(input, "AposAttrContentChar", "(input.LA(1)=='{' && input.LA(2)=='{')");
                    ...
                    break;
                case 3 :
                    // etc/XQFT.g:1038:15: {...}? => RBRACSi RBRACSi
                    {
                    if ( !((input.LA(1)=='}' && input.LA(2)=='}')) ) {
                        if (backtracking>0) {failed=true; return ;}
                        throw new FailedPredicateException(input, "AposAttrContentChar", "(input.LA(1)=='}' && input.LA(2)=='}')");
                    ...
                    break;
                case 4 :
                    // etc/XQFT.g:1039:15: ~ ( NotChar | LBRACESi | RBRACSi | LTSi | AMPERSi | APOSSi )
                    {
                    if ( input.LA(1)=='\u0000'||(input.LA(1)>='\t' && input.LA(1)<='\n')||input.LA(1)=='\r'||(input.LA(1)>=' ' && input.LA(1)<='%')||(input.LA(1)>='(' && input.LA(1)<=';')||(input.LA(1)>='=' && input.LA(1)<='z')||input.LA(1)=='|'||(input.LA(1)>='~' && input.LA(1)<='\uD7FF')||(input.LA(1)>='\uE000' && input.LA(1)<='\uFFFE') ) {
                        input.consume();
                    failed=false;
    ...
    public final void mCDataSectionLEX() throws RecognitionException {
        try {
            // etc/XQFT.g:1045:26: ( LCDATASi CDataContents RCDATASi )
            // etc/XQFT.g:1046:5: LCDATASi CDataContents RCDATASi
            {
            if ( backtracking==0 ) {
              prepareSubToken();
            }
    ...
    public final void mLCDATASi() throws RecognitionException {
        try {
            // etc/XQFT.g:1051:19: ( '<![CDATA[' )
            // etc/XQFT.g:1051:21: '<![CDATA['
            {
    ...
    public final void mCDataContents() throws RecognitionException {
        try {
            // etc/XQFT.g:1052:24: ( ({...}? => RBRACKSi | ~ ( RBRACKSi | NotChar ) )* )
            // etc/XQFT.g:1052:26: ({...}? => RBRACKSi | ~ ( RBRACKSi | NotChar ) )*
            {
            // etc/XQFT.g:1052:26: ({...}? => RBRACKSi | ~ ( RBRACKSi | NotChar ) )*
            loop16:
            do {
            	...
            	case 1 :
            	    ...
            	    break;
            	case 2 :
            	    // etc/XQFT.g:1052:83: ~ ( RBRACKSi | NotChar )
            	    {
            	    if ( input.LA(1)=='\u0000'||(input.LA(1)>='\t' && input.LA(1)<='\n')||input.LA(1)=='\r'||(input.LA(1)>=' ' && input.LA(1)<='\\')||(input.LA(1)>='^' && input.LA(1)<='\uD7FF')||(input.LA(1)>='\uE000' && input.LA(1)<='\uFFFE') ) {
            	        input.consume();
            	    failed=false;
    ...
    public final void mDirPIConstructor() throws RecognitionException {
        try {
            ...
            // etc/XQFT.g:1055:27: ( LPISi PiTarget ( S d= DirPiContents )? RPISi )
            // etc/XQFT.g:1056:5: LPISi PiTarget ( S d= DirPiContents )? RPISi
            {
            if ( backtracking==0 ) {
              prepareSubToken();
            }
            ...
            // etc/XQFT.g:1058:5: ( S d= DirPiContents )?
            int alt17=2;
            ...
            switch (alt17) {
                case 1 :
                    // etc/XQFT.g:1059:9: S d= DirPiContents
                    {
                    mS(); if (failed) return ;
                    if ( backtracking==0 ) {
                      prepareSubToken();
                    }
                    int dStart1646 = getCharIndex();
                    mDirPiContents(); if (failed) return ;
                    d = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, dStart1646, getCharIndex()-1);
                    if ( backtracking==0 ) {
    ...
    public final void mPiTarget() throws RecognitionException {
        try {
            ...
            // etc/XQFT.g:1066:19: (n= Name {...}?)
            // etc/XQFT.g:1066:21: n= Name {...}?
            {
            int nStart1698 = getCharIndex();
            mName(); if (failed) return ;
            n = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, nStart1698, getCharIndex()-1);
    ...
    public final void mName() throws RecognitionException {
        try {
            // etc/XQFT.g:1067:15: ( ( Letter | UNDERSCORESi | COLONSi ) ( NameChar )* )
            // etc/XQFT.g:1067:17: ( Letter | UNDERSCORESi | COLONSi ) ( NameChar )*
            {
    ...
    public final void mNameChar() throws RecognitionException {
        try {
            // etc/XQFT.g:1068:19: ( Letter | Digit | DOTSi | MINUSSi | UNDERSCORESi | COLONSi | CombiningChar | Extender )
            // etc/XQFT.g:
            {
    ...
    public final void mDirPiContents() throws RecognitionException {
        try {
            // etc/XQFT.g:1069:24: ( ({...}? => QUESTIONSi | ~ ( NotChar | QUESTIONSi ) )* )
            // etc/XQFT.g:1069:26: ({...}? => QUESTIONSi | ~ ( NotChar | QUESTIONSi ) )*
            {
            // etc/XQFT.g:1069:26: ({...}? => QUESTIONSi | ~ ( NotChar | QUESTIONSi ) )*
            loop19:
            do {
            	...
            	case 1 :
            	    ...
            	    break;
            	case 2 :
            	    // etc/XQFT.g:1069:63: ~ ( NotChar | QUESTIONSi )
            	    {
            	    if ( input.LA(1)=='\u0000'||(input.LA(1)>='\t' && input.LA(1)<='\n')||input.LA(1)=='\r'||(input.LA(1)>=' ' && input.LA(1)<='>')||(input.LA(1)>='@' && input.LA(1)<='\uD7FF')||(input.LA(1)>='\uE000' && input.LA(1)<='\uFFFE') ) {
            	        input.consume();
            	    failed=false;
    ...
    public final void mDirCommentConstLEX() throws RecognitionException {
        try {
            // etc/XQFT.g:1073:29: ( LCOMMENTSi DirCommentContent RCOMMENTSi )
            // etc/XQFT.g:1074:5: LCOMMENTSi DirCommentContent RCOMMENTSi
            {
            if ( backtracking==0 ) {
              prepareSubToken();
            }
    ...
    public final void mDirCommentContent() throws RecognitionException {
        try {
            // etc/XQFT.g:1080:28: ( ({...}? => MINUSSi | ~ ( NotChar | MINUSSi ) )* )
            // etc/XQFT.g:1080:30: ({...}? => MINUSSi | ~ ( NotChar | MINUSSi ) )*
            {
            // etc/XQFT.g:1080:30: ({...}? => MINUSSi | ~ ( NotChar | MINUSSi ) )*
            loop20:
            do {
            	...
            	case 1 :
            	    ...
            	    break;
            	case 2 :
            	    // etc/XQFT.g:1080:65: ~ ( NotChar | MINUSSi )
            	    {
            	    if ( input.LA(1)=='\u0000'||(input.LA(1)>='\t' && input.LA(1)<='\n')||input.LA(1)=='\r'||(input.LA(1)>=' ' && input.LA(1)<=',')||(input.LA(1)>='.' && input.LA(1)<='\uD7FF')||(input.LA(1)>='\uE000' && input.LA(1)<='\uFFFE') ) {
            	        input.consume();
            	    failed=false;
    ...
    public final void mPragmaLEX() throws RecognitionException {
        try {
            ...
            // etc/XQFT.g:1084:20: ( LPRAGSi ( S )? ( ( QName )=> QName | NCName ) ( S p= PragmaContents )? RPRAGSi )
            // etc/XQFT.g:1085:5: LPRAGSi ( S )? ( ( QName )=> QName | NCName ) ( S p= PragmaContents )? RPRAGSi
            {
            if ( backtracking==0 ) {
              prepareSubToken();
            }
            ...
            // etc/XQFT.g:1087:5: ( ( QName )=> QName | NCName )
            int alt22=2;
            alt22 = dfa22.predict(input);
            switch (alt22) {
                case 1 :
                    // etc/XQFT.g:1088:9: ( QName )=> QName
                    {
                    if ( backtracking==0 ) {
                      prepareSubToken();
                    }
            ...
            // etc/XQFT.g:1092:5: ( S p= PragmaContents )?
            int alt23=2;
            ...
            switch (alt23) {
                case 1 :
                    // etc/XQFT.g:1093:9: S p= PragmaContents
                    {
                    mS(); if (failed) return ;
                    if ( backtracking==0 ) {
                      prepareSubToken();
                    }
                    int pStart2039 = getCharIndex();
                    mPragmaContents(); if (failed) return ;
                    p = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, pStart2039, getCharIndex()-1);
                    if ( backtracking==0 ) {
    ...
    public final void mPragmaContents() throws RecognitionException {
        try {
            // etc/XQFT.g:1100:25: ( ({...}? => SHARPSi | ~ ( NotChar | SHARPSi ) )* )
            // etc/XQFT.g:1100:27: ({...}? => SHARPSi | ~ ( NotChar | SHARPSi ) )*
            {
            // etc/XQFT.g:1100:27: ({...}? => SHARPSi | ~ ( NotChar | SHARPSi ) )*
            loop24:
            do {
            	...
            	case 1 :
            	    ...
            	    break;
            	case 2 :
            	    // etc/XQFT.g:1100:62: ~ ( NotChar | SHARPSi )
            	    {
            	    if ( input.LA(1)=='\u0000'||(input.LA(1)>='\t' && input.LA(1)<='\n')||input.LA(1)=='\r'||(input.LA(1)>=' ' && input.LA(1)<='\"')||(input.LA(1)>='$' && input.LA(1)<='\uD7FF')||(input.LA(1)>='\uE000' && input.LA(1)<='\uFFFE') ) {
            	        input.consume();
            	    failed=false;
    ...
    public final void mComment() throws RecognitionException {
        try {
            // etc/XQFT.g:1104:18: ( LXQCOMMENTSi ({...}? Comment | {...}? => COLONSi | {...}? => LPARSi | ~ ( LPARSi | COLONSi | NotChar ) )* RXQCOMMENTSi )
            // etc/XQFT.g:1105:5: LXQCOMMENTSi ({...}? Comment | {...}? => COLONSi | {...}? => LPARSi | ~ ( LPARSi | COLONSi | NotChar ) )* RXQCOMMENTSi
            {
            mLXQCOMMENTSi(); if (failed) return ;
            // etc/XQFT.g:1106:5: ({...}? Comment | {...}? => COLONSi | {...}? => LPARSi | ~ ( LPARSi | COLONSi | NotChar ) )*
            loop25:
            do {
                int alt25=5;
            	...
            	case 3 :
            	    ...
            	    break;
            	case 4 :
            	    // etc/XQFT.g:1109:7: ~ ( LPARSi | COLONSi | NotChar )
            	    {
    ...
    public final void mNumberLEX() throws RecognitionException {
        try {
            // etc/XQFT.g:1118:20: ( ( DoubleLiteral )=> DoubleLiteral | ( DecimalLiteral )=> DecimalLiteral | ( IntegerLiteral )=> IntegerLiteral )
            int alt26=3;
            alt26 = dfa26.predict(input);
            switch (alt26) {
                case 1 :
                    // etc/XQFT.g:1118:22: ( DoubleLiteral )=> DoubleLiteral
                    {
                    ...
                    break;
                case 2 :
                    // etc/XQFT.g:1119:7: ( DecimalLiteral )=> DecimalLiteral
                    {
                    ...
                    break;
                case 3 :
                    // etc/XQFT.g:1120:7: ( IntegerLiteral )=> IntegerLiteral
                    {
    ...
    public final void mIntegerLiteral() throws RecognitionException {
        try {
            // etc/XQFT.g:1123:25: ( Digits )
            // etc/XQFT.g:1123:27: Digits
            {
    ...
    public final void mDecimalLiteral() throws RecognitionException {
        try {
            // etc/XQFT.g:1124:25: ( DOTSi Digits | Digits DOTSi ( '0' .. '9' )* )
            int alt28=2;
            ...
            if ( (LA28_0=='.') ) {
                ...
                if (backtracking>0) {failed=true; return ;}
                NoViableAltException nvae =
                    new NoViableAltException("1124:10: fragment DecimalLiteral : ( DOTSi Digits | Digits DOTSi ( '0' .. '9' )* );", 28, 0, input);

                throw nvae;
            }
            switch (alt28) {
                case 1 :
                    // etc/XQFT.g:1124:27: DOTSi Digits
                    {
                    mDOTSi(); if (failed) return ;
                    mDigits(); if (failed) return ;
                    ...
                    break;
                case 2 :
                    // etc/XQFT.g:1124:42: Digits DOTSi ( '0' .. '9' )*
                    {
                    mDigits(); if (failed) return ;
                    mDOTSi(); if (failed) return ;
                    // etc/XQFT.g:1124:55: ( '0' .. '9' )*
                    loop27:
                    do {
                        int alt27=2;
    ...
    public final void mDoubleLiteral() throws RecognitionException {
        try {
            // etc/XQFT.g:1125:24: ( ( DOTSi Digits | Digits ( DOTSi ( '0' .. '9' )* )? ) ( 'e' | 'E' ) ( PLUSSi | MINUSSi )? Digits )
            // etc/XQFT.g:1126:5: ( DOTSi Digits | Digits ( DOTSi ( '0' .. '9' )* )? ) ( 'e' | 'E' ) ( PLUSSi | MINUSSi )? Digits
            {
            // etc/XQFT.g:1126:5: ( DOTSi Digits | Digits ( DOTSi ( '0' .. '9' )* )? )
            int alt31=2;
            ...
            if ( (LA31_0=='.') ) {
                ...
                if (backtracking>0) {failed=true; return ;}
                NoViableAltException nvae =
                    new NoViableAltException("1126:5: ( DOTSi Digits | Digits ( DOTSi ( '0' .. '9' )* )? )", 31, 0, input);

                throw nvae;
            }
            switch (alt31) {
                case 1 :
                    // etc/XQFT.g:1127:9: DOTSi Digits
                    {
                    mDOTSi(); if (failed) return ;
                    mDigits(); if (failed) return ;
                    ...
                    break;
                case 2 :
                    // etc/XQFT.g:1128:11: Digits ( DOTSi ( '0' .. '9' )* )?
                    {
                    mDigits(); if (failed) return ;
                    // etc/XQFT.g:1128:18: ( DOTSi ( '0' .. '9' )* )?
                    int alt30=2;
                    ...
                    switch (alt30) {
                        case 1 :
                            // etc/XQFT.g:1128:20: DOTSi ( '0' .. '9' )*
                            {
                            mDOTSi(); if (failed) return ;
                            // etc/XQFT.g:1128:26: ( '0' .. '9' )*
                            loop29:
                            do {
                                int alt29=2;
            ...
            // etc/XQFT.g:1130:15: ( PLUSSi | MINUSSi )?
            int alt32=2;
    ...
    public final void mQName() throws RecognitionException {
        try {
            // etc/XQFT.g:1133:16: ( NCName COLONSi NCName )
            // etc/XQFT.g:1133:18: NCName COLONSi NCName
            {
            mNCName(); if (failed) return ;
            mCOLONSi(); if (failed) return ;
            mNCName(); if (failed) return ;
    ...
    public final void mNCName() throws RecognitionException {
        try {
            // etc/XQFT.g:1135:17: ( NCNameStartChar ( NCNameChar )* )
            // etc/XQFT.g:1135:19: NCNameStartChar ( NCNameChar )*
            {
            mNCNameStartChar(); if (failed) return ;
            // etc/XQFT.g:1135:35: ( NCNameChar )*
            loop33:
            do {
                int alt33=2;
    ...
    public final void mNCNameChar() throws RecognitionException {
        try {
            // etc/XQFT.g:1136:21: ( Letter | Digit | DOTSi | MINUSSi | UNDERSCORESi | CombiningChar | Extender )
            // etc/XQFT.g:
            {
    ...
    public final void mNCNameStartChar() throws RecognitionException {
        try {
            // etc/XQFT.g:1137:26: ( Letter | UNDERSCORESi )
            // etc/XQFT.g:
            {
    ...
    public final void mLexLiterals() throws RecognitionException {
        try {
            ...
            // etc/XQFT.g:1139:22: ( ( QName )=> QName | n= NCName )
            int alt34=2;
            alt34 = dfa34.predict(input);
            switch (alt34) {
                case 1 :
                    // etc/XQFT.g:1140:5: ( QName )=> QName
                    {
                    mQName(); if (failed) return ;
                    if ( backtracking==0 ) {
                    ...
                    break;
                case 2 :
                    // etc/XQFT.g:1141:7: n= NCName
                    {
                    int nStart2639 = getCharIndex();
                    mNCName(); if (failed) return ;
                    n = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, nStart2639, getCharIndex()-1);
                    if ( backtracking==0 ) {
    ...
    public final void mLexSigns() throws RecognitionException {
        try {
            // etc/XQFT.g:1293:19: ( NODEBEFORESi | LTOREQSi | GTOREQSi | NODEAFTERSi | DBLCOLONSi | ASSIGNSi | DBLSLASHSi | DOTDOTSi | NEQSi )
            int alt35=9;
            switch ( input.LA(1) ) {
            case '<':
                {
                ...
                if ( (LA35_1=='=') ) {
                    ...
                    if (backtracking>0) {failed=true; return ;}
                    NoViableAltException nvae =
                        new NoViableAltException("1293:10: fragment LexSigns : ( NODEBEFORESi | LTOREQSi | GTOREQSi | NODEAFTERSi | DBLCOLONSi | ASSIGNSi | DBLSLASHSi | DOTDOTSi | NEQSi );", 35, 1, input);
            ...
            case '>':
                ...
                if ( (LA35_2=='>') ) {
                    ...
                    if (backtracking>0) {failed=true; return ;}
                    NoViableAltException nvae =
                        new NoViableAltException("1293:10: fragment LexSigns : ( NODEBEFORESi | LTOREQSi | GTOREQSi | NODEAFTERSi | DBLCOLONSi | ASSIGNSi | DBLSLASHSi | DOTDOTSi | NEQSi );", 35, 2, input);
            ...
            case ':':
                ...
                if ( (LA35_3=='=') ) {
                    ...
                    if (backtracking>0) {failed=true; return ;}
                    NoViableAltException nvae =
                        new NoViableAltException("1293:10: fragment LexSigns : ( NODEBEFORESi | LTOREQSi | GTOREQSi | NODEAFTERSi | DBLCOLONSi | ASSIGNSi | DBLSLASHSi | DOTDOTSi | NEQSi );", 35, 3, input);
            ...
            default:
                if (backtracking>0) {failed=true; return ;}
                NoViableAltException nvae =
                    new NoViableAltException("1293:10: fragment LexSigns : ( NODEBEFORESi | LTOREQSi | GTOREQSi | NODEAFTERSi | DBLCOLONSi | ASSIGNSi | DBLSLASHSi | DOTDOTSi | NEQSi );", 35, 0, input);
            ...
            switch (alt35) {
                case 1 :
                    // etc/XQFT.g:1294:5: NODEBEFORESi
                    {
    ...
    public final void mUNDERSCORESi() throws RecognitionException {
        try {
            // etc/XQFT.g:1341:23: ( '_' )
            // etc/XQFT.g:1341:25: '_'
            {
    ...
    public final void mALL() throws RecognitionException {
        try {
            // etc/XQFT.g:1348:23: ( 'all' )
            // etc/XQFT.g:1348:25: 'all'
            {
    ...
    public final void mANY() throws RecognitionException {
        try {
            // etc/XQFT.g:1349:23: ( 'any' )
            // etc/XQFT.g:1349:25: 'any'
            {
    ...
    public final void mANCESTOR() throws RecognitionException {
        try {
            // etc/XQFT.g:1350:23: ( 'ancestor' )
            // etc/XQFT.g:1350:25: 'ancestor'
            {
    ...
    public final void mANCESTOR_OR_SELF() throws RecognitionException {
        try {
            // etc/XQFT.g:1351:27: ( 'ancestor-or-self' )
            // etc/XQFT.g:1351:29: 'ancestor-or-self'
            {
    ...
    public final void mAND() throws RecognitionException {
        try {
            // etc/XQFT.g:1352:23: ( 'and' )
            // etc/XQFT.g:1352:25: 'and'
            {
    ...
    public final void mAS() throws RecognitionException {
        try {
            // etc/XQFT.g:1353:23: ( 'as' )
            // etc/XQFT.g:1353:25: 'as'
            {
    ...
    public final void mASCENDING() throws RecognitionException {
        try {
            // etc/XQFT.g:1354:23: ( 'ascending' )
            // etc/XQFT.g:1354:25: 'ascending'
            {
    ...
    public final void mAT() throws RecognitionException {
        try {
            // etc/XQFT.g:1355:23: ( 'at' )
            // etc/XQFT.g:1355:25: 'at'
            {
    ...
    public final void mATTRIBUTE() throws RecognitionException {
        try {
            // etc/XQFT.g:1356:23: ( 'attribute' )
            // etc/XQFT.g:1356:25: 'attribute'
            {
    ...
    public final void mBASE_URI() throws RecognitionException {
        try {
            // etc/XQFT.g:1357:23: ( 'base-uri' )
            // etc/XQFT.g:1357:25: 'base-uri'
            {
    ...
    public final void mBY() throws RecognitionException {
        try {
            // etc/XQFT.g:1358:23: ( 'by' )
            // etc/XQFT.g:1358:25: 'by'
            {
    ...
    public final void mBOUNDARYSPACE() throws RecognitionException {
        try {
            // etc/XQFT.g:1359:24: ( 'boundary-space' )
            // etc/XQFT.g:1359:26: 'boundary-space'
            {
    ...
    public final void mCASE() throws RecognitionException {
        try {
            // etc/XQFT.g:1360:23: ( 'case' )
            // etc/XQFT.g:1360:25: 'case'
            {
    ...
    public final void mCAST() throws RecognitionException {
        try {
            // etc/XQFT.g:1361:23: ( 'cast' )
            // etc/XQFT.g:1361:25: 'cast'
            {
    ...
    public final void mCASTABLE() throws RecognitionException {
        try {
            // etc/XQFT.g:1362:23: ( 'castable' )
            // etc/XQFT.g:1362:25: 'castable'
            {
    ...
    public final void mCHILD() throws RecognitionException {
        try {
            // etc/XQFT.g:1363:23: ( 'child' )
            // etc/XQFT.g:1363:25: 'child'
            {
    ...
    public final void mCOLLATION() throws RecognitionException {
        try {
            // etc/XQFT.g:1364:23: ( 'collation' )
            // etc/XQFT.g:1364:25: 'collation'
            {
    ...
    public final void mCOMMENT() throws RecognitionException {
        try {
            // etc/XQFT.g:1365:23: ( 'comment' )
            // etc/XQFT.g:1365:25: 'comment'
            {
    ...
    public final void mCONSTRUCTION() throws RecognitionException {
        try {
            // etc/XQFT.g:1366:23: ( 'construction' )
            // etc/XQFT.g:1366:25: 'construction'
            {
    ...
    public final void mCONTENT() throws RecognitionException {
        try {
            // etc/XQFT.g:1367:23: ( 'content' )
            // etc/XQFT.g:1367:25: 'content'
            {
    ...
    public final void mCOPY_NAMESPACES() throws RecognitionException {
        try {
            // etc/XQFT.g:1368:26: ( 'copy-namespaces' )
            // etc/XQFT.g:1368:28: 'copy-namespaces'
            {
    ...
    public final void mDECLARE() throws RecognitionException {
        try {
            // etc/XQFT.g:1369:23: ( 'declare' )
            // etc/XQFT.g:1369:25: 'declare'
            {
    ...
    public final void mDEFAULT() throws RecognitionException {
        try {
            // etc/XQFT.g:1370:23: ( 'default' )
            // etc/XQFT.g:1370:25: 'default'
            {
    ...
    public final void mDESCENDANT() throws RecognitionException {
        try {
            // etc/XQFT.g:1371:23: ( 'descendant' )
            // etc/XQFT.g:1371:25: 'descendant'
            {
    ...
    public final void mDESCENDANT_OR_SELF() throws RecognitionException {
        try {
            // etc/XQFT.g:1372:29: ( 'descendant-or-self' )
            // etc/XQFT.g:1372:31: 'descendant-or-self'
            {
    ...
    public final void mDESCENDING() throws RecognitionException {
        try {
            // etc/XQFT.g:1373:23: ( 'descending' )
            // etc/XQFT.g:1373:25: 'descending'
            {
    ...
    public final void mDIACRITICS() throws RecognitionException {
        try {
            // etc/XQFT.g:1374:23: ( 'diacritics' )
            // etc/XQFT.g:1374:25: 'diacritics'
            {
    ...
    public final void mDIFFERENT() throws RecognitionException {
        try {
            // etc/XQFT.g:1375:23: ( 'different' )
            // etc/XQFT.g:1375:25: 'different'
            {
    ...
    public final void mDISTANCE() throws RecognitionException {
        try {
            // etc/XQFT.g:1376:23: ( 'distance' )
            // etc/XQFT.g:1376:25: 'distance'
            {
    ...
    public final void mDIV() throws RecognitionException {
        try {
            // etc/XQFT.g:1377:23: ( 'div' )
            // etc/XQFT.g:1377:25: 'div'
            {
    ...
    public final void mDOCUMENT() throws RecognitionException {
        try {
            // etc/XQFT.g:1378:23: ( 'document' )
            // etc/XQFT.g:1378:25: 'document'
            {
    ...
    public final void mDOCUMENT_NODE() throws RecognitionException {
        try {
            // etc/XQFT.g:1379:24: ( 'document-node' )
            // etc/XQFT.g:1379:26: 'document-node'
            {
    ...
    public final void mELEMENT() throws RecognitionException {
        try {
            // etc/XQFT.g:1380:23: ( 'element' )
            // etc/XQFT.g:1380:25: 'element'
            {
    ...
    public final void mELSE() throws RecognitionException {
        try {
            // etc/XQFT.g:1381:23: ( 'else' )
            // etc/XQFT.g:1381:25: 'else'
            {
    ...
    public final void mENCODING() throws RecognitionException {
        try {
            // etc/XQFT.g:1382:23: ( 'encoding' )
            // etc/XQFT.g:1382:25: 'encoding'
            {
    ...
    public final void mEND() throws RecognitionException {
        try {
            // etc/XQFT.g:1383:23: ( 'end' )
            // etc/XQFT.g:1383:25: 'end'
            {
    ...
    public final void mENTIRE() throws RecognitionException {
        try {
            // etc/XQFT.g:1384:23: ( 'entire' )
            // etc/XQFT.g:1384:25: 'entire'
            {
    ...
    public final void mEMPTY() throws RecognitionException {
        try {
            // etc/XQFT.g:1385:23: ( 'empty' )
            // etc/XQFT.g:1385:25: 'empty'
            {
    ...
    public final void mEMPTY_SEQUENCE() throws RecognitionException {
        try {
            // etc/XQFT.g:1386:25: ( 'empty-sequence' )
            // etc/XQFT.g:1386:27: 'empty-sequence'
            {
    ...
    public final void mEQ() throws RecognitionException {
        try {
            // etc/XQFT.g:1387:23: ( 'eq' )
            // etc/XQFT.g:1387:25: 'eq'
            {
    ...
    public final void mEVERY() throws RecognitionException {
        try {
            // etc/XQFT.g:1388:23: ( 'every' )
            // etc/XQFT.g:1388:25: 'every'
            {
    ...
    public final void mEXACTLY() throws RecognitionException {
        try {
            // etc/XQFT.g:1389:23: ( 'exactly' )
            // etc/XQFT.g:1389:25: 'exactly'
            {
    ...
    public final void mEXCEPT() throws RecognitionException {
        try {
            // etc/XQFT.g:1390:23: ( 'except' )
            // etc/XQFT.g:1390:25: 'except'
            {
    ...
    public final void mEXTERNAL() throws RecognitionException {
        try {
            // etc/XQFT.g:1391:23: ( 'external' )
            // etc/XQFT.g:1391:25: 'external'
            {
    ...
    public final void mFOLLOWING() throws RecognitionException {
        try {
            // etc/XQFT.g:1392:23: ( 'following' )
            // etc/XQFT.g:1392:25: 'following'
            {
    ...
    public final void mFOLLOWING_SIBLING() throws RecognitionException {
        try {
            // etc/XQFT.g:1393:28: ( 'following-sibling' )
            // etc/XQFT.g:1393:30: 'following-sibling'
            {
    ...
    public final void mFOR() throws RecognitionException {
        try {
            // etc/XQFT.g:1394:23: ( 'for' )
            // etc/XQFT.g:1394:25: 'for'
            {
    ...
    public final void mFROM() throws RecognitionException {
        try {
            // etc/XQFT.g:1395:23: ( 'from' )
            // etc/XQFT.g:1395:25: 'from'
            {
    ...
    public final void mFTAND() throws RecognitionException {
        try {
            // etc/XQFT.g:1396:23: ( 'ftand' )
            // etc/XQFT.g:1396:25: 'ftand'
            {
    ...
    public final void mFTCONTAINS() throws RecognitionException {
        try {
            // etc/XQFT.g:1397:23: ( 'ftcontains' )
            // etc/XQFT.g:1397:25: 'ftcontains'
            {
    ...
    public final void mFTNOT() throws RecognitionException {
        try {
            // etc/XQFT.g:1398:23: ( 'ftnot' )
            // etc/XQFT.g:1398:25: 'ftnot'
            {
    ...
    public final void mFTOPTION() throws RecognitionException {
        try {
            // etc/XQFT.g:1399:23: ( 'ft-option' )
            // etc/XQFT.g:1399:25: 'ft-option'
            {
    ...
    public final void mFTOR() throws RecognitionException {
        try {
            // etc/XQFT.g:1400:23: ( 'ftor' )
            // etc/XQFT.g:1400:25: 'ftor'
            {
    ...
    public final void mFUNCTION() throws RecognitionException {
        try {
            // etc/XQFT.g:1401:23: ( 'function' )
            // etc/XQFT.g:1401:25: 'function'
            {
    ...
    public final void mGE() throws RecognitionException {
        try {
            // etc/XQFT.g:1402:23: ( 'ge' )
            // etc/XQFT.g:1402:25: 'ge'
            {
    ...
    public final void mGREATEST() throws RecognitionException {
        try {
            // etc/XQFT.g:1403:23: ( 'greatest' )
            // etc/XQFT.g:1403:25: 'greatest'
            {
    ...
    public final void mGT() throws RecognitionException {
        try {
            // etc/XQFT.g:1404:23: ( 'gt' )
            // etc/XQFT.g:1404:25: 'gt'
            {
            match("gt"); if (failed) return ;
    ...
    public final void mIDIV() throws RecognitionException {
        try {
            // etc/XQFT.g:1405:23: ( 'idiv' )
            // etc/XQFT.g:1405:25: 'idiv'
            {
    ...
    public final void mIF() throws RecognitionException {
        try {
            // etc/XQFT.g:1406:23: ( 'if' )
            // etc/XQFT.g:1406:25: 'if'
            {
    ...
    public final void mIMPORT() throws RecognitionException {
        try {
            // etc/XQFT.g:1407:23: ( 'import' )
            // etc/XQFT.g:1407:25: 'import'
            {
    ...
    public final void mIN() throws RecognitionException {
        try {
            // etc/XQFT.g:1408:23: ( 'in' )
            // etc/XQFT.g:1408:25: 'in'
            {
    ...
    public final void mINHERIT() throws RecognitionException {
        try {
            // etc/XQFT.g:1409:23: ( 'inherit' )
            // etc/XQFT.g:1409:25: 'inherit'
            {
    ...
    public final void mINSENSITIVE() throws RecognitionException {
        try {
            // etc/XQFT.g:1410:23: ( 'insensitive' )
            // etc/XQFT.g:1410:25: 'insensitive'
            {
    ...
    public final void mINSTANCE() throws RecognitionException {
        try {
            // etc/XQFT.g:1411:23: ( 'instance' )
            // etc/XQFT.g:1411:25: 'instance'
            {
    ...
    public final void mINTERSECT() throws RecognitionException {
        try {
            // etc/XQFT.g:1412:23: ( 'intersect' )
            // etc/XQFT.g:1412:25: 'intersect'
            {
    ...
    public final void mIS() throws RecognitionException {
        try {
            // etc/XQFT.g:1413:23: ( 'is' )
            // etc/XQFT.g:1413:25: 'is'
            {
    ...
    public final void mITEM() throws RecognitionException {
        try {
            // etc/XQFT.g:1414:23: ( 'item' )
            // etc/XQFT.g:1414:25: 'item'
            {
    ...
    public final void mLANGUAGE() throws RecognitionException {
        try {
            // etc/XQFT.g:1415:23: ( 'language' )
            // etc/XQFT.g:1415:25: 'language'
            {
    ...
    public final void mLAX() throws RecognitionException {
        try {
            // etc/XQFT.g:1416:23: ( 'lax' )
            // etc/XQFT.g:1416:25: 'lax'
            {
    ...
    public final void mLE() throws RecognitionException {
        try {
            // etc/XQFT.g:1417:23: ( 'le' )
            // etc/XQFT.g:1417:25: 'le'
            {
    ...
    public final void mLEAST() throws RecognitionException {
        try {
            // etc/XQFT.g:1418:23: ( 'least' )
            // etc/XQFT.g:1418:25: 'least'
            {
    ...
    public final void mLET() throws RecognitionException {
        try {
            // etc/XQFT.g:1419:23: ( 'let' )
            // etc/XQFT.g:1419:25: 'let'
            {
    ...
    public final void mLEVELS() throws RecognitionException {
        try {
            // etc/XQFT.g:1420:23: ( 'levels' )
            // etc/XQFT.g:1420:25: 'levels'
            {
    ...
    public final void mLOWERCASE() throws RecognitionException {
        try {
            // etc/XQFT.g:1421:23: ( 'lowercase' )
            // etc/XQFT.g:1421:25: 'lowercase'
            {
    ...
    public final void mLT() throws RecognitionException {
        try {
            // etc/XQFT.g:1422:23: ( 'lt' )
            // etc/XQFT.g:1422:25: 'lt'
            {
            match("lt"); if (failed) return ;
    ...
    public final void mMOD() throws RecognitionException {
        try {
            // etc/XQFT.g:1423:23: ( 'mod' )
            // etc/XQFT.g:1423:25: 'mod'
            {
    ...
    public final void mMODULE() throws RecognitionException {
        try {
            // etc/XQFT.g:1424:23: ( 'module' )
            // etc/XQFT.g:1424:25: 'module'
            {
    ...
    public final void mMOST() throws RecognitionException {
        try {
            // etc/XQFT.g:1425:23: ( 'most' )
            // etc/XQFT.g:1425:25: 'most'
            {
    ...
    public final void mNAMESPACE() throws RecognitionException {
        try {
            // etc/XQFT.g:1426:23: ( 'namespace' )
            // etc/XQFT.g:1426:25: 'namespace'
            {
    ...
    public final void mNE() throws RecognitionException {
        try {
            // etc/XQFT.g:1427:23: ( 'ne' )
            // etc/XQFT.g:1427:25: 'ne'
            {
    ...
    public final void mNODE() throws RecognitionException {
        try {
            // etc/XQFT.g:1428:23: ( 'node' )
            // etc/XQFT.g:1428:25: 'node'
            {
    ...
    public final void mNOINHERIT() throws RecognitionException {
        try {
            // etc/XQFT.g:1429:23: ( 'no-inherit' )
            // etc/XQFT.g:1429:25: 'no-inherit'
            {
    ...
    public final void mNOPRESERVE() throws RecognitionException {
        try {
            // etc/XQFT.g:1430:23: ( 'no-preserve' )
            // etc/XQFT.g:1430:25: 'no-preserve'
            {
    ...
    public final void mNOT() throws RecognitionException {
        try {
            // etc/XQFT.g:1431:23: ( 'not' )
            // etc/XQFT.g:1431:25: 'not'
            {
    ...
    public final void mOCCURS() throws RecognitionException {
        try {
            // etc/XQFT.g:1432:23: ( 'occurs' )
            // etc/XQFT.g:1432:25: 'occurs'
            {
    ...
    public final void mOF() throws RecognitionException {
        try {
            // etc/XQFT.g:1433:23: ( 'of' )
            // etc/XQFT.g:1433:25: 'of'
            {
    ...
    public final void mOPTION() throws RecognitionException {
        try {
            // etc/XQFT.g:1434:23: ( 'option' )
            // etc/XQFT.g:1434:25: 'option'
            {
    ...
    public final void mOR() throws RecognitionException {
        try {
            // etc/XQFT.g:1435:23: ( 'or' )
            // etc/XQFT.g:1435:25: 'or'
            {
    ...
    public final void mORDER() throws RecognitionException {
        try {
            // etc/XQFT.g:1436:23: ( 'order' )
            // etc/XQFT.g:1436:25: 'order'
            {
    ...
    public final void mORDERED() throws RecognitionException {
        try {
            // etc/XQFT.g:1437:23: ( 'ordered' )
            // etc/XQFT.g:1437:25: 'ordered'
            {
    ...
    public final void mORDERING() throws RecognitionException {
        try {
            // etc/XQFT.g:1438:23: ( 'ordering' )
            // etc/XQFT.g:1438:25: 'ordering'
            {
    ...
    public final void mPARAGRAPH() throws RecognitionException {
        try {
            // etc/XQFT.g:1439:23: ( 'paragraph' )
            // etc/XQFT.g:1439:25: 'paragraph'
            {
    ...
    public final void mPARAGRAPHS() throws RecognitionException {
        try {
            // etc/XQFT.g:1440:23: ( 'paragraphs' )
            // etc/XQFT.g:1440:25: 'paragraphs'
            {
    ...
    public final void mPARENT() throws RecognitionException {
        try {
            // etc/XQFT.g:1441:23: ( 'parent' )
            // etc/XQFT.g:1441:25: 'parent'
            {
    ...
    public final void mPHRASE() throws RecognitionException {
        try {
            // etc/XQFT.g:1442:23: ( 'phrase' )
            // etc/XQFT.g:1442:25: 'phrase'
            {
    ...
    public final void mPRECEDING() throws RecognitionException {
        try {
            // etc/XQFT.g:1443:23: ( 'preceding' )
            // etc/XQFT.g:1443:25: 'preceding'
            {
    ...
    public final void mPRECEDING_SIBLING() throws RecognitionException {
        try {
            // etc/XQFT.g:1444:28: ( 'preceding-sibling' )
            // etc/XQFT.g:1444:30: 'preceding-sibling'
            {
    ...
    public final void mPRESERVE() throws RecognitionException {
        try {
            // etc/XQFT.g:1445:23: ( 'preserve' )
            // etc/XQFT.g:1445:25: 'preserve'
            {
    ...
    public final void mPROCESSING_INSTRUCTION() throws RecognitionException {
        try {
            // etc/XQFT.g:1446:33: ( 'processing-instruction' )
            // etc/XQFT.g:1446:35: 'processing-instruction'
            {
    ...
    public final void mRELATIONSHIP() throws RecognitionException {
        try {
            // etc/XQFT.g:1447:23: ( 'relationship' )
            // etc/XQFT.g:1447:25: 'relationship'
            {
    ...
    public final void mRETURN() throws RecognitionException {
        try {
            // etc/XQFT.g:1448:23: ( 'return' )
            // etc/XQFT.g:1448:25: 'return'
            {
    ...
    public final void mSAME() throws RecognitionException {
        try {
            // etc/XQFT.g:1449:23: ( 'same' )
            // etc/XQFT.g:1449:25: 'same'
            {
    ...
    public final void mSATISFIES() throws RecognitionException {
        try {
            // etc/XQFT.g:1450:23: ( 'satisfies' )
            // etc/XQFT.g:1450:25: 'satisfies'
            {
    ...
    public final void mSCHEMA() throws RecognitionException {
        try {
            // etc/XQFT.g:1451:23: ( 'schema' )
            // etc/XQFT.g:1451:25: 'schema'
            {
    ...
    public final void mSCHEMA_ATTRIBUTE() throws RecognitionException {
        try {
            // etc/XQFT.g:1452:27: ( 'schema-attribute' )
            // etc/XQFT.g:1452:29: 'schema-attribute'
            {
    ...
    public final void mSCHEMA_ELEMENT() throws RecognitionException {
        try {
            // etc/XQFT.g:1453:27: ( 'schema-element' )
            // etc/XQFT.g:1453:29: 'schema-element'
            {
    ...
    public final void mSCORE() throws RecognitionException {
        try {
            // etc/XQFT.g:1454:23: ( 'score' )
            // etc/XQFT.g:1454:25: 'score'
            {
    ...
    public final void mSELF() throws RecognitionException {
        try {
            // etc/XQFT.g:1455:23: ( 'self' )
            // etc/XQFT.g:1455:25: 'self'
            {
    ...
    public final void mSENSITIVE() throws RecognitionException {
        try {
            // etc/XQFT.g:1456:23: ( 'sensitive' )
            // etc/XQFT.g:1456:25: 'sensitive'
            {
    ...
    public final void mSENTENCES() throws RecognitionException {
        try {
            // etc/XQFT.g:1457:23: ( 'sentences' )
            // etc/XQFT.g:1457:25: 'sentences'
            {
    ...
    public final void mSENTENCE() throws RecognitionException {
        try {
            // etc/XQFT.g:1458:23: ( 'sentence' )
            // etc/XQFT.g:1458:25: 'sentence'
            {
    ...
    public final void mSOME() throws RecognitionException {
        try {
            // etc/XQFT.g:1459:23: ( 'some' )
            // etc/XQFT.g:1459:25: 'some'
            {
    ...
    public final void mSTABLE() throws RecognitionException {
        try {
            // etc/XQFT.g:1460:23: ( 'stable' )
            // etc/XQFT.g:1460:25: 'stable'
            {
    ...
    public final void mSTART() throws RecognitionException {
        try {
            // etc/XQFT.g:1461:23: ( 'start' )
            // etc/XQFT.g:1461:25: 'start'
            {
    ...
    public final void mSTEMMING() throws RecognitionException {
        try {
            // etc/XQFT.g:1462:23: ( 'stemming' )
            // etc/XQFT.g:1462:25: 'stemming'
            {
    ...
    public final void mSTOP() throws RecognitionException {
        try {
            // etc/XQFT.g:1463:23: ( 'stop' )
            // etc/XQFT.g:1463:25: 'stop'
            {
    ...
    public final void mSTRICT() throws RecognitionException {
        try {
            // etc/XQFT.g:1464:23: ( 'strict' )
            // etc/XQFT.g:1464:25: 'strict'
            {
    ...
    public final void mSTRIP() throws RecognitionException {
        try {
            // etc/XQFT.g:1465:23: ( 'strip' )
            // etc/XQFT.g:1465:25: 'strip'
            {
    ...
    public final void mTEXT() throws RecognitionException {
        try {
            // etc/XQFT.g:1466:23: ( 'text' )
            // etc/XQFT.g:1466:25: 'text'
            {
    ...
    public final void mTHESAURUS() throws RecognitionException {
        try {
            // etc/XQFT.g:1467:23: ( 'thesaurus' )
            // etc/XQFT.g:1467:25: 'thesaurus'
            {
    ...
    public final void mTHEN() throws RecognitionException {
        try {
            // etc/XQFT.g:1468:23: ( 'then' )
            // etc/XQFT.g:1468:25: 'then'
            {
    ...
    public final void mTIMES() throws RecognitionException {
        try {
            // etc/XQFT.g:1469:23: ( 'times' )
            // etc/XQFT.g:1469:25: 'times'
            {
    ...
    public final void mTO() throws RecognitionException {
        try {
            // etc/XQFT.g:1470:23: ( 'to' )
            // etc/XQFT.g:1470:25: 'to'
            {
    ...
    public final void mTREAT() throws RecognitionException {
        try {
            // etc/XQFT.g:1471:23: ( 'treat' )
            // etc/XQFT.g:1471:25: 'treat'
            {
    ...
    public final void mTYPESWITCH() throws RecognitionException {
        try {
            // etc/XQFT.g:1472:23: ( 'typeswitch' )
            // etc/XQFT.g:1472:25: 'typeswitch'
            {
    ...
    public final void mUNION() throws RecognitionException {
        try {
            // etc/XQFT.g:1473:23: ( 'union' )
            // etc/XQFT.g:1473:25: 'union'
            {
    ...
    public final void mUNORDERED() throws RecognitionException {
        try {
            // etc/XQFT.g:1474:23: ( 'unordered' )
            // etc/XQFT.g:1474:25: 'unordered'
            {
    ...
    public final void mUPPERCASE() throws RecognitionException {
        try {
            // etc/XQFT.g:1475:23: ( 'uppercase' )
            // etc/XQFT.g:1475:25: 'uppercase'
            {
    ...
    public final void mVALIDATE() throws RecognitionException {
        try {
            // etc/XQFT.g:1476:23: ( 'validate' )
            // etc/XQFT.g:1476:25: 'validate'
            {
    ...
    public final void mVARIABLE() throws RecognitionException {
        try {
            // etc/XQFT.g:1477:23: ( 'variable' )
            // etc/XQFT.g:1477:25: 'variable'
            {
    ...
    public final void mVERSION() throws RecognitionException {
        try {
            // etc/XQFT.g:1478:23: ( 'version' )
            // etc/XQFT.g:1478:25: 'version'
            {
    ...
    public final void mWEIGHT() throws RecognitionException {
        try {
            // etc/XQFT.g:1479:23: ( 'weight' )
            // etc/XQFT.g:1479:25: 'weight'
            {
    ...
    public final void mWHERE() throws RecognitionException {
        try {
            // etc/XQFT.g:1480:23: ( 'where' )
            // etc/XQFT.g:1480:25: 'where'
            {
    ...
    public final void mWILDCARDS() throws RecognitionException {
        try {
            // etc/XQFT.g:1481:23: ( 'wildcards' )
            // etc/XQFT.g:1481:25: 'wildcards'
            {
    ...
    public final void mWINDOW() throws RecognitionException {
        try {
            // etc/XQFT.g:1482:23: ( 'window' )
            // etc/XQFT.g:1482:25: 'window'
            {
    ...
    public final void mWITH() throws RecognitionException {
        try {
            // etc/XQFT.g:1483:23: ( 'with' )
            // etc/XQFT.g:1483:25: 'with'
            {
    ...
    public final void mWITHOUT() throws RecognitionException {
        try {
            // etc/XQFT.g:1484:23: ( 'without' )
            // etc/XQFT.g:1484:25: 'without'
            {
    ...
    public final void mWORD() throws RecognitionException {
        try {
            // etc/XQFT.g:1485:23: ( 'word' )
            // etc/XQFT.g:1485:25: 'word'
            {
    ...
    public final void mWORDS() throws RecognitionException {
        try {
            // etc/XQFT.g:1486:23: ( 'words' )
            // etc/XQFT.g:1486:25: 'words'
            {
    ...
    public final void mXQUERY() throws RecognitionException {
        try {
            // etc/XQFT.g:1487:23: ( 'xquery' )
            // etc/XQFT.g:1487:25: 'xquery'
            {
    ...
    public final void mCleanChar() throws RecognitionException {
        try {
            // etc/XQFT.g:1496:20: ( S | BaseChar | Ideographic | CombiningChar | Extender | Digit | ExtraChar | EXCLSi | SHARPSi | DOLLARSi | LPARSi | RPARSi | STARSi | PLUSSi | COMMASi | DOTSi | SLASHSi | COLONSi | SEMICOLONSi | EQSi | GTSi | QUESTIONSi | ATSi | LBRACKSi | BACKSLASHSi | RBRACKSi | UNDERSCORESi | PIPESi )
            int alt36=28;
            ...
            if ( ((LA36_0>='\t' && LA36_0<='\n')||LA36_0=='\r'||LA36_0==' ') ) {
                ...
                if (backtracking>0) {failed=true; return ;}
                NoViableAltException nvae =
                    new NoViableAltException("1496:10: fragment CleanChar : ( S | BaseChar | Ideographic | CombiningChar | Extender | Digit | ExtraChar | EXCLSi | SHARPSi | DOLLARSi | LPARSi | RPARSi | STARSi | PLUSSi | COMMASi | DOTSi | SLASHSi | COLONSi | SEMICOLONSi | EQSi | GTSi | QUESTIONSi | ATSi | LBRACKSi | BACKSLASHSi | RBRACKSi | UNDERSCORESi | PIPESi );", 36, 0, input);
            ...
            switch (alt36) {
                ...
                case 2 :
                    ...
                    break;
                case 3 :
                    // etc/XQFT.g:1497:20: Ideographic
                    {
                    ...
                    break;
                case 4 :
                    // etc/XQFT.g:1497:34: CombiningChar
                    {
                ...
                case 18 :
                    ...
                    break;
                case 19 :
                    // etc/XQFT.g:1499:35: SEMICOLONSi
                    {
                    mSEMICOLONSi(); if (failed) return ;
                ...
                case 24 :
                    ...
                    break;
                case 25 :
                    // etc/XQFT.g:1500:18: BACKSLASHSi
                    {
                ...
                case 26 :
                    ...
                    break;
                case 27 :
                    // etc/XQFT.g:1500:46: UNDERSCORESi
                    {
    ...
    public final void mChar() throws RecognitionException {
        try {
            // etc/XQFT.g:1503:15: ( CleanChar | LBRACESi | RBRACSi | LTSi | AMPERSi | QUOTSi | APOSSi | MINUSSi )
            int alt37=8;
            ...
            if ( ((LA37_0>='\t' && LA37_0<='\n')||LA37_0=='\r'||(LA37_0>=' ' && LA37_0<='!')||(LA37_0>='#' && LA37_0<='%')||(LA37_0>='(' && LA37_0<=',')||(LA37_0>='.' && LA37_0<=';')||(LA37_0>='=' && LA37_0<='z')||LA37_0=='|'||(LA37_0>='~' && LA37_0<='\uD7FF')||(LA37_0>='\uE000' && LA37_0<='\uFFFD')) ) {
                ...
                if (backtracking>0) {failed=true; return ;}
                NoViableAltException nvae =
                    new NoViableAltException("1503:10: fragment Char : ( CleanChar | LBRACESi | RBRACSi | LTSi | AMPERSi | QUOTSi | APOSSi | MINUSSi );", 37, 0, input);

                throw nvae;
            }
            switch (alt37) {
                case 1 :
                    // etc/XQFT.g:1503:17: CleanChar
                    {
    ...
    public final void mDigits() throws RecognitionException {
        try {
            // etc/XQFT.g:1508:17: ( ( '0' .. '9' )+ )
            // etc/XQFT.g:1508:19: ( '0' .. '9' )+
            {
            // etc/XQFT.g:1508:19: ( '0' .. '9' )+
            int cnt38=0;
            loop38:
    ...
    public final void mDigit() throws RecognitionException {
        try {
            // etc/XQFT.g:1509:42: ( '\\u0030' .. '\\u0039' | '\\u0660' .. '\\u0669' | '\\u06F0' .. '\\u06F9' | '\\u0966' .. '\\u096F' | '\\u09E6' .. '\\u09EF' | '\\u0A66' .. '\\u0A6F' | '\\u0AE6' .. '\\u0AEF' | '\\u0B66' .. '\\u0B6F' | '\\u0BE7' .. '\\u0BEF' | '\\u0C66' .. '\\u0C6F' | '\\u0CE6' .. '\\u0CEF' | '\\u0D66' .. '\\u0D6F' | '\\u0E50' .. '\\u0E59' | '\\u0ED0' .. '\\u0ED9' | '\\u0F20' .. '\\u0F29' )
            // etc/XQFT.g:
            {
    ...
    public final void mLetter() throws RecognitionException {
        try {
            // etc/XQFT.g:1511:44: ( BaseChar | Ideographic )
            // etc/XQFT.g:
            {
    ...
    public final void mCombiningChar() throws RecognitionException {
        try {
            // etc/XQFT.g:1517:42: ( '\\u0300' .. '\\u0345' | '\\u0360' .. '\\u0361' | '\\u0483' .. '\\u0486' | '\\u0591' .. '\\u05A1' | '\\u05A3' .. '\\u05B9' | '\\u05BB' .. '\\u05BD' | '\\u05BF' | '\\u05C1' .. '\\u05C2' | '\\u05C4' | '\\u064B' .. '\\u0652' | '\\u0670' | '\\u06D6' .. '\\u06DC' | '\\u06DD' .. '\\u06DF' | '\\u06E0' .. '\\u06E4' | '\\u06E7' .. '\\u06E8' | '\\u06EA' .. '\\u06ED' | '\\u0901' .. '\\u0903' | '\\u093C' | '\\u093E' .. '\\u094C' | '\\u094D' | '\\u0951' .. '\\u0954' | '\\u0962' .. '\\u0963' | '\\u0981' .. '\\u0983' | '\\u09BC' | '\\u09BE' | '\\u09BF' | '\\u09C0' .. '\\u09C4' | '\\u09C7' .. '\\u09C8' | '\\u09CB' .. '\\u09CD' | '\\u09D7' | '\\u09E2' .. '\\u09E3' | '\\u0A02' | '\\u0A3C' | '\\u0A3E' | '\\u0A3F' | '\\u0A40' .. '\\u0A42' | '\\u0A47' .. '\\u0A48' | '\\u0A4B' .. '\\u0A4D' | '\\u0A70' .. '\\u0A71' | '\\u0A81' .. '\\u0A83' | '\\u0ABC' | '\\u0ABE' .. '\\u0AC5' | '\\u0AC7' .. '\\u0AC9' | '\\u0ACB' .. '\\u0ACD' | '\\u0B01' .. '\\u0B03' | '\\u0B3C' | '\\u0B3E' .. '\\u0B43' | '\\u0B47' .. '\\u0B48' | '\\u0B4B' .. '\\u0B4D' | '\\u0B56' .. '\\u0B57' | '\\u0B82' .. '\\u0B83' | '\\u0BBE' .. '\\u0BC2' | '\\u0BC6' .. '\\u0BC8' | '\\u0BCA' .. '\\u0BCD' | '\\u0BD7' | '\\u0C01' .. '\\u0C03' | '\\u0C3E' .. '\\u0C44' | '\\u0C46' .. '\\u0C48' | '\\u0C4A' .. '\\u0C4D' | '\\u0C55' .. '\\u0C56' | '\\u0C82' .. '\\u0C83' | '\\u0CBE' .. '\\u0CC4' | '\\u0CC6' .. '\\u0CC8' | '\\u0CCA' .. '\\u0CCD' | '\\u0CD5' .. '\\u0CD6' | '\\u0D02' .. '\\u0D03' | '\\u0D3E' .. '\\u0D43' | '\\u0D46' .. '\\u0D48' | '\\u0D4A' .. '\\u0D4D' | '\\u0D57' | '\\u0E31' | '\\u0E34' .. '\\u0E3A' | '\\u0E47' .. '\\u0E4E' | '\\u0EB1' | '\\u0EB4' .. '\\u0EB9' | '\\u0EBB' .. '\\u0EBC' | '\\u0EC8' .. '\\u0ECD' | '\\u0F18' .. '\\u0F19' | '\\u0F35' | '\\u0F37' | '\\u0F39' | '\\u0F3E' | '\\u0F3F' | '\\u0F71' .. '\\u0F84' | '\\u0F86' .. '\\u0F8B' | '\\u0F90' .. '\\u0F95' | '\\u0F97' | '\\u0F99' .. '\\u0FAD' | '\\u0FB1' .. '\\u0FB7' | '\\u0FB9' | '\\u20D0' .. '\\u20DC' | '\\u20E1' | '\\u302A' .. '\\u302F' | '\\u3099' | '\\u309A' )
            // etc/XQFT.g:
            {
    ...
    public final void mExtender() throws RecognitionException {
        try {
            // etc/XQFT.g:1519:42: ( '\\u00B7' | '\\u02D0' | '\\u02D1' | '\\u0387' | '\\u0640' | '\\u0E46' | '\\u0EC6' | '\\u3005' | '\\u3031' .. '\\u3035' | '\\u309D' .. '\\u309E' | '\\u30FC' .. '\\u30FE' )
            // etc/XQFT.g:
            {
    ...
    public final void synpred1_fragment() throws RecognitionException {   
        // etc/XQFT.g:1089:9: ( QName )
        // etc/XQFT.g:1089:10: QName
        {
        mQName(); if (failed) return ;
    ...
    public final void synpred2_fragment() throws RecognitionException {   
        // etc/XQFT.g:1118:22: ( DoubleLiteral )
        // etc/XQFT.g:1118:23: DoubleLiteral
        {
        mDoubleLiteral(); if (failed) return ;
    ...
    public final void synpred3_fragment() throws RecognitionException {   
        // etc/XQFT.g:1119:7: ( DecimalLiteral )
        // etc/XQFT.g:1119:8: DecimalLiteral
        {
        mDecimalLiteral(); if (failed) return ;
    ...
    public final void synpred4_fragment() throws RecognitionException {   
        // etc/XQFT.g:1120:7: ( IntegerLiteral )
        // etc/XQFT.g:1120:8: IntegerLiteral
        {
        mIntegerLiteral(); if (failed) return ;
    ...
    public final void synpred5_fragment() throws RecognitionException {   
        // etc/XQFT.g:1140:5: ( QName )
        // etc/XQFT.g:1140:6: QName
        {
        mQName(); if (failed) return ;
    ...
    class DFA1 extends DFA {
        ...
        public String getDescription() {
            return "934:15: ({...}? =>n= CDataSectionLEX | {...}? =>n= DirPIConstructor | {...}? =>n= DirCommentConstLEX | {...}? =>n= LENDTAGSi | {...}? =>n= ElementContent | {...}? =>n= PragmaLEX | {...}? =>n= Comment | {...}? =>n= NumberLEX | {...}? =>n= LexSigns | {...}? =>n= S | {...}? =>n= StringLiteral | {...}? =>n= LexLiterals | {...}? =>n= QuotAttributeContent | {...}? =>n= AposAttributeContent | {...}? =>n= RSELFTERMSi | n= QUOTSi | n= DOLLARSi | n= APOSSi | n= LPARSi | n= RPARSi | n= STARSi | n= PLUSSi | n= COMMASi | n= MINUSSi | n= DOTSi | n= SLASHSi | n= COLONSi | n= SEMICOLONSi | n= LTSi | n= EQSi | n= GTSi | n= QUESTIONSi | n= ATSi | n= LBRACKSi | n= RBRACKSi | n= LBRACESi | n= PIPESi | n= RBRACSi )";
        }
        public int specialStateTransition(int s, IntStream input) throws NoViableAltException {
            ...
            switch ( s ) {
                    ...
                    case 23 : 
                        ...
                        else if ( (LA1_14=='\"') && (((state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='"' && input.LA(2)=='"'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='"' && input.LA(2)=='"'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='"' && input.LA(2)=='"'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='"' && input.LA(2)=='"'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='"' && input.LA(2)=='"'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='"' && input.LA(2)=='"'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='"' && input.LA(2)=='"'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='"' && input.LA(2)=='"'))||state==State.DEFAULT||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='"' && input.LA(2)=='"'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='"' && input.LA(2)=='"'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='"' && input.LA(2)=='"'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='"' && input.LA(2)=='"'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='"' && input.LA(2)=='"'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='"' && input.LA(2)=='"'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='"' && input.LA(2)=='"'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='"' && input.LA(2)=='"'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='"' && input.LA(2)=='"'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='"' && input.LA(2)=='"'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='"' && input.LA(2)=='"'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='"' && input.LA(2)=='"'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='"' && input.LA(2)=='"'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='"' && input.LA(2)=='"'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='"' && input.LA(2)=='"'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='"' && input.LA(2)=='"'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='"' && input.LA(2)=='"'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='"' && input.LA(2)=='"'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='"' && input.LA(2)=='"'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='"' && input.LA(2)=='"'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='"' && input.LA(2)=='"'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='"' && input.LA(2)=='"'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='"' && input.LA(2)=='"'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='"' && input.LA(2)=='"'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='"' && input.LA(2)=='"'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='"' && input.LA(2)=='"'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='"' && input.LA(2)=='"'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='"' && input.LA(2)=='"'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='"' && input.LA(2)=='"'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='"' && input.LA(2)=='"'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='"' && input.LA(2)=='"'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='"' && input.LA(2)=='"'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='"' && input.LA(2)=='"'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='"' && input.LA(2)=='"'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='"' && input.LA(2)=='"'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='"' && input.LA(2)=='"'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='"' && input.LA(2)=='"'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='"' && input.LA(2)=='"'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='"' && input.LA(2)=='"'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='"' && input.LA(2)=='"'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='"' && input.LA(2)=='"'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='"' && input.LA(2)=='"'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='"' && input.LA(2)=='"'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='"' && input.LA(2)=='"'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='"' && input.LA(2)=='"'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='"' && input.LA(2)=='"'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='"' && input.LA(2)=='"'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='"' && input.LA(2)=='"'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='"' && input.LA(2)=='"'))))) {s = 65;}
                    ...
                    case 24 : 
                        ...
                        input.rewind();
                        s = -1;
                        if ( (LA1_3=='{') && (((state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))))) {s = 42;}
    ...
    class DFA22 extends DFA {
        ...
        public String getDescription() {
            return "1087:5: ( ( QName )=> QName | NCName )";
        }
        public int specialStateTransition(int s, IntStream input) throws NoViableAltException {
        	int _s = s;
            switch ( s ) {
    ...
    class DFA26 extends DFA {
        ...
        public String getDescription() {
            return "1118:10: fragment NumberLEX : ( ( DoubleLiteral )=> DoubleLiteral | ( DecimalLiteral )=> DecimalLiteral | ( IntegerLiteral )=> IntegerLiteral );";
        }
        public int specialStateTransition(int s, IntStream input) throws NoViableAltException {
        	int _s = s;
            switch ( s ) {
    ...
    class DFA34 extends DFA {
        ...
        public String getDescription() {
            return "1139:10: fragment LexLiterals : ( ( QName )=> QName | n= NCName );";
        }
        public int specialStateTransition(int s, IntStream input) throws NoViableAltException {
        	int _s = s;
            switch ( s ) {

// $ANTLR 3.0.1 etc/XQFT.g 2007-12-08 15:51:44
...
public class XQFTLexer extends Lexer {
    ...
    public static final int UNDERSCORESi=236;
    public static final int ELSE=37;
    public static final int RCDATASi=207;
    ...
    public static final int MINUSSi=175;
    ...
    public static final int LPRAGSi=187;
    public static final int INSENSITIVE=66;
    public static final int APOSSi=202;
    public static final int AST_TYPESWITCHEXPR=151;
    public static final int LBRACKSi=195;
    public static final int RSELFTERMSi=198;
    public static final int GT=60;
    public static final int END=39;
    public static final int DoubleLiteral=186;
    public static final int QUOTSi=200;
    public static final int DirCommentContent=209;
    public static final int LexLiterals=223;
    public static final int OPTION=90;
    public static final int CharRef=226;
    public static final int Extender=240;
    ...
    public static final int RXQCOMMENTSi=243;
    public static final int IDIV=61;
    public static final int ASCENDING=10;
    public static final int ExtraChar=249;
    ...
    public static final int ATSi=194;
    public static final int DOCUMENT=34;
    public static final int DBLSLASHSi=190;
    public static final int COLLATION=20;
    public static final int LCOMMENTSi=208;
    public static final int ANCESTOR=6;
    public static final int AMPERSi=228;
    public static final int CleanChar=252;
    public static final int CASTABLE=18;
    public static final int ElementContent=204;
    public static final int MOST=81;
    public static final int EQSi=163;
    public static final int BY=14;
    public static final int NODEBEFORESi=182;
    public static final int DOTSi=197;
    public static final int NCNameChar=246;
    ...
    public static final int LTOREQSi=179;
    public static final int NotChar=227;
    public static final int DirPIConstructor=216;
    public static final int TEXT=122;
    public static final int MODULE=80;
    public static final int FTNOT=54;
    public static final int Tokens=254;
    ...
    public static final int StringLiteral=160;
    public static final int SCHEMA=107;
    public static final int COLONSi=167;
    public static final int PiTarget=212;
    ...
    public static final int IntegerLiteral=184;
    public static final int DIV=33;
    public static final int CombiningChar=239;
    public static final int DESCENDING=29;
    public static final int SELF=111;
    public static final int RPRAGSi=189;
    public static final int NEQSi=177;
    ...
    public static final int RBRACKSi=196;
    public static final int QUESTIONSi=172;
    public static final int BACKSLASHSi=248;
    public static final int AST_LETCLAUSE=146;
    public static final int CASE=16;
    public static final int ENCODING=38;
    public static final int RCOMMENTSi=210;
    public static final int DIFFERENT=31;
    public static final int PLUSSi=174;
    public static final int PragmaLEX=218;
    public static final int DOCUMENT_NODE=35;
    public static final int SCHEMAATTRIBUTE=108;
    public static final int LXQCOMMENTSi=242;
    public static final int SEMICOLONSi=161;
    public static final int WORD=141;
    public static final int SHARPSi=241;
    public static final int UPPERCASE=131;
    public static final int Comment=219;
    public static final int Char=253;
    public static final int Digits=244;
    public static final int QuotAttrContentChar=229;
    public static final int AST_FLWOR=144;
    public static final int FTOPTION=55;
    public static final int AposAttributeContent=203;
    public static final int COMMENT=21;
    public static final int NE=83;
    public static final int CDataSectionLEX=215;
    public static final int BOUNDARYSPACE=15;
    public static final int NODE=84;
    public static final int AST_FTPOSFILTER=155;
    public static final int CDataContents=206;
    public static final int AST_QUANTIFIEDEXPR=150;
    public static final int AposAttrContentChar=230;
    ...
    public static final int AST_DIRELEMCONSTRUCTOR=158;
    public static final int OF=89;
    public static final int LTSi=178;
    public static final int NODEAFTERSi=183;
    public static final int RELATIONSHIP=103;
    public static final int NAMESPACE=82;
    public static final int LCDATASi=205;
    public static final int LBRACESi=170;
    ...
    public static final int DirPiContents=213;
    public static final int OR=91;
    public static final int LPARSi=168;
    public static final int STARSi=173;
    public static final int QuotAttributeContent=201;
    public static final int FROM=51;
    public static final int RPISi=214;
    public static final int PRECEDING_SIBLING=100;
    public static final int Letter=235;
    public static final int NCName=162;
    ...
    public static final int EXCLSi=247;
    ...
    public static final int PIPESi=176;
    public static final int WITH=139;
    public static final int NCNameStartChar=245;
    public static final int LENDTAGSi=199;
    public static final int GTSi=180;
    public static final int RBRACSi=171;
    ...
    public static final int NameChar=237;
    public static final int COMMASi=164;
    public static final int SLASHSi=191;
    public static final int Digit=238;
    public static final int DecimalLiteral=185;
    public static final int GTOREQSi=181;
    public static final int AST_DIRELEMCONTENT=159;
    public static final int UNORDERED=130;
    public static final int PHRASE=98;
    public static final int TOKENSWITCH=224;
    public static final int ElementContentChar=231;
    public static final int ANY=5;
    public static final int AST_RETURNCLAUSE=149;
    public static final int SCORE=110;
    public static final int LexSigns=221;
    public static final int ORDERING=94;
    public static final int PredefinedEntityRef=225;
    ...
    public static final int DirCommentConstLEX=217;
    ...
    public final void mTOKENSWITCH() throws RecognitionException {
        try {
            ...
            // etc/XQFT.g:989:16: ( ({...}? =>n= CDataSectionLEX | {...}? =>n= DirPIConstructor | {...}? =>n= DirCommentConstLEX | {...}? =>n= LENDTAGSi | {...}? =>n= ElementContent | {...}? =>n= PragmaLEX | {...}? =>n= Comment | {...}? =>n= NumberLEX | {...}? =>n= LexSigns | {...}? =>n= S | {...}? =>n= StringLiteral | {...}? =>n= LexLiterals | {...}? =>n= QuotAttributeContent | {...}? =>n= AposAttributeContent | {...}? =>n= RSELFTERMSi | n= QUOTSi | n= DOLLARSi | n= APOSSi | n= LPARSi | n= RPARSi | n= STARSi | n= PLUSSi | n= COMMASi | n= MINUSSi | n= DOTSi | n= SLASHSi | n= COLONSi | n= SEMICOLONSi | n= LTSi | n= EQSi | n= GTSi | n= QUESTIONSi | n= ATSi | n= LBRACKSi | n= RBRACKSi | n= LBRACESi | n= PIPESi | n= RBRACSi ) )
            // etc/XQFT.g:989:18: ({...}? =>n= CDataSectionLEX | {...}? =>n= DirPIConstructor | {...}? =>n= DirCommentConstLEX | {...}? =>n= LENDTAGSi | {...}? =>n= ElementContent | {...}? =>n= PragmaLEX | {...}? =>n= Comment | {...}? =>n= NumberLEX | {...}? =>n= LexSigns | {...}? =>n= S | {...}? =>n= StringLiteral | {...}? =>n= LexLiterals | {...}? =>n= QuotAttributeContent | {...}? =>n= AposAttributeContent | {...}? =>n= RSELFTERMSi | n= QUOTSi | n= DOLLARSi | n= APOSSi | n= LPARSi | n= RPARSi | n= STARSi | n= PLUSSi | n= COMMASi | n= MINUSSi | n= DOTSi | n= SLASHSi | n= COLONSi | n= SEMICOLONSi | n= LTSi | n= EQSi | n= GTSi | n= QUESTIONSi | n= ATSi | n= LBRACKSi | n= RBRACKSi | n= LBRACESi | n= PIPESi | n= RBRACSi )
            {
            if ( backtracking==0 ) {
              System.out.println("State is: " + state);
            }
            // etc/XQFT.g:989:61: ({...}? =>n= CDataSectionLEX | {...}? =>n= DirPIConstructor | {...}? =>n= DirCommentConstLEX | {...}? =>n= LENDTAGSi | {...}? =>n= ElementContent | {...}? =>n= PragmaLEX | {...}? =>n= Comment | {...}? =>n= NumberLEX | {...}? =>n= LexSigns | {...}? =>n= S | {...}? =>n= StringLiteral | {...}? =>n= LexLiterals | {...}? =>n= QuotAttributeContent | {...}? =>n= AposAttributeContent | {...}? =>n= RSELFTERMSi | n= QUOTSi | n= DOLLARSi | n= APOSSi | n= LPARSi | n= RPARSi | n= STARSi | n= PLUSSi | n= COMMASi | n= MINUSSi | n= DOTSi | n= SLASHSi | n= COLONSi | n= SEMICOLONSi | n= LTSi | n= EQSi | n= GTSi | n= QUESTIONSi | n= ATSi | n= LBRACKSi | n= RBRACKSi | n= LBRACESi | n= PIPESi | n= RBRACSi )
            int alt1=38;
            alt1 = dfa1.predict(input);
            switch (alt1) {
                case 1 :
                    // etc/XQFT.g:990:9: {...}? =>n= CDataSectionLEX
                    {
                    ...
                    break;
                case 2 :
                    // etc/XQFT.g:992:9: {...}? =>n= DirPIConstructor
                    {
                    if ( !(state!=State.IN_TAG && state!=State.IN_QUOT_ATTRIBUTE && state!=State.IN_APOS_ATTRIBUTE) ) {
                        if (backtracking>0) {failed=true; return ;}
                        throw new FailedPredicateException(input, "TOKENSWITCH", "state!=State.IN_TAG && state!=State.IN_QUOT_ATTRIBUTE && state!=State.IN_APOS_ATTRIBUTE");
                    ...
                    break;
                case 3 :
                    // etc/XQFT.g:994:9: {...}? =>n= DirCommentConstLEX
                    {
                    if ( !(state!=State.IN_TAG && state!=State.IN_QUOT_ATTRIBUTE && state!=State.IN_APOS_ATTRIBUTE) ) {
                        if (backtracking>0) {failed=true; return ;}
                        throw new FailedPredicateException(input, "TOKENSWITCH", "state!=State.IN_TAG && state!=State.IN_QUOT_ATTRIBUTE && state!=State.IN_APOS_ATTRIBUTE");
                ...
                case 4 :
                    ...
                    break;
                case 5 :
                    // etc/XQFT.g:998:13: {...}? =>n= ElementContent
                    {
                    if ( !(state==State.IN_ELEMENT) ) {
                        if (backtracking>0) {failed=true; return ;}
                        throw new FailedPredicateException(input, "TOKENSWITCH", "state==State.IN_ELEMENT");
                ...
                case 10 :
                    ...
                    break;
                case 11 :
                    // etc/XQFT.g:1010:9: {...}? =>n= StringLiteral
                    {
                    if ( !(state==State.DEFAULT) ) {
                        if (backtracking>0) {failed=true; return ;}
                        throw new FailedPredicateException(input, "TOKENSWITCH", "state==State.DEFAULT");
                    ...
                    break;
                case 12 :
                    // etc/XQFT.g:1012:9: {...}? =>n= LexLiterals
                    {
                    if ( !((state==State.DEFAULT || state==State.IN_TAG)) ) {
                        if (backtracking>0) {failed=true; return ;}
                        throw new FailedPredicateException(input, "TOKENSWITCH", "(state==State.DEFAULT || state==State.IN_TAG)");
                    ...
                    break;
                case 13 :
                    // etc/XQFT.g:1014:9: {...}? =>n= QuotAttributeContent
                    {
                    ...
                    break;
                case 14 :
                    // etc/XQFT.g:1016:9: {...}? =>n= AposAttributeContent
                    {
                    ...
                    break;
                case 15 :
                    // etc/XQFT.g:1018:9: {...}? =>n= RSELFTERMSi
                    {
                ...
                case 27 :
                    ...
                    break;
                case 28 :
                    // etc/XQFT.g:1032:9: n= SEMICOLONSi
                    {
                ...
                case 31 :
                    ...
                    break;
                case 32 :
                    // etc/XQFT.g:1036:9: n= QUESTIONSi
                    {
    ...
    public final void mStringLiteral() throws RecognitionException {
        try {
            // etc/XQFT.g:1053:30: ( QUOTSi ( PredefinedEntityRef | CharRef | {...}? => QUOTSi QUOTSi | ~ ( NotChar | QUOTSi | AMPERSi ) )* QUOTSi | APOSSi ( PredefinedEntityRef | CharRef | {...}? => APOSSi APOSSi | ~ ( NotChar | APOSSi | AMPERSi ) )* APOSSi )
            int alt5=2;
            ...
            if ( (LA5_0=='\"') ) {
                ...
                NoViableAltException nvae =
                    new NoViableAltException("1053:10: fragment StringLiteral : ( QUOTSi ( PredefinedEntityRef | CharRef | {...}? => QUOTSi QUOTSi | ~ ( NotChar | QUOTSi | AMPERSi ) )* QUOTSi | APOSSi ( PredefinedEntityRef | CharRef | {...}? => APOSSi APOSSi | ~ ( NotChar | APOSSi | AMPERSi ) )* APOSSi );", 5, 0, input);

                throw nvae;
            }
            switch (alt5) {
                case 1 :
                    // etc/XQFT.g:1053:32: QUOTSi ( PredefinedEntityRef | CharRef | {...}? => QUOTSi QUOTSi | ~ ( NotChar | QUOTSi | AMPERSi ) )* QUOTSi
                    {
                    mQUOTSi(); if (failed) return ;
                    // etc/XQFT.g:1054:11: ( PredefinedEntityRef | CharRef | {...}? => QUOTSi QUOTSi | ~ ( NotChar | QUOTSi | AMPERSi ) )*
                    loop3:
                    do {
                        int alt3=5;
                        ...
                        switch (alt3) {
                    	case 1 :
                    	    // etc/XQFT.g:1054:12: PredefinedEntityRef
                    	    {
                    	...
                    	case 2 :
                    	    ...
                    	    break;
                    	case 3 :
                    	    // etc/XQFT.g:1054:44: {...}? => QUOTSi QUOTSi
                    	    {
                    	    ...
                    	    break;
                    	case 4 :
                    	    // etc/XQFT.g:1054:104: ~ ( NotChar | QUOTSi | AMPERSi )
                    	    {
                    ...
                    break;
                case 2 :
                    // etc/XQFT.g:1056:12: APOSSi ( PredefinedEntityRef | CharRef | {...}? => APOSSi APOSSi | ~ ( NotChar | APOSSi | AMPERSi ) )* APOSSi
                    {
                    mAPOSSi(); if (failed) return ;
                    // etc/XQFT.g:1057:11: ( PredefinedEntityRef | CharRef | {...}? => APOSSi APOSSi | ~ ( NotChar | APOSSi | AMPERSi ) )*
                    loop4:
                    do {
                        int alt4=5;
                        ...
                        switch (alt4) {
                    	case 1 :
                    	    // etc/XQFT.g:1057:12: PredefinedEntityRef
                    	    {
                    	    mPredefinedEntityRef(); if (failed) return ;
                    	...
                    	case 2 :
                    	    ...
                    	    break;
                    	case 3 :
                    	    // etc/XQFT.g:1057:44: {...}? => APOSSi APOSSi
                    	    {
                    	    if ( !((input.LA(1)=='\'' && input.LA(2)=='\'')) ) {
                    	        if (backtracking>0) {failed=true; return ;}
                    	        throw new FailedPredicateException(input, "StringLiteral", "(input.LA(1)=='\\'' && input.LA(2)=='\\'')");
                    	    ...
                    	    break;
                    	case 4 :
                    	    // etc/XQFT.g:1057:106: ~ ( NotChar | APOSSi | AMPERSi )
                    	    {
    ...
    public final void mQuotAttributeContent() throws RecognitionException {
        try {
            // etc/XQFT.g:1061:32: ( ( PredefinedEntityRef | CharRef | QuotAttrContentChar )* )
            // etc/XQFT.g:1061:34: ( PredefinedEntityRef | CharRef | QuotAttrContentChar )*
            {
            // etc/XQFT.g:1061:34: ( PredefinedEntityRef | CharRef | QuotAttrContentChar )*
            loop6:
            do {
            	...
            	case 2 :
            	    ...
            	    break;
            	case 3 :
            	    // etc/XQFT.g:1061:67: QuotAttrContentChar
            	    {
    ...
    public final void mAposAttributeContent() throws RecognitionException {
        try {
            // etc/XQFT.g:1062:32: ( ( PredefinedEntityRef | CharRef | AposAttrContentChar )* )
            // etc/XQFT.g:1062:34: ( PredefinedEntityRef | CharRef | AposAttrContentChar )*
            {
            // etc/XQFT.g:1062:34: ( PredefinedEntityRef | CharRef | AposAttrContentChar )*
            loop7:
            do {
                ...
                switch (alt7) {
            	case 1 :
            	    // etc/XQFT.g:1062:35: PredefinedEntityRef
            	    {
            	    mPredefinedEntityRef(); if (failed) return ;
            	...
            	case 2 :
            	    ...
            	    break;
            	case 3 :
            	    // etc/XQFT.g:1062:67: AposAttrContentChar
            	    {
    ...
    public final void mElementContent() throws RecognitionException {
        try {
            // etc/XQFT.g:1063:28: ( ( PredefinedEntityRef | CharRef | ElementContentChar )* )
            // etc/XQFT.g:1063:30: ( PredefinedEntityRef | CharRef | ElementContentChar )*
            {
            // etc/XQFT.g:1063:30: ( PredefinedEntityRef | CharRef | ElementContentChar )*
            loop8:
            do {
                ...
                switch (alt8) {
            	case 1 :
            	    // etc/XQFT.g:1063:31: PredefinedEntityRef
            	    {
            	    mPredefinedEntityRef(); if (failed) return ;
            	...
            	case 2 :
            	    ...
            	    break;
            	case 3 :
            	    // etc/XQFT.g:1063:63: ElementContentChar
            	    {
    ...
    public final void mPredefinedEntityRef() throws RecognitionException {
        try {
            // etc/XQFT.g:1065:30: ( AMPERSi ( 'lt' | 'gt' | 'amp' | 'quot' | 'apos' ) SEMICOLONSi )
            // etc/XQFT.g:1065:32: AMPERSi ( 'lt' | 'gt' | 'amp' | 'quot' | 'apos' ) SEMICOLONSi
            {
            mAMPERSi(); if (failed) return ;
            // etc/XQFT.g:1065:40: ( 'lt' | 'gt' | 'amp' | 'quot' | 'apos' )
            int alt9=5;
            switch ( input.LA(1) ) {
            case 'l':
                {
            ...
            case 'a':
                ...
                if ( (LA9_3=='p') ) {
                    ...
                    if (backtracking>0) {failed=true; return ;}
                    NoViableAltException nvae =
                        new NoViableAltException("1065:40: ( 'lt' | 'gt' | 'amp' | 'quot' | 'apos' )", 9, 3, input);
            ...
            default:
                if (backtracking>0) {failed=true; return ;}
                NoViableAltException nvae =
                    new NoViableAltException("1065:40: ( 'lt' | 'gt' | 'amp' | 'quot' | 'apos' )", 9, 0, input);
    ...
    public final void mCharRef() throws RecognitionException {
        try {
            // etc/XQFT.g:1067:31: ( CREFDECSi ( '0' .. '9' )+ SEMICOLONSi | CREFHEXSi ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' )+ SEMICOLONSi )
            int alt12=2;
            ...
            if ( (LA12_0=='&') ) {
                ...
                if ( (LA12_1=='#') ) {
                    ...
                    if ( (LA12_2=='x') ) {
                        ...
                        if (backtracking>0) {failed=true; return ;}
                        NoViableAltException nvae =
                            new NoViableAltException("1067:10: fragment CharRef : ( CREFDECSi ( '0' .. '9' )+ SEMICOLONSi | CREFHEXSi ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' )+ SEMICOLONSi );", 12, 2, input);
                    ...
                    if (backtracking>0) {failed=true; return ;}
                    NoViableAltException nvae =
                        new NoViableAltException("1067:10: fragment CharRef : ( CREFDECSi ( '0' .. '9' )+ SEMICOLONSi | CREFHEXSi ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' )+ SEMICOLONSi );", 12, 1, input);
                ...
                if (backtracking>0) {failed=true; return ;}
                NoViableAltException nvae =
                    new NoViableAltException("1067:10: fragment CharRef : ( CREFDECSi ( '0' .. '9' )+ SEMICOLONSi | CREFHEXSi ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' )+ SEMICOLONSi );", 12, 0, input);

                throw nvae;
            }
            switch (alt12) {
                case 1 :
                    // etc/XQFT.g:1067:33: CREFDECSi ( '0' .. '9' )+ SEMICOLONSi
                    {
                    mCREFDECSi(); if (failed) return ;
                    // etc/XQFT.g:1067:43: ( '0' .. '9' )+
                    int cnt10=0;
                    loop10:
                    do {
                        int alt10=2;
                    ...
                    break;
                case 2 :
                    // etc/XQFT.g:1068:12: CREFHEXSi ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' )+ SEMICOLONSi
                    {
                    mCREFHEXSi(); if (failed) return ;
                    // etc/XQFT.g:1068:22: ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' )+
                    int cnt11=0;
                    loop11:
                    do {
                        int alt11=2;
    ...
    public final void mCREFHEXSi() throws RecognitionException {
        try {
            // etc/XQFT.g:1070:23: ( '&#x' )
            // etc/XQFT.g:1070:25: '&#x'
            {
    ...
    public final void mElementContentChar() throws RecognitionException {
        try {
            // etc/XQFT.g:1082:30: ( ({...}? => LBRACESi LBRACESi | {...}? => RBRACSi RBRACSi | ~ ( NotChar | LBRACESi | RBRACSi | LTSi | AMPERSi ) ) )
            // etc/XQFT.g:1082:32: ({...}? => LBRACESi LBRACESi | {...}? => RBRACSi RBRACSi | ~ ( NotChar | LBRACESi | RBRACSi | LTSi | AMPERSi ) )
            {
            // etc/XQFT.g:1082:32: ({...}? => LBRACESi LBRACESi | {...}? => RBRACSi RBRACSi | ~ ( NotChar | LBRACESi | RBRACSi | LTSi | AMPERSi ) )
            int alt13=3;
            ...
            if ( (LA13_0=='{') && ((input.LA(1)=='{' && input.LA(2)=='{'))) {
                ...
                if (backtracking>0) {failed=true; return ;}
                NoViableAltException nvae =
                    new NoViableAltException("1082:32: ({...}? => LBRACESi LBRACESi | {...}? => RBRACSi RBRACSi | ~ ( NotChar | LBRACESi | RBRACSi | LTSi | AMPERSi ) )", 13, 0, input);

                throw nvae;
            }
            switch (alt13) {
                case 1 :
                    // etc/XQFT.g:1082:33: {...}? => LBRACESi LBRACESi
                    {
                    if ( !((input.LA(1)=='{' && input.LA(2)=='{')) ) {
                        if (backtracking>0) {failed=true; return ;}
                    ...
                    break;
                case 2 :
                    // etc/XQFT.g:1083:13: {...}? => RBRACSi RBRACSi
                    {
                    if ( !((input.LA(1)=='}' && input.LA(2)=='}')) ) {
                        if (backtracking>0) {failed=true; return ;}
                        throw new FailedPredicateException(input, "ElementContentChar", "(input.LA(1)=='}' && input.LA(2)=='}')");
                    ...
                    break;
                case 3 :
                    // etc/XQFT.g:1084:12: ~ ( NotChar | LBRACESi | RBRACSi | LTSi | AMPERSi )
                    {
    ...
    public final void mQuotAttrContentChar() throws RecognitionException {
        try {
            // etc/XQFT.g:1085:30: ( ({...}? => QUOTSi QUOTSi | {...}? => LBRACESi LBRACESi | {...}? => RBRACSi RBRACSi | ~ ( NotChar | LBRACESi | RBRACSi | LTSi | AMPERSi | QUOTSi ) ) )
            // etc/XQFT.g:1085:32: ({...}? => QUOTSi QUOTSi | {...}? => LBRACESi LBRACESi | {...}? => RBRACSi RBRACSi | ~ ( NotChar | LBRACESi | RBRACSi | LTSi | AMPERSi | QUOTSi ) )
            {
            // etc/XQFT.g:1085:32: ({...}? => QUOTSi QUOTSi | {...}? => LBRACESi LBRACESi | {...}? => RBRACSi RBRACSi | ~ ( NotChar | LBRACESi | RBRACSi | LTSi | AMPERSi | QUOTSi ) )
            int alt14=4;
            ...
            if ( (LA14_0=='\"') && ((input.LA(1)=='"' && input.LA(2)=='"'))) {
                ...
                if (backtracking>0) {failed=true; return ;}
                NoViableAltException nvae =
                    new NoViableAltException("1085:32: ({...}? => QUOTSi QUOTSi | {...}? => LBRACESi LBRACESi | {...}? => RBRACSi RBRACSi | ~ ( NotChar | LBRACESi | RBRACSi | LTSi | AMPERSi | QUOTSi ) )", 14, 0, input);

                throw nvae;
            }
            switch (alt14) {
                case 1 :
                    // etc/XQFT.g:1085:33: {...}? => QUOTSi QUOTSi
                    {
                    if ( !((input.LA(1)=='"' && input.LA(2)=='"')) ) {
                        if (backtracking>0) {failed=true; return ;}
                    ...
                    break;
                case 2 :
                    // etc/XQFT.g:1086:12: {...}? => LBRACESi LBRACESi
                    {
                    if ( !((input.LA(1)=='{' && input.LA(2)=='{')) ) {
                        if (backtracking>0) {failed=true; return ;}
                        throw new FailedPredicateException(input, "QuotAttrContentChar", "(input.LA(1)=='{' && input.LA(2)=='{')");
                    ...
                    break;
                case 3 :
                    // etc/XQFT.g:1087:12: {...}? => RBRACSi RBRACSi
                    {
                    if ( !((input.LA(1)=='}' && input.LA(2)=='}')) ) {
                        if (backtracking>0) {failed=true; return ;}
                        throw new FailedPredicateException(input, "QuotAttrContentChar", "(input.LA(1)=='}' && input.LA(2)=='}')");
                    ...
                    break;
                case 4 :
                    // etc/XQFT.g:1088:12: ~ ( NotChar | LBRACESi | RBRACSi | LTSi | AMPERSi | QUOTSi )
                    {
    ...
    public final void mAposAttrContentChar() throws RecognitionException {
        try {
            // etc/XQFT.g:1089:30: ( ({...}? => APOSSi APOSSi | {...}? => LBRACESi LBRACESi | {...}? => RBRACSi RBRACSi | ~ ( NotChar | LBRACESi | RBRACSi | LTSi | AMPERSi | APOSSi ) ) )
            // etc/XQFT.g:1089:32: ({...}? => APOSSi APOSSi | {...}? => LBRACESi LBRACESi | {...}? => RBRACSi RBRACSi | ~ ( NotChar | LBRACESi | RBRACSi | LTSi | AMPERSi | APOSSi ) )
            {
            // etc/XQFT.g:1089:32: ({...}? => APOSSi APOSSi | {...}? => LBRACESi LBRACESi | {...}? => RBRACSi RBRACSi | ~ ( NotChar | LBRACESi | RBRACSi | LTSi | AMPERSi | APOSSi ) )
            int alt15=4;
            ...
            if ( (LA15_0=='\'') && ((input.LA(1)=='\'' && input.LA(2)=='\''))) {
                ...
                if (backtracking>0) {failed=true; return ;}
                NoViableAltException nvae =
                    new NoViableAltException("1089:32: ({...}? => APOSSi APOSSi | {...}? => LBRACESi LBRACESi | {...}? => RBRACSi RBRACSi | ~ ( NotChar | LBRACESi | RBRACSi | LTSi | AMPERSi | APOSSi ) )", 15, 0, input);

                throw nvae;
            }
            switch (alt15) {
                case 1 :
                    // etc/XQFT.g:1089:33: {...}? => APOSSi APOSSi
                    {
                    if ( !((input.LA(1)=='\'' && input.LA(2)=='\'')) ) {
                        if (backtracking>0) {failed=true; return ;}
                    ...
                    break;
                case 2 :
                    // etc/XQFT.g:1090:12: {...}? => LBRACESi LBRACESi
                    {
                    if ( !((input.LA(1)=='{' && input.LA(2)=='{')) ) {
                        if (backtracking>0) {failed=true; return ;}
                        throw new FailedPredicateException(input, "AposAttrContentChar", "(input.LA(1)=='{' && input.LA(2)=='{')");
                    ...
                    break;
                case 3 :
                    // etc/XQFT.g:1091:12: {...}? => RBRACSi RBRACSi
                    {
                    if ( !((input.LA(1)=='}' && input.LA(2)=='}')) ) {
                        if (backtracking>0) {failed=true; return ;}
                        throw new FailedPredicateException(input, "AposAttrContentChar", "(input.LA(1)=='}' && input.LA(2)=='}')");
                    ...
                    break;
                case 4 :
                    // etc/XQFT.g:1092:12: ~ ( NotChar | LBRACESi | RBRACSi | LTSi | AMPERSi | APOSSi )
                    {
                    if ( input.LA(1)=='\u0000'||(input.LA(1)>='\t' && input.LA(1)<='\n')||input.LA(1)=='\r'||(input.LA(1)>=' ' && input.LA(1)<='%')||(input.LA(1)>='(' && input.LA(1)<=';')||(input.LA(1)>='=' && input.LA(1)<='z')||input.LA(1)=='|'||(input.LA(1)>='~' && input.LA(1)<='\uD7FF')||(input.LA(1)>='\uE000' && input.LA(1)<='\uFFFE') ) {
                        input.consume();
                    failed=false;
    ...
    public final void mCDataSectionLEX() throws RecognitionException {
        try {
            // etc/XQFT.g:1096:28: ( LCDATASi CDataContents RCDATASi )
            // etc/XQFT.g:1096:30: LCDATASi CDataContents RCDATASi
            {
            if ( backtracking==0 ) {
              prepareSubToken();
            }
    ...
    public final void mLCDATASi() throws RecognitionException {
        try {
            // etc/XQFT.g:1099:23: ( '<![CDATA[' )
            // etc/XQFT.g:1099:25: '<![CDATA['
            {
    ...
    public final void mCDataContents() throws RecognitionException {
        try {
            // etc/XQFT.g:1100:27: ( ({...}? => RBRACKSi | ~ ( RBRACKSi | NotChar ) )* )
            // etc/XQFT.g:1100:29: ({...}? => RBRACKSi | ~ ( RBRACKSi | NotChar ) )*
            {
            // etc/XQFT.g:1100:29: ({...}? => RBRACKSi | ~ ( RBRACKSi | NotChar ) )*
            loop16:
            do {
            	...
            	case 1 :
            	    ...
            	    break;
            	case 2 :
            	    // etc/XQFT.g:1100:86: ~ ( RBRACKSi | NotChar )
            	    {
            	    if ( input.LA(1)=='\u0000'||(input.LA(1)>='\t' && input.LA(1)<='\n')||input.LA(1)=='\r'||(input.LA(1)>=' ' && input.LA(1)<='\\')||(input.LA(1)>='^' && input.LA(1)<='\uD7FF')||(input.LA(1)>='\uE000' && input.LA(1)<='\uFFFE') ) {
            	        input.consume();
            	    failed=false;
    ...
    public final void mDirPIConstructor() throws RecognitionException {
        try {
            ...
            // etc/XQFT.g:1104:29: ( LPISi PiTarget ( S d= DirPiContents )? RPISi )
            // etc/XQFT.g:1104:31: LPISi PiTarget ( S d= DirPiContents )? RPISi
            {
            if ( backtracking==0 ) {
              prepareSubToken();
            }
            ...
            // etc/XQFT.g:1106:15: ( S d= DirPiContents )?
            int alt17=2;
            ...
            switch (alt17) {
                case 1 :
                    // etc/XQFT.g:1106:16: S d= DirPiContents
                    {
                    mS(); if (failed) return ;
                    if ( backtracking==0 ) {
                      prepareSubToken();
    ...
    public final void mPiTarget() throws RecognitionException {
        try {
            ...
            // etc/XQFT.g:1110:23: (n= Name {...}?)
            // etc/XQFT.g:1110:25: n= Name {...}?
            {
    ...
    public final void mName() throws RecognitionException {
        try {
            // etc/XQFT.g:1111:25: ( ( Letter | UNDERSCORESi | COLONSi ) ( NameChar )* )
            // etc/XQFT.g:1111:27: ( Letter | UNDERSCORESi | COLONSi ) ( NameChar )*
            {
    ...
    public final void mNameChar() throws RecognitionException {
        try {
            // etc/XQFT.g:1112:23: ( Letter | Digit | DOTSi | MINUSSi | UNDERSCORESi | COLONSi | CombiningChar | Extender )
            // etc/XQFT.g:
            {
    ...
    public final void mDirPiContents() throws RecognitionException {
        try {
            // etc/XQFT.g:1113:27: ( ({...}? => QUESTIONSi | ~ ( NotChar | QUESTIONSi ) )* )
            // etc/XQFT.g:1113:29: ({...}? => QUESTIONSi | ~ ( NotChar | QUESTIONSi ) )*
            {
            // etc/XQFT.g:1113:29: ({...}? => QUESTIONSi | ~ ( NotChar | QUESTIONSi ) )*
            loop19:
            do {
            	...
            	case 1 :
            	    ...
            	    break;
            	case 2 :
            	    // etc/XQFT.g:1113:66: ~ ( NotChar | QUESTIONSi )
            	    {
            	    if ( input.LA(1)=='\u0000'||(input.LA(1)>='\t' && input.LA(1)<='\n')||input.LA(1)=='\r'||(input.LA(1)>=' ' && input.LA(1)<='>')||(input.LA(1)>='@' && input.LA(1)<='\uD7FF')||(input.LA(1)>='\uE000' && input.LA(1)<='\uFFFE') ) {
            	        input.consume();
            	    failed=false;
    ...
    public final void mDirCommentConstLEX() throws RecognitionException {
        try {
            // etc/XQFT.g:1117:31: ( LCOMMENTSi DirCommentContent RCOMMENTSi )
            // etc/XQFT.g:1117:33: LCOMMENTSi DirCommentContent RCOMMENTSi
            {
            if ( backtracking==0 ) {
              prepareSubToken();
            }
    ...
    public final void mDirCommentContent() throws RecognitionException {
        try {
            // etc/XQFT.g:1121:30: ( ({...}? => MINUSSi | ~ ( NotChar | MINUSSi ) )* )
            // etc/XQFT.g:1121:32: ({...}? => MINUSSi | ~ ( NotChar | MINUSSi ) )*
            {
            // etc/XQFT.g:1121:32: ({...}? => MINUSSi | ~ ( NotChar | MINUSSi ) )*
            loop20:
            do {
            	...
            	case 1 :
            	    ...
            	    break;
            	case 2 :
            	    // etc/XQFT.g:1121:67: ~ ( NotChar | MINUSSi )
            	    {
            	    if ( input.LA(1)=='\u0000'||(input.LA(1)>='\t' && input.LA(1)<='\n')||input.LA(1)=='\r'||(input.LA(1)>=' ' && input.LA(1)<=',')||(input.LA(1)>='.' && input.LA(1)<='\uD7FF')||(input.LA(1)>='\uE000' && input.LA(1)<='\uFFFE') ) {
            	        input.consume();
            	    failed=false;
    ...
    public final void mPragmaLEX() throws RecognitionException {
        try {
            ...
            // etc/XQFT.g:1125:22: ( LPRAGSi ( S )? NCName (c= COLONSi n= NCName )? ( S p= PragmaContents )? RPRAGSi )
            // etc/XQFT.g:1125:24: LPRAGSi ( S )? NCName (c= COLONSi n= NCName )? ( S p= PragmaContents )? RPRAGSi
            {
            if ( backtracking==0 ) {
              prepareSubToken();
            }
            ...
            // etc/XQFT.g:1128:10: (c= COLONSi n= NCName )?
            int alt22=2;
            ...
            switch (alt22) {
                case 1 :
                    // etc/XQFT.g:1129:11: c= COLONSi n= NCName
                    {
                    if ( backtracking==0 ) {
                      prepareSubToken();
                    }
            ...
            // etc/XQFT.g:1132:10: ( S p= PragmaContents )?
            int alt23=2;
            ...
            switch (alt23) {
                case 1 :
                    // etc/XQFT.g:1132:11: S p= PragmaContents
                    {
                    mS(); if (failed) return ;
                    if ( backtracking==0 ) {
                      prepareSubToken();
    ...
    public final void mPragmaContents() throws RecognitionException {
        try {
            // etc/XQFT.g:1137:26: ( ({...}? => SHARPSi | ~ ( NotChar | SHARPSi ) )* )
            // etc/XQFT.g:1137:28: ({...}? => SHARPSi | ~ ( NotChar | SHARPSi ) )*
            {
            // etc/XQFT.g:1137:28: ({...}? => SHARPSi | ~ ( NotChar | SHARPSi ) )*
            loop24:
            do {
            	...
            	case 1 :
            	    ...
            	    break;
            	case 2 :
            	    // etc/XQFT.g:1137:63: ~ ( NotChar | SHARPSi )
            	    {
            	    if ( input.LA(1)=='\u0000'||(input.LA(1)>='\t' && input.LA(1)<='\n')||input.LA(1)=='\r'||(input.LA(1)>=' ' && input.LA(1)<='\"')||(input.LA(1)>='$' && input.LA(1)<='\uD7FF')||(input.LA(1)>='\uE000' && input.LA(1)<='\uFFFE') ) {
            	        input.consume();
            	    failed=false;
    ...
    public final void mComment() throws RecognitionException {
        try {
            // etc/XQFT.g:1141:26: ( LXQCOMMENTSi ({...}? Comment | {...}? => COLONSi | {...}? => LPARSi | ~ ( LPARSi | COLONSi | NotChar ) )* RXQCOMMENTSi )
            // etc/XQFT.g:1141:28: LXQCOMMENTSi ({...}? Comment | {...}? => COLONSi | {...}? => LPARSi | ~ ( LPARSi | COLONSi | NotChar ) )* RXQCOMMENTSi
            {
            mLXQCOMMENTSi(); if (failed) return ;
            // etc/XQFT.g:1142:9: ({...}? Comment | {...}? => COLONSi | {...}? => LPARSi | ~ ( LPARSi | COLONSi | NotChar ) )*
            loop25:
            do {
                int alt25=5;
            	...
            	case 3 :
            	    ...
            	    break;
            	case 4 :
            	    // etc/XQFT.g:1145:11: ~ ( LPARSi | COLONSi | NotChar )
            	    {
    ...
    public final void mNumberLEX() throws RecognitionException {
        try {
            // etc/XQFT.g:1153:24: ( ( DoubleLiteral )=> DoubleLiteral | ( DecimalLiteral )=> DecimalLiteral | ( IntegerLiteral )=> IntegerLiteral )
            int alt26=3;
            alt26 = dfa26.predict(input);
            switch (alt26) {
                case 1 :
                    // etc/XQFT.g:1153:26: ( DoubleLiteral )=> DoubleLiteral
                    {
                    ...
                    break;
                case 2 :
                    // etc/XQFT.g:1154:14: ( DecimalLiteral )=> DecimalLiteral
                    {
                    ...
                    break;
                case 3 :
                    // etc/XQFT.g:1155:12: ( IntegerLiteral )=> IntegerLiteral
                    {
    ...
    public final void mIntegerLiteral() throws RecognitionException {
        try {
            // etc/XQFT.g:1158:28: ( Digits )
            // etc/XQFT.g:1158:30: Digits
            {
    ...
    public final void mDecimalLiteral() throws RecognitionException {
        try {
            // etc/XQFT.g:1159:28: ( DOTSi Digits | Digits DOTSi ( '0' .. '9' )* )
            int alt28=2;
            ...
            if ( (LA28_0=='.') ) {
                ...
                if (backtracking>0) {failed=true; return ;}
                NoViableAltException nvae =
                    new NoViableAltException("1159:10: fragment DecimalLiteral : ( DOTSi Digits | Digits DOTSi ( '0' .. '9' )* );", 28, 0, input);

                throw nvae;
            }
            switch (alt28) {
                case 1 :
                    // etc/XQFT.g:1159:30: DOTSi Digits
                    {
                    mDOTSi(); if (failed) return ;
                    mDigits(); if (failed) return ;
                    ...
                    break;
                case 2 :
                    // etc/XQFT.g:1160:12: Digits DOTSi ( '0' .. '9' )*
                    {
                    mDigits(); if (failed) return ;
                    mDOTSi(); if (failed) return ;
                    // etc/XQFT.g:1160:25: ( '0' .. '9' )*
                    loop27:
                    do {
                        int alt27=2;
    ...
    public final void mDoubleLiteral() throws RecognitionException {
        try {
            // etc/XQFT.g:1161:27: ( ( DOTSi Digits | Digits ( DOTSi ( '0' .. '9' )* )? ) ( 'e' | 'E' ) ( PLUSSi | MINUSSi )? Digits )
            // etc/XQFT.g:1161:29: ( DOTSi Digits | Digits ( DOTSi ( '0' .. '9' )* )? ) ( 'e' | 'E' ) ( PLUSSi | MINUSSi )? Digits
            {
            // etc/XQFT.g:1161:29: ( DOTSi Digits | Digits ( DOTSi ( '0' .. '9' )* )? )
            int alt31=2;
            ...
            if ( (LA31_0=='.') ) {
                ...
                if (backtracking>0) {failed=true; return ;}
                NoViableAltException nvae =
                    new NoViableAltException("1161:29: ( DOTSi Digits | Digits ( DOTSi ( '0' .. '9' )* )? )", 31, 0, input);

                throw nvae;
            }
            switch (alt31) {
                case 1 :
                    // etc/XQFT.g:1162:11: DOTSi Digits
                    {
                    mDOTSi(); if (failed) return ;
                    mDigits(); if (failed) return ;
                    ...
                    break;
                case 2 :
                    // etc/XQFT.g:1163:13: Digits ( DOTSi ( '0' .. '9' )* )?
                    {
                    mDigits(); if (failed) return ;
                    // etc/XQFT.g:1163:20: ( DOTSi ( '0' .. '9' )* )?
                    int alt30=2;
                    ...
                    switch (alt30) {
                        case 1 :
                            // etc/XQFT.g:1163:22: DOTSi ( '0' .. '9' )*
                            {
                            mDOTSi(); if (failed) return ;
                            // etc/XQFT.g:1163:28: ( '0' .. '9' )*
                            loop29:
                            do {
                                int alt29=2;
            ...
            // etc/XQFT.g:1165:22: ( PLUSSi | MINUSSi )?
            int alt32=2;
    ...
    public final void mNCName() throws RecognitionException {
        try {
            // etc/XQFT.g:1167:33: ( NCNameStartChar ( NCNameChar )* )
            // etc/XQFT.g:1167:35: NCNameStartChar ( NCNameChar )*
            {
            mNCNameStartChar(); if (failed) return ;
            // etc/XQFT.g:1167:51: ( NCNameChar )*
            loop33:
            do {
                int alt33=2;
    ...
    public final void mNCNameChar() throws RecognitionException {
        try {
            // etc/XQFT.g:1168:29: ( Letter | Digit | DOTSi | MINUSSi | UNDERSCORESi | CombiningChar | Extender )
            // etc/XQFT.g:
            {
    ...
    public final void mNCNameStartChar() throws RecognitionException {
        try {
            // etc/XQFT.g:1169:33: ( Letter | UNDERSCORESi )
            // etc/XQFT.g:
            {
    ...
    public final void mLexLiterals() throws RecognitionException {
        try {
            ...
            // etc/XQFT.g:1173:22: (n= NCName )
            // etc/XQFT.g:1173:24: n= NCName
            {
    ...
    public final void mLexSigns() throws RecognitionException {
        try {
            // etc/XQFT.g:1323:20: ( NODEBEFORESi | LTOREQSi | GTOREQSi | NODEAFTERSi | DBLCOLONSi | ASSIGNSi | DBLSLASHSi | DOTDOTSi | NEQSi )
            int alt34=9;
            switch ( input.LA(1) ) {
            case '<':
                {
                ...
                if ( (LA34_1=='<') ) {
                    ...
                    if (backtracking>0) {failed=true; return ;}
                    NoViableAltException nvae =
                        new NoViableAltException("1323:10: fragment LexSigns : ( NODEBEFORESi | LTOREQSi | GTOREQSi | NODEAFTERSi | DBLCOLONSi | ASSIGNSi | DBLSLASHSi | DOTDOTSi | NEQSi );", 34, 1, input);
            ...
            case '>':
                ...
                if ( (LA34_2=='=') ) {
                    ...
                    if (backtracking>0) {failed=true; return ;}
                    NoViableAltException nvae =
                        new NoViableAltException("1323:10: fragment LexSigns : ( NODEBEFORESi | LTOREQSi | GTOREQSi | NODEAFTERSi | DBLCOLONSi | ASSIGNSi | DBLSLASHSi | DOTDOTSi | NEQSi );", 34, 2, input);
            ...
            case ':':
                ...
                if ( (LA34_3==':') ) {
                    ...
                    if (backtracking>0) {failed=true; return ;}
                    NoViableAltException nvae =
                        new NoViableAltException("1323:10: fragment LexSigns : ( NODEBEFORESi | LTOREQSi | GTOREQSi | NODEAFTERSi | DBLCOLONSi | ASSIGNSi | DBLSLASHSi | DOTDOTSi | NEQSi );", 34, 3, input);
            ...
            default:
                if (backtracking>0) {failed=true; return ;}
                NoViableAltException nvae =
                    new NoViableAltException("1323:10: fragment LexSigns : ( NODEBEFORESi | LTOREQSi | GTOREQSi | NODEAFTERSi | DBLCOLONSi | ASSIGNSi | DBLSLASHSi | DOTDOTSi | NEQSi );", 34, 0, input);
            ...
            switch (alt34) {
                case 1 :
                    // etc/XQFT.g:1323:22: NODEBEFORESi
                    {
    ...
    public final void mUNDERSCORESi() throws RecognitionException {
        try {
            // etc/XQFT.g:1371:26: ( '_' )
            // etc/XQFT.g:1371:28: '_'
            {
    ...
    public final void mALL() throws RecognitionException {
        try {
            // etc/XQFT.g:1378:19: ( 'all' )
            // etc/XQFT.g:1378:21: 'all'
            {
    ...
    public final void mANY() throws RecognitionException {
        try {
            // etc/XQFT.g:1379:19: ( 'any' )
            // etc/XQFT.g:1379:21: 'any'
            {
    ...
    public final void mANCESTOR() throws RecognitionException {
        try {
            // etc/XQFT.g:1380:23: ( 'ancestor' )
            // etc/XQFT.g:1380:25: 'ancestor'
            {
    ...
    public final void mANCESTOR_OR_SELF() throws RecognitionException {
        try {
            // etc/XQFT.g:1381:29: ( 'ancestor-or-self' )
            // etc/XQFT.g:1381:31: 'ancestor-or-self'
            {
    ...
    public final void mAND() throws RecognitionException {
        try {
            // etc/XQFT.g:1382:19: ( 'and' )
            // etc/XQFT.g:1382:21: 'and'
            {
    ...
    public final void mAS() throws RecognitionException {
        try {
            // etc/XQFT.g:1383:18: ( 'as' )
            // etc/XQFT.g:1383:20: 'as'
            {
    ...
    public final void mASCENDING() throws RecognitionException {
        try {
            // etc/XQFT.g:1384:24: ( 'ascending' )
            // etc/XQFT.g:1384:26: 'ascending'
            {
    ...
    public final void mAT() throws RecognitionException {
        try {
            // etc/XQFT.g:1385:18: ( 'at' )
            // etc/XQFT.g:1385:20: 'at'
            {
    ...
    public final void mATTRIBUTE() throws RecognitionException {
        try {
            // etc/XQFT.g:1386:24: ( 'attribute' )
            // etc/XQFT.g:1386:26: 'attribute'
            {
    ...
    public final void mBASE_URI() throws RecognitionException {
        try {
            // etc/XQFT.g:1387:23: ( 'base-uri' )
            // etc/XQFT.g:1387:25: 'base-uri'
            {
    ...
    public final void mBY() throws RecognitionException {
        try {
            // etc/XQFT.g:1388:18: ( 'by' )
            // etc/XQFT.g:1388:20: 'by'
            {
    ...
    public final void mBOUNDARYSPACE() throws RecognitionException {
        try {
            // etc/XQFT.g:1389:27: ( 'boundary-space' )
            // etc/XQFT.g:1389:29: 'boundary-space'
            {
    ...
    public final void mCASE() throws RecognitionException {
        try {
            // etc/XQFT.g:1390:20: ( 'case' )
            // etc/XQFT.g:1390:22: 'case'
            {
    ...
    public final void mCAST() throws RecognitionException {
        try {
            // etc/XQFT.g:1391:20: ( 'cast' )
            // etc/XQFT.g:1391:22: 'cast'
            {
    ...
    public final void mCASTABLE() throws RecognitionException {
        try {
            // etc/XQFT.g:1392:23: ( 'castable' )
            // etc/XQFT.g:1392:25: 'castable'
            {
    ...
    public final void mCHILD() throws RecognitionException {
        try {
            // etc/XQFT.g:1393:21: ( 'child' )
            // etc/XQFT.g:1393:23: 'child'
            {
    ...
    public final void mCOLLATION() throws RecognitionException {
        try {
            // etc/XQFT.g:1394:24: ( 'collation' )
            // etc/XQFT.g:1394:26: 'collation'
            {
    ...
    public final void mCOMMENT() throws RecognitionException {
        try {
            // etc/XQFT.g:1395:22: ( 'comment' )
            // etc/XQFT.g:1395:24: 'comment'
            {
    ...
    public final void mCONSTRUCTION() throws RecognitionException {
        try {
            // etc/XQFT.g:1396:26: ( 'construction' )
            // etc/XQFT.g:1396:28: 'construction'
            {
    ...
    public final void mCONTENT() throws RecognitionException {
        try {
            // etc/XQFT.g:1397:22: ( 'content' )
            // etc/XQFT.g:1397:24: 'content'
            {
    ...
    public final void mCOPY_NAMESPACES() throws RecognitionException {
        try {
            // etc/XQFT.g:1398:28: ( 'copy-namespaces' )
            // etc/XQFT.g:1398:30: 'copy-namespaces'
            {
    ...
    public final void mDECLARE() throws RecognitionException {
        try {
            // etc/XQFT.g:1399:22: ( 'declare' )
            // etc/XQFT.g:1399:24: 'declare'
            {
    ...
    public final void mDEFAULT() throws RecognitionException {
        try {
            // etc/XQFT.g:1400:22: ( 'default' )
            // etc/XQFT.g:1400:24: 'default'
            {
    ...
    public final void mDESCENDANT() throws RecognitionException {
        try {
            // etc/XQFT.g:1401:24: ( 'descendant' )
            // etc/XQFT.g:1401:26: 'descendant'
            {
    ...
    public final void mDESCENDANT_OR_SELF() throws RecognitionException {
        try {
            // etc/XQFT.g:1402:30: ( 'descendant-or-self' )
            // etc/XQFT.g:1402:32: 'descendant-or-self'
            {
    ...
    public final void mDESCENDING() throws RecognitionException {
        try {
            // etc/XQFT.g:1403:24: ( 'descending' )
            // etc/XQFT.g:1403:26: 'descending'
            {
    ...
    public final void mDIACRITICS() throws RecognitionException {
        try {
            // etc/XQFT.g:1404:24: ( 'diacritics' )
            // etc/XQFT.g:1404:26: 'diacritics'
            {
    ...
    public final void mDIFFERENT() throws RecognitionException {
        try {
            // etc/XQFT.g:1405:24: ( 'different' )
            // etc/XQFT.g:1405:26: 'different'
            {
    ...
    public final void mDISTANCE() throws RecognitionException {
        try {
            // etc/XQFT.g:1406:23: ( 'distance' )
            // etc/XQFT.g:1406:25: 'distance'
            {
    ...
    public final void mDIV() throws RecognitionException {
        try {
            // etc/XQFT.g:1407:19: ( 'div' )
            // etc/XQFT.g:1407:21: 'div'
            {
    ...
    public final void mDOCUMENT() throws RecognitionException {
        try {
            // etc/XQFT.g:1408:23: ( 'document' )
            // etc/XQFT.g:1408:25: 'document'
            {
    ...
    public final void mDOCUMENT_NODE() throws RecognitionException {
        try {
            // etc/XQFT.g:1409:27: ( 'document-node' )
            // etc/XQFT.g:1409:29: 'document-node'
            {
    ...
    public final void mELEMENT() throws RecognitionException {
        try {
            // etc/XQFT.g:1410:22: ( 'element' )
            // etc/XQFT.g:1410:24: 'element'
            {
    ...
    public final void mELSE() throws RecognitionException {
        try {
            // etc/XQFT.g:1411:20: ( 'else' )
            // etc/XQFT.g:1411:22: 'else'
            {
    ...
    public final void mENCODING() throws RecognitionException {
        try {
            // etc/XQFT.g:1412:23: ( 'encoding' )
            // etc/XQFT.g:1412:25: 'encoding'
            {
    ...
    public final void mEND() throws RecognitionException {
        try {
            // etc/XQFT.g:1413:19: ( 'end' )
            // etc/XQFT.g:1413:21: 'end'
            {
    ...
    public final void mENTIRE() throws RecognitionException {
        try {
            // etc/XQFT.g:1414:21: ( 'entire' )
            // etc/XQFT.g:1414:23: 'entire'
            {
    ...
    public final void mEMPTY() throws RecognitionException {
        try {
            // etc/XQFT.g:1415:21: ( 'empty' )
            // etc/XQFT.g:1415:23: 'empty'
            {
    ...
    public final void mEMPTY_SEQUENCE() throws RecognitionException {
        try {
            // etc/XQFT.g:1416:27: ( 'empty-sequence' )
            // etc/XQFT.g:1416:29: 'empty-sequence'
            {
    ...
    public final void mEQ() throws RecognitionException {
        try {
            // etc/XQFT.g:1417:18: ( 'eq' )
            // etc/XQFT.g:1417:20: 'eq'
            {
    ...
    public final void mEVERY() throws RecognitionException {
        try {
            // etc/XQFT.g:1418:21: ( 'every' )
            // etc/XQFT.g:1418:23: 'every'
            {
    ...
    public final void mEXACTLY() throws RecognitionException {
        try {
            // etc/XQFT.g:1419:22: ( 'exactly' )
            // etc/XQFT.g:1419:24: 'exactly'
            {
    ...
    public final void mEXCEPT() throws RecognitionException {
        try {
            // etc/XQFT.g:1420:21: ( 'except' )
            // etc/XQFT.g:1420:23: 'except'
            {
    ...
    public final void mEXTERNAL() throws RecognitionException {
        try {
            // etc/XQFT.g:1421:23: ( 'external' )
            // etc/XQFT.g:1421:25: 'external'
            {
    ...
    public final void mFOLLOWING() throws RecognitionException {
        try {
            // etc/XQFT.g:1422:24: ( 'following' )
            // etc/XQFT.g:1422:26: 'following'
            {
    ...
    public final void mFOLLOWING_SIBLING() throws RecognitionException {
        try {
            // etc/XQFT.g:1423:30: ( 'following-sibling' )
            // etc/XQFT.g:1423:32: 'following-sibling'
            {
    ...
    public final void mFOR() throws RecognitionException {
        try {
            // etc/XQFT.g:1424:19: ( 'for' )
            // etc/XQFT.g:1424:21: 'for'
            {
    ...
    public final void mFROM() throws RecognitionException {
        try {
            // etc/XQFT.g:1425:20: ( 'from' )
            // etc/XQFT.g:1425:22: 'from'
            {
    ...
    public final void mFTAND() throws RecognitionException {
        try {
            // etc/XQFT.g:1426:21: ( 'ftand' )
            // etc/XQFT.g:1426:23: 'ftand'
            {
    ...
    public final void mFTCONTAINS() throws RecognitionException {
        try {
            // etc/XQFT.g:1427:24: ( 'ftcontains' )
            // etc/XQFT.g:1427:26: 'ftcontains'
            {
    ...
    public final void mFTNOT() throws RecognitionException {
        try {
            // etc/XQFT.g:1428:21: ( 'ftnot' )
            // etc/XQFT.g:1428:23: 'ftnot'
            {
    ...
    public final void mFTOPTION() throws RecognitionException {
        try {
            // etc/XQFT.g:1429:23: ( 'ft-option' )
            // etc/XQFT.g:1429:25: 'ft-option'
            {
    ...
    public final void mFTOR() throws RecognitionException {
        try {
            // etc/XQFT.g:1430:20: ( 'ftor' )
            // etc/XQFT.g:1430:22: 'ftor'
            {
    ...
    public final void mFUNCTION() throws RecognitionException {
        try {
            // etc/XQFT.g:1431:23: ( 'function' )
            // etc/XQFT.g:1431:25: 'function'
            {
    ...
    public final void mGE() throws RecognitionException {
        try {
            // etc/XQFT.g:1432:18: ( 'ge' )
            // etc/XQFT.g:1432:20: 'ge'
            {
    ...
    public final void mGREATEST() throws RecognitionException {
        try {
            // etc/XQFT.g:1433:23: ( 'greatest' )
            // etc/XQFT.g:1433:25: 'greatest'
            {
    ...
    public final void mGT() throws RecognitionException {
        try {
            // etc/XQFT.g:1434:18: ( 'gt' )
            // etc/XQFT.g:1434:20: 'gt'
            {
            match("gt"); if (failed) return ;
    ...
    public final void mIDIV() throws RecognitionException {
        try {
            // etc/XQFT.g:1435:20: ( 'idiv' )
            // etc/XQFT.g:1435:22: 'idiv'
            {
    ...
    public final void mIF() throws RecognitionException {
        try {
            // etc/XQFT.g:1436:18: ( 'if' )
            // etc/XQFT.g:1436:20: 'if'
            {
    ...
    public final void mIMPORT() throws RecognitionException {
        try {
            // etc/XQFT.g:1437:21: ( 'import' )
            // etc/XQFT.g:1437:23: 'import'
            {
    ...
    public final void mIN() throws RecognitionException {
        try {
            // etc/XQFT.g:1438:18: ( 'in' )
            // etc/XQFT.g:1438:20: 'in'
            {
    ...
    public final void mINHERIT() throws RecognitionException {
        try {
            // etc/XQFT.g:1439:22: ( 'inherit' )
            // etc/XQFT.g:1439:24: 'inherit'
            {
    ...
    public final void mINSENSITIVE() throws RecognitionException {
        try {
            // etc/XQFT.g:1440:25: ( 'insensitive' )
            // etc/XQFT.g:1440:27: 'insensitive'
            {
    ...
    public final void mINSTANCE() throws RecognitionException {
        try {
            // etc/XQFT.g:1441:23: ( 'instance' )
            // etc/XQFT.g:1441:25: 'instance'
            {
    ...
    public final void mINTERSECT() throws RecognitionException {
        try {
            // etc/XQFT.g:1442:24: ( 'intersect' )
            // etc/XQFT.g:1442:26: 'intersect'
            {
    ...
    public final void mIS() throws RecognitionException {
        try {
            // etc/XQFT.g:1443:18: ( 'is' )
            // etc/XQFT.g:1443:20: 'is'
            {
    ...
    public final void mITEM() throws RecognitionException {
        try {
            // etc/XQFT.g:1444:20: ( 'item' )
            // etc/XQFT.g:1444:22: 'item'
            {
    ...
    public final void mLANGUAGE() throws RecognitionException {
        try {
            // etc/XQFT.g:1445:23: ( 'language' )
            // etc/XQFT.g:1445:25: 'language'
            {
    ...
    public final void mLAX() throws RecognitionException {
        try {
            // etc/XQFT.g:1446:19: ( 'lax' )
            // etc/XQFT.g:1446:21: 'lax'
            {
    ...
    public final void mLE() throws RecognitionException {
        try {
            // etc/XQFT.g:1447:18: ( 'le' )
            // etc/XQFT.g:1447:20: 'le'
            {
    ...
    public final void mLEAST() throws RecognitionException {
        try {
            // etc/XQFT.g:1448:21: ( 'least' )
            // etc/XQFT.g:1448:23: 'least'
            {
    ...
    public final void mLET() throws RecognitionException {
        try {
            // etc/XQFT.g:1449:19: ( 'let' )
            // etc/XQFT.g:1449:21: 'let'
            {
    ...
    public final void mLEVELS() throws RecognitionException {
        try {
            // etc/XQFT.g:1450:21: ( 'levels' )
            // etc/XQFT.g:1450:23: 'levels'
            {
    ...
    public final void mLOWERCASE() throws RecognitionException {
        try {
            // etc/XQFT.g:1451:24: ( 'lowercase' )
            // etc/XQFT.g:1451:26: 'lowercase'
            {
    ...
    public final void mLT() throws RecognitionException {
        try {
            // etc/XQFT.g:1452:18: ( 'lt' )
            // etc/XQFT.g:1452:20: 'lt'
            {
            match("lt"); if (failed) return ;
    ...
    public final void mMOD() throws RecognitionException {
        try {
            // etc/XQFT.g:1453:19: ( 'mod' )
            // etc/XQFT.g:1453:21: 'mod'
            {
    ...
    public final void mMODULE() throws RecognitionException {
        try {
            // etc/XQFT.g:1454:21: ( 'module' )
            // etc/XQFT.g:1454:23: 'module'
            {
    ...
    public final void mMOST() throws RecognitionException {
        try {
            // etc/XQFT.g:1455:20: ( 'most' )
            // etc/XQFT.g:1455:22: 'most'
            {
    ...
    public final void mNAMESPACE() throws RecognitionException {
        try {
            // etc/XQFT.g:1456:24: ( 'namespace' )
            // etc/XQFT.g:1456:26: 'namespace'
            {
    ...
    public final void mNE() throws RecognitionException {
        try {
            // etc/XQFT.g:1457:18: ( 'ne' )
            // etc/XQFT.g:1457:20: 'ne'
            {
    ...
    public final void mNODE() throws RecognitionException {
        try {
            // etc/XQFT.g:1458:20: ( 'node' )
            // etc/XQFT.g:1458:22: 'node'
            {
    ...
    public final void mNOINHERIT() throws RecognitionException {
        try {
            // etc/XQFT.g:1459:24: ( 'no-inherit' )
            // etc/XQFT.g:1459:26: 'no-inherit'
            {
    ...
    public final void mNOPRESERVE() throws RecognitionException {
        try {
            // etc/XQFT.g:1460:24: ( 'no-preserve' )
            // etc/XQFT.g:1460:26: 'no-preserve'
            {
    ...
    public final void mNOT() throws RecognitionException {
        try {
            // etc/XQFT.g:1461:19: ( 'not' )
            // etc/XQFT.g:1461:21: 'not'
            {
    ...
    public final void mOCCURS() throws RecognitionException {
        try {
            // etc/XQFT.g:1462:21: ( 'occurs' )
            // etc/XQFT.g:1462:23: 'occurs'
            {
    ...
    public final void mOF() throws RecognitionException {
        try {
            // etc/XQFT.g:1463:18: ( 'of' )
            // etc/XQFT.g:1463:20: 'of'
            {
    ...
    public final void mOPTION() throws RecognitionException {
        try {
            // etc/XQFT.g:1464:21: ( 'option' )
            // etc/XQFT.g:1464:23: 'option'
            {
    ...
    public final void mOR() throws RecognitionException {
        try {
            // etc/XQFT.g:1465:18: ( 'or' )
            // etc/XQFT.g:1465:20: 'or'
            {
    ...
    public final void mORDER() throws RecognitionException {
        try {
            // etc/XQFT.g:1466:21: ( 'order' )
            // etc/XQFT.g:1466:23: 'order'
            {
    ...
    public final void mORDERED() throws RecognitionException {
        try {
            // etc/XQFT.g:1467:22: ( 'ordered' )
            // etc/XQFT.g:1467:24: 'ordered'
            {
    ...
    public final void mORDERING() throws RecognitionException {
        try {
            // etc/XQFT.g:1468:23: ( 'ordering' )
            // etc/XQFT.g:1468:25: 'ordering'
            {
    ...
    public final void mPARAGRAPH() throws RecognitionException {
        try {
            // etc/XQFT.g:1469:24: ( 'paragraph' )
            // etc/XQFT.g:1469:26: 'paragraph'
            {
    ...
    public final void mPARAGRAPHS() throws RecognitionException {
        try {
            // etc/XQFT.g:1470:24: ( 'paragraphs' )
            // etc/XQFT.g:1470:26: 'paragraphs'
            {
    ...
    public final void mPARENT() throws RecognitionException {
        try {
            // etc/XQFT.g:1471:21: ( 'parent' )
            // etc/XQFT.g:1471:23: 'parent'
            {
    ...
    public final void mPHRASE() throws RecognitionException {
        try {
            // etc/XQFT.g:1472:21: ( 'phrase' )
            // etc/XQFT.g:1472:23: 'phrase'
            {
    ...
    public final void mPRECEDING() throws RecognitionException {
        try {
            // etc/XQFT.g:1473:24: ( 'preceding' )
            // etc/XQFT.g:1473:26: 'preceding'
            {
    ...
    public final void mPRECEDING_SIBLING() throws RecognitionException {
        try {
            // etc/XQFT.g:1474:30: ( 'preceding-sibling' )
            // etc/XQFT.g:1474:32: 'preceding-sibling'
            {
    ...
    public final void mPRESERVE() throws RecognitionException {
        try {
            // etc/XQFT.g:1475:23: ( 'preserve' )
            // etc/XQFT.g:1475:25: 'preserve'
            {
    ...
    public final void mPROCESSING_INSTRUCTION() throws RecognitionException {
        try {
            // etc/XQFT.g:1476:33: ( 'processing-instruction' )
            // etc/XQFT.g:1476:35: 'processing-instruction'
            {
    ...
    public final void mRELATIONSHIP() throws RecognitionException {
        try {
            // etc/XQFT.g:1477:26: ( 'relationship' )
            // etc/XQFT.g:1477:28: 'relationship'
            {
    ...
    public final void mRETURN() throws RecognitionException {
        try {
            // etc/XQFT.g:1478:21: ( 'return' )
            // etc/XQFT.g:1478:23: 'return'
            {
    ...
    public final void mSAME() throws RecognitionException {
        try {
            // etc/XQFT.g:1479:20: ( 'same' )
            // etc/XQFT.g:1479:22: 'same'
            {
    ...
    public final void mSATISFIES() throws RecognitionException {
        try {
            // etc/XQFT.g:1480:24: ( 'satisfies' )
            // etc/XQFT.g:1480:26: 'satisfies'
            {
    ...
    public final void mSCHEMA() throws RecognitionException {
        try {
            // etc/XQFT.g:1481:21: ( 'schema' )
            // etc/XQFT.g:1481:23: 'schema'
            {
    ...
    public final void mSCHEMAATTRIBUTE() throws RecognitionException {
        try {
            // etc/XQFT.g:1482:28: ( 'schema-attribute' )
            // etc/XQFT.g:1482:30: 'schema-attribute'
            {
    ...
    public final void mSCHEMAELEMENT() throws RecognitionException {
        try {
            // etc/XQFT.g:1483:27: ( 'schema-element' )
            // etc/XQFT.g:1483:29: 'schema-element'
            {
    ...
    public final void mSCORE() throws RecognitionException {
        try {
            // etc/XQFT.g:1484:21: ( 'score' )
            // etc/XQFT.g:1484:23: 'score'
            {
    ...
    public final void mSELF() throws RecognitionException {
        try {
            // etc/XQFT.g:1485:20: ( 'self' )
            // etc/XQFT.g:1485:22: 'self'
            {
    ...
    public final void mSENSITIVE() throws RecognitionException {
        try {
            // etc/XQFT.g:1486:24: ( 'sensitive' )
            // etc/XQFT.g:1486:26: 'sensitive'
            {
    ...
    public final void mSENTENCES() throws RecognitionException {
        try {
            // etc/XQFT.g:1487:24: ( 'sentences' )
            // etc/XQFT.g:1487:26: 'sentences'
            {
    ...
    public final void mSENTENCE() throws RecognitionException {
        try {
            // etc/XQFT.g:1488:23: ( 'sentence' )
            // etc/XQFT.g:1488:25: 'sentence'
            {
    ...
    public final void mSOME() throws RecognitionException {
        try {
            // etc/XQFT.g:1489:20: ( 'some' )
            // etc/XQFT.g:1489:22: 'some'
            {
    ...
    public final void mSTABLE() throws RecognitionException {
        try {
            // etc/XQFT.g:1490:21: ( 'stable' )
            // etc/XQFT.g:1490:23: 'stable'
            {
    ...
    public final void mSTART() throws RecognitionException {
        try {
            // etc/XQFT.g:1491:21: ( 'start' )
            // etc/XQFT.g:1491:23: 'start'
            {
    ...
    public final void mSTEMMING() throws RecognitionException {
        try {
            // etc/XQFT.g:1492:23: ( 'stemming' )
            // etc/XQFT.g:1492:25: 'stemming'
            {
    ...
    public final void mSTOP() throws RecognitionException {
        try {
            // etc/XQFT.g:1493:20: ( 'stop' )
            // etc/XQFT.g:1493:22: 'stop'
            {
    ...
    public final void mSTRICT() throws RecognitionException {
        try {
            // etc/XQFT.g:1494:21: ( 'strict' )
            // etc/XQFT.g:1494:23: 'strict'
            {
    ...
    public final void mSTRIP() throws RecognitionException {
        try {
            // etc/XQFT.g:1495:21: ( 'strip' )
            // etc/XQFT.g:1495:23: 'strip'
            {
    ...
    public final void mTEXT() throws RecognitionException {
        try {
            // etc/XQFT.g:1496:20: ( 'text' )
            // etc/XQFT.g:1496:22: 'text'
            {
    ...
    public final void mTHESAURUS() throws RecognitionException {
        try {
            // etc/XQFT.g:1497:24: ( 'thesaurus' )
            // etc/XQFT.g:1497:26: 'thesaurus'
            {
    ...
    public final void mTHEN() throws RecognitionException {
        try {
            // etc/XQFT.g:1498:20: ( 'then' )
            // etc/XQFT.g:1498:22: 'then'
            {
    ...
    public final void mTIMES() throws RecognitionException {
        try {
            // etc/XQFT.g:1499:21: ( 'times' )
            // etc/XQFT.g:1499:23: 'times'
            {
    ...
    public final void mTO() throws RecognitionException {
        try {
            // etc/XQFT.g:1500:18: ( 'to' )
            // etc/XQFT.g:1500:20: 'to'
            {
    ...
    public final void mTREAT() throws RecognitionException {
        try {
            // etc/XQFT.g:1501:21: ( 'treat' )
            // etc/XQFT.g:1501:23: 'treat'
            {
    ...
    public final void mTYPESWITCH() throws RecognitionException {
        try {
            // etc/XQFT.g:1502:24: ( 'typeswitch' )
            // etc/XQFT.g:1502:26: 'typeswitch'
            {
    ...
    public final void mUNION() throws RecognitionException {
        try {
            // etc/XQFT.g:1503:21: ( 'union' )
            // etc/XQFT.g:1503:23: 'union'
            {
    ...
    public final void mUNORDERED() throws RecognitionException {
        try {
            // etc/XQFT.g:1504:24: ( 'unordered' )
            // etc/XQFT.g:1504:26: 'unordered'
            {
    ...
    public final void mUPPERCASE() throws RecognitionException {
        try {
            // etc/XQFT.g:1505:24: ( 'uppercase' )
            // etc/XQFT.g:1505:26: 'uppercase'
            {
    ...
    public final void mVALIDATE() throws RecognitionException {
        try {
            // etc/XQFT.g:1506:23: ( 'validate' )
            // etc/XQFT.g:1506:25: 'validate'
            {
    ...
    public final void mVARIABLE() throws RecognitionException {
        try {
            // etc/XQFT.g:1507:23: ( 'variable' )
            // etc/XQFT.g:1507:25: 'variable'
            {
    ...
    public final void mVERSION() throws RecognitionException {
        try {
            // etc/XQFT.g:1508:22: ( 'version' )
            // etc/XQFT.g:1508:24: 'version'
            {
    ...
    public final void mWEIGHT() throws RecognitionException {
        try {
            // etc/XQFT.g:1509:21: ( 'weight' )
            // etc/XQFT.g:1509:23: 'weight'
            {
    ...
    public final void mWHERE() throws RecognitionException {
        try {
            // etc/XQFT.g:1510:21: ( 'where' )
            // etc/XQFT.g:1510:23: 'where'
            {
    ...
    public final void mWILDCARDS() throws RecognitionException {
        try {
            // etc/XQFT.g:1511:24: ( 'wildcards' )
            // etc/XQFT.g:1511:26: 'wildcards'
            {
    ...
    public final void mWINDOW() throws RecognitionException {
        try {
            // etc/XQFT.g:1512:21: ( 'window' )
            // etc/XQFT.g:1512:23: 'window'
            {
    ...
    public final void mWITH() throws RecognitionException {
        try {
            // etc/XQFT.g:1513:20: ( 'with' )
            // etc/XQFT.g:1513:22: 'with'
            {
    ...
    public final void mWITHOUT() throws RecognitionException {
        try {
            // etc/XQFT.g:1514:22: ( 'without' )
            // etc/XQFT.g:1514:24: 'without'
            {
    ...
    public final void mWORD() throws RecognitionException {
        try {
            // etc/XQFT.g:1515:20: ( 'word' )
            // etc/XQFT.g:1515:22: 'word'
            {
    ...
    public final void mWORDS() throws RecognitionException {
        try {
            // etc/XQFT.g:1516:21: ( 'words' )
            // etc/XQFT.g:1516:23: 'words'
            {
    ...
    public final void mXQUERY() throws RecognitionException {
        try {
            // etc/XQFT.g:1517:21: ( 'xquery' )
            // etc/XQFT.g:1517:23: 'xquery'
            {
    ...
    public final void mCleanChar() throws RecognitionException {
        try {
            // etc/XQFT.g:1526:25: ( S | BaseChar | Ideographic | CombiningChar | Extender | Digit | ExtraChar | EXCLSi | SHARPSi | DOLLARSi | LPARSi | RPARSi | STARSi | PLUSSi | COMMASi | DOTSi | SLASHSi | COLONSi | SEMICOLONSi | EQSi | GTSi | QUESTIONSi | ATSi | LBRACKSi | BACKSLASHSi | RBRACKSi | UNDERSCORESi | PIPESi )
            int alt35=28;
            ...
            if ( ((LA35_0>='\t' && LA35_0<='\n')||LA35_0=='\r'||LA35_0==' ') ) {
                ...
                if (backtracking>0) {failed=true; return ;}
                NoViableAltException nvae =
                    new NoViableAltException("1526:10: fragment CleanChar : ( S | BaseChar | Ideographic | CombiningChar | Extender | Digit | ExtraChar | EXCLSi | SHARPSi | DOLLARSi | LPARSi | RPARSi | STARSi | PLUSSi | COMMASi | DOTSi | SLASHSi | COLONSi | SEMICOLONSi | EQSi | GTSi | QUESTIONSi | ATSi | LBRACKSi | BACKSLASHSi | RBRACKSi | UNDERSCORESi | PIPESi );", 35, 0, input);

                throw nvae;
            }
            switch (alt35) {
                case 1 :
                    // etc/XQFT.g:1526:27: S
                    {
                    mS(); if (failed) return ;
                ...
                case 2 :
                    ...
                    break;
                case 3 :
                    // etc/XQFT.g:1526:42: Ideographic
                    {
                    ...
                    break;
                case 4 :
                    // etc/XQFT.g:1526:56: CombiningChar
                    {
                ...
                case 18 :
                    ...
                    break;
                case 19 :
                    // etc/XQFT.g:1528:41: SEMICOLONSi
                    {
                    mSEMICOLONSi(); if (failed) return ;
                ...
                case 24 :
                    ...
                    break;
                case 25 :
                    // etc/XQFT.g:1529:24: BACKSLASHSi
                    {
                ...
                case 26 :
                    ...
                    break;
                case 27 :
                    // etc/XQFT.g:1529:49: UNDERSCORESi
                    {
    ...
    public final void mChar() throws RecognitionException {
        try {
            // etc/XQFT.g:1531:21: ( CleanChar | LBRACESi | RBRACSi | LTSi | AMPERSi | QUOTSi | APOSSi | MINUSSi )
            int alt36=8;
            ...
            if ( ((LA36_0>='\t' && LA36_0<='\n')||LA36_0=='\r'||(LA36_0>=' ' && LA36_0<='!')||(LA36_0>='#' && LA36_0<='%')||(LA36_0>='(' && LA36_0<=',')||(LA36_0>='.' && LA36_0<=';')||(LA36_0>='=' && LA36_0<='z')||LA36_0=='|'||(LA36_0>='~' && LA36_0<='\uD7FF')||(LA36_0>='\uE000' && LA36_0<='\uFFFD')) ) {
                ...
                if (backtracking>0) {failed=true; return ;}
                NoViableAltException nvae =
                    new NoViableAltException("1531:10: fragment Char : ( CleanChar | LBRACESi | RBRACSi | LTSi | AMPERSi | QUOTSi | APOSSi | MINUSSi );", 36, 0, input);

                throw nvae;
            }
            switch (alt36) {
                case 1 :
                    // etc/XQFT.g:1531:23: CleanChar
                    {
    ...
    public final void mDigits() throws RecognitionException {
        try {
            // etc/XQFT.g:1536:33: ( ( '0' .. '9' )+ )
            // etc/XQFT.g:1536:35: ( '0' .. '9' )+
            {
            // etc/XQFT.g:1536:35: ( '0' .. '9' )+
            int cnt37=0;
            loop37:
    ...
    public final void mDigit() throws RecognitionException {
        try {
            // etc/XQFT.g:1538:33: ( '\\u0030' .. '\\u0039' | '\\u0660' .. '\\u0669' | '\\u06F0' .. '\\u06F9' | '\\u0966' .. '\\u096F' | '\\u09E6' .. '\\u09EF' | '\\u0A66' .. '\\u0A6F' | '\\u0AE6' .. '\\u0AEF' | '\\u0B66' .. '\\u0B6F' | '\\u0BE7' .. '\\u0BEF' | '\\u0C66' .. '\\u0C6F' | '\\u0CE6' .. '\\u0CEF' | '\\u0D66' .. '\\u0D6F' | '\\u0E50' .. '\\u0E59' | '\\u0ED0' .. '\\u0ED9' | '\\u0F20' .. '\\u0F29' )
            // etc/XQFT.g:
            {
    ...
    public final void mLetter() throws RecognitionException {
        try {
            // etc/XQFT.g:1540:23: ( BaseChar | Ideographic )
            // etc/XQFT.g:
            {
    ...
    public final void mCombiningChar() throws RecognitionException {
        try {
            // etc/XQFT.g:1546:33: ( '\\u0300' .. '\\u0345' | '\\u0360' .. '\\u0361' | '\\u0483' .. '\\u0486' | '\\u0591' .. '\\u05A1' | '\\u05A3' .. '\\u05B9' | '\\u05BB' .. '\\u05BD' | '\\u05BF' | '\\u05C1' .. '\\u05C2' | '\\u05C4' | '\\u064B' .. '\\u0652' | '\\u0670' | '\\u06D6' .. '\\u06DC' | '\\u06DD' .. '\\u06DF' | '\\u06E0' .. '\\u06E4' | '\\u06E7' .. '\\u06E8' | '\\u06EA' .. '\\u06ED' | '\\u0901' .. '\\u0903' | '\\u093C' | '\\u093E' .. '\\u094C' | '\\u094D' | '\\u0951' .. '\\u0954' | '\\u0962' .. '\\u0963' | '\\u0981' .. '\\u0983' | '\\u09BC' | '\\u09BE' | '\\u09BF' | '\\u09C0' .. '\\u09C4' | '\\u09C7' .. '\\u09C8' | '\\u09CB' .. '\\u09CD' | '\\u09D7' | '\\u09E2' .. '\\u09E3' | '\\u0A02' | '\\u0A3C' | '\\u0A3E' | '\\u0A3F' | '\\u0A40' .. '\\u0A42' | '\\u0A47' .. '\\u0A48' | '\\u0A4B' .. '\\u0A4D' | '\\u0A70' .. '\\u0A71' | '\\u0A81' .. '\\u0A83' | '\\u0ABC' | '\\u0ABE' .. '\\u0AC5' | '\\u0AC7' .. '\\u0AC9' | '\\u0ACB' .. '\\u0ACD' | '\\u0B01' .. '\\u0B03' | '\\u0B3C' | '\\u0B3E' .. '\\u0B43' | '\\u0B47' .. '\\u0B48' | '\\u0B4B' .. '\\u0B4D' | '\\u0B56' .. '\\u0B57' | '\\u0B82' .. '\\u0B83' | '\\u0BBE' .. '\\u0BC2' | '\\u0BC6' .. '\\u0BC8' | '\\u0BCA' .. '\\u0BCD' | '\\u0BD7' | '\\u0C01' .. '\\u0C03' | '\\u0C3E' .. '\\u0C44' | '\\u0C46' .. '\\u0C48' | '\\u0C4A' .. '\\u0C4D' | '\\u0C55' .. '\\u0C56' | '\\u0C82' .. '\\u0C83' | '\\u0CBE' .. '\\u0CC4' | '\\u0CC6' .. '\\u0CC8' | '\\u0CCA' .. '\\u0CCD' | '\\u0CD5' .. '\\u0CD6' | '\\u0D02' .. '\\u0D03' | '\\u0D3E' .. '\\u0D43' | '\\u0D46' .. '\\u0D48' | '\\u0D4A' .. '\\u0D4D' | '\\u0D57' | '\\u0E31' | '\\u0E34' .. '\\u0E3A' | '\\u0E47' .. '\\u0E4E' | '\\u0EB1' | '\\u0EB4' .. '\\u0EB9' | '\\u0EBB' .. '\\u0EBC' | '\\u0EC8' .. '\\u0ECD' | '\\u0F18' .. '\\u0F19' | '\\u0F35' | '\\u0F37' | '\\u0F39' | '\\u0F3E' | '\\u0F3F' | '\\u0F71' .. '\\u0F84' | '\\u0F86' .. '\\u0F8B' | '\\u0F90' .. '\\u0F95' | '\\u0F97' | '\\u0F99' .. '\\u0FAD' | '\\u0FB1' .. '\\u0FB7' | '\\u0FB9' | '\\u20D0' .. '\\u20DC' | '\\u20E1' | '\\u302A' .. '\\u302F' | '\\u3099' | '\\u309A' )
            // etc/XQFT.g:
            {
    ...
    public final void mExtender() throws RecognitionException {
        try {
            // etc/XQFT.g:1548:33: ( '\\u00B7' | '\\u02D0' | '\\u02D1' | '\\u0387' | '\\u0640' | '\\u0E46' | '\\u0EC6' | '\\u3005' | '\\u3031' .. '\\u3035' | '\\u309D' .. '\\u309E' | '\\u30FC' .. '\\u30FE' )
            // etc/XQFT.g:
            {
    ...
    public final void synpred1_fragment() throws RecognitionException {   
        // etc/XQFT.g:1153:26: ( DoubleLiteral )
        // etc/XQFT.g:1153:27: DoubleLiteral
        {
        mDoubleLiteral(); if (failed) return ;
    ...
    public final void synpred2_fragment() throws RecognitionException {   
        // etc/XQFT.g:1154:14: ( DecimalLiteral )
        // etc/XQFT.g:1154:15: DecimalLiteral
        {
        mDecimalLiteral(); if (failed) return ;
    ...
    public final void synpred3_fragment() throws RecognitionException {   
        // etc/XQFT.g:1155:12: ( IntegerLiteral )
        // etc/XQFT.g:1155:13: IntegerLiteral
        {
        mIntegerLiteral(); if (failed) return ;
    ...
    class DFA1 extends DFA {
        ...
        public String getDescription() {
            return "989:61: ({...}? =>n= CDataSectionLEX | {...}? =>n= DirPIConstructor | {...}? =>n= DirCommentConstLEX | {...}? =>n= LENDTAGSi | {...}? =>n= ElementContent | {...}? =>n= PragmaLEX | {...}? =>n= Comment | {...}? =>n= NumberLEX | {...}? =>n= LexSigns | {...}? =>n= S | {...}? =>n= StringLiteral | {...}? =>n= LexLiterals | {...}? =>n= QuotAttributeContent | {...}? =>n= AposAttributeContent | {...}? =>n= RSELFTERMSi | n= QUOTSi | n= DOLLARSi | n= APOSSi | n= LPARSi | n= RPARSi | n= STARSi | n= PLUSSi | n= COMMASi | n= MINUSSi | n= DOTSi | n= SLASHSi | n= COLONSi | n= SEMICOLONSi | n= LTSi | n= EQSi | n= GTSi | n= QUESTIONSi | n= ATSi | n= LBRACKSi | n= RBRACKSi | n= LBRACESi | n= PIPESi | n= RBRACSi )";
        }
        public int specialStateTransition(int s, IntStream input) throws NoViableAltException {
            ...
            switch ( s ) {
                    ...
                    case 6 : 
                        ...
                        input.rewind();
                        s = -1;
                        if ( (LA1_3=='{') && (((state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='{' && input.LA(2)=='{'))||(state==State.IN_ELEMENT&&(input.LA(1)=='{' && input.LA(2)=='{'))))) {s = 42;}
                    ...
                    case 31 : 
                        ...
                        input.rewind();
                        s = -1;
                        if ( (LA1_4=='}') && (((state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_ELEMENT&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_QUOT_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))||(state==State.IN_APOS_ATTRIBUTE&&(input.LA(1)=='}' && input.LA(2)=='}'))))) {s = 44;}
    ...
    class DFA26 extends DFA {
        ...
        public String getDescription() {
            return "1153:10: fragment NumberLEX : ( ( DoubleLiteral )=> DoubleLiteral | ( DecimalLiteral )=> DecimalLiteral | ( IntegerLiteral )=> IntegerLiteral );";
        }
        public int specialStateTransition(int s, IntStream input) throws NoViableAltException {
        	int _s = s;
            switch ( s ) {

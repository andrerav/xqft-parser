...
\textsf{scope} operator will have to be reversed. The same can also be done to the rules
\ref{rule:trans:TD:sglSlash} and \ref{rule:trans:TD:dblSlash}. Only clean axis + name test steps can be translated

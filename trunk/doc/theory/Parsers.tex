...
which is claimed to be LL(1) (one token lookahead) -- however, as shown in
\cite{ourselves}, a complete implementation of the XQuery 1.0/XPath 2.0 grammar
requires more than one token look-ahead.

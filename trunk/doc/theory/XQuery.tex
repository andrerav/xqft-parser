...
\begin{figure}[!h]
  \centering
[for \$VarName_1 OptTypeDeclaration_1 OptPositionalVar_1 in Expr_1, \ldots,
\$VarNamen OptTypeDeclaration_n OptPositionalVar_n in Expr_n
FormalReturnClause]_{Expr}
==
for \$VarName1 OptTypeDeclaration1

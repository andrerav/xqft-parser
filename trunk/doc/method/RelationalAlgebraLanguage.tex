...
This operator should generate a sequence field from the input result set,
optionally restart the sequence based on field partitioning, and optionally sort
the output. The operator accepts three parameters and one child operator; the

...
\begin{figure}[h]
\Tree [.{\tiny AST\_FLWOR} [.{\tiny AST\_FORCLAUSE} \tiny{x} [.{\tiny /} [.{\tiny /} [.{\tiny /} [.{\tiny AST\_FUNCTIONCALL} \tiny{doc} \tiny{"books.xml"} ]  \tiny{bookstore} ]  \tiny{book} ]  \tiny{title} ]  ]  [.{\tiny AST\_WHERECLAUSE} [.{\tiny /} \tiny{x} \tiny{text} \tiny{(} \tiny{)} ]  \tiny{!=} \tiny{"The Definitive ANTLR Reference"} ]  [.{\tiny AST\_ORDERBYCLAUSE} \tiny{x} ]  [.{\tiny AST\_DIRELEMCONSTRUCTOR} \tiny{elem} ]  ]

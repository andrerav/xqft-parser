...
\nomenclature{\textbf{DOM}}{\textbf{D}ocument \textbf{O}bject \textbf{M}odel. A platform- and language-independent
standard object model for representing XML and related formats.}

\nomenclature{\textbf{Iterator dependency}}{A concept of Tainting Dependencies. See Section \ref{sect:trans:TD:dependency} }

\nomenclature{\textbf{Tainting}, iterator dependency}{A concept of Tainting Dependencies. See Section
\ref{sect:trans:TD:tainting}}

\nomenclature{\textbf{MarkXRemove}}{A predecessor of Tainting Dependencies. See Section
\ref{sect:trans:MarkXRemove}.}

...
may start with a namespace declaration, which is on the form \verb!declare
namespace...! and that \verb!declare! is a permitted function name. There is no
way to left factorize these productions without the risk of rendering the grammar
complex and possibly containing redundancies.     

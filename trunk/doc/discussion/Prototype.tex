...
\begin{itemize}
  ...
  new structures. (in particular to support normalisation to XQuery Core) \marginpar{\textbf{\LARGE TODO:}\\ 
  \scriptsize er dette en\\ constraint?}
...
This introduces a high level of redundancy.\marginpar{\textbf{\LARGE TODO:}\\?} \textbf{The two grammar

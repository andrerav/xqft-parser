 ...
 *
 */
public class HHJoin extends Operator {
    
    public HHJoin(no.ntnu.xqft.tree.param.List key1, no.ntnu.xqft.tree.param.List key2, no.ntnu.xqft.tree.param.List projectList, StringLiteral joinType, Operator op1, Operator op2) {
        super(null, null);
    ...
    public HHJoin(String[] key1, String[] key2, String[] projectList)
    {
        super(null, null);
    ...
    public HHJoin(String[] key1, String[] key2, String[] projectList, Operator one)
    {
     ...
     */
    public HHJoin(String[] key1, String[] key2, String[] projectList, Operator one, Operator two)
    {
        this(key1, key2, projectList);
        operators.add(one);
        operators.add(two);
    ...
    public HHJoin(String[] key1, String[] key2, String[] projectList, String joinType, Operator one, Operator two)
    {
...
//    }
    ...
    public HHJoin(String args, Operator en, Operator to)
    {
        super(null, null);
        this.name = "hhjoin";

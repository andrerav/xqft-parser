// $ANTLR 3.0.1 etc/XQFT.g 2007-11-23 22:11:49
            ...
            if ( (LA9_0==DECLARE) ) {
                ...
                case DEFAULT:
                    ...
                    if ( (LA9_6==COLLATION) ) {
                        ...
                        if (backtracking>0) {failed=true; return ;}
                        NoViableAltException nvae =
                            new NoViableAltException("95:1: setter : ( boundarySpaceDecl | defaultCollationDecl | baseURIDecl | constructionDecl | orderingModeDecl | emptyOrderDecl | copyNamespacesDecl );", 9, 6, input);
